...
<li><span>Geek_frank</span> 👍（2） 💬（2）<div>fragment 中53、7是怎么得到的？pos属性中x0,z0的数值设定有什么讲究的？</div>2020-08-24</li><br/><li><span>木瓜777</span> 👍（1） 💬（1）<div>你好，在绘制大场景的时候，设置每个模型的绘制顺序，好像不太合适吧？有没有其他解决z-fighting的方法？</div>2020-09-15</li><br/><li><span>Noah</span> 👍（0） 💬（1）<div>老师可不可以点评比较一下ThreeJS和BabylonJS这两个库？</div>2020-10-07</li><br/><li><span>Geek_25714e</span> 👍（0） 💬（1）<div>失效了</div>2022-02-24</li><br/>
</ul>