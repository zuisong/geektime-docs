...
<li><span>Sam</span> 👍（1） 💬（1）<div>GSLS中可以debugger或者console.log操作吗，总感觉没有理解到webgl的原理</div>2020-08-02</li><br/><li><span>秋谷</span> 👍（0） 💬（1）<div>看到例子中的画布宽高都是相等的，如果是不等的情况下，能画出来圆吗，自己画出来的变成了椭圆了</div>2021-07-21</li><br/><li><span>姚凯伦</span> 👍（0） 💬（1）<div>使用符号距离场渲染的方式绘制线段感觉很难实现端点圆角和指定线段接头处的连结方式等效果</div>2020-10-08</li><br/><li><span>武岳</span> 👍（3） 💬（0）<div>符号距离场，SDF，学习了</div>2020-07-24</li><br/><li><span>白夜</span> 👍（2） 💬（1）<div>那个进度条的例子没怎么看懂，老师能稍微解释一下吗？</div>2020-09-03</li><br/><li><span>西门吹雪</span> 👍（1） 💬（0）<div>真是大开眼界 简单的代码 震撼的效果</div>2020-09-13</li><br/><li><span>becky</span> 👍（0） 💬（0）<div>课后练习：https:&#47;&#47;yeying0827.github.io&#47;visualization-demos&#47;#&#47;fragment-shape&#47;practice
正六角星没想好怎么画，画了正六边形</div>2024-05-10</li><br/><li><span>有一种踏实</span> 👍（0） 💬（0）<div>clamp 函数还真是有点奇怪
1.理论上 clamp(x, a, b) = min(max(x, a), b)，显然当 a &lt; b 时，才会有预期的效果，而当 a &gt; b 时，返回的结果永远是 b；
2.但是  clamp(0.5, 1.3, 1.2) 返回 0，而 float b = 1.2; clamp(0.5, 1.3, b) 返回 1.2，这就令人费解！</div>2023-12-04</li><br/><li><span>量子蔷薇</span> 👍（0） 💬（0）<div>图片渐隐渐显没看懂，老师能解释一下吗？
gl_FragColor.rgb = color.rgb * clamp(0.5, 1.3, d + 1.0 * shading);
这里 clamp 函数的用法没看懂，渐变的某个时刻图片会变成黑色，也就是说 rgb 乘积会有 0 的情况，但是 clamp 里面我看不懂什么情况下返回的结果会是0？</div>2022-10-24</li><br/><li><span>阿不晕</span> 👍（0） 💬（1）<div>因为两个二维向量叉积的 z 轴分量的大小，就是这两个向量组成的平行四边形的面积，这段着实没有看懂。</div>2022-08-12</li><br/><li><span>冰糖爱白开水</span> 👍（0） 💬（0）<div>学这个课程，需要有一定基础</div>2022-03-01</li><br/><li><span>Herve</span> 👍（0） 💬（0）<div>月影老师，符号距离场绘制六边形能给个思路吗</div>2021-03-03</li><br/><li><span>Geek_00734e</span> 👍（0） 💬（0）<div>直线那个没有考虑0向量的因素，当鼠标放到指定的原点位置时，整个画布都是白色的</div>2021-02-15</li><br/><li><span>张旭</span> 👍（0） 💬（0）<div>原来数学公式可以搞出这么多事情</div>2020-07-29</li><br/>
</ul>