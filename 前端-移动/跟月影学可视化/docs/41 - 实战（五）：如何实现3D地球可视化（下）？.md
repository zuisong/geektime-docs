...
<li><span>Geek_e15910</span> 👍（0） 💬（1）<div>vertex.push(x, y, 1, 0, x, y, 1, 1.0);
  月影大大，这个生成marker的方法中，为什么要添加两次x,y,1,0呢？</div>2020-12-03</li><br/><li><span>萌萌的程序媛</span> 👍（1） 💬（1）<div>我用代码中例子，但是报错  没有createGlobe这个对象，这是什么原因呢？</div>2021-03-10</li><br/><li><span>冰糖爱白开水</span> 👍（0） 💬（0）<div>知道了，通过射线
</div>2023-02-21</li><br/><li><span>冰糖爱白开水</span> 👍（0） 💬（0）<div>鼠标与地球交互时，鼠标点击时，是怎样获取的球面坐标？？</div>2023-02-21</li><br/><li><span>Geek_0e4bce</span> 👍（0） 💬（0）<div>老师，代码没有办法正常运行，vid-geo-earth中的例子除了b_globe.html可以正常运行外，其他都报错</div>2022-04-28</li><br/>
</ul>