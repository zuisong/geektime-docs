...
https:&#47;&#47;github.com&#47;sankyutang&#47;fontend-trace-geekbang-course</div>2024-07-18</li><br/><li><span>JuneRain</span> 👍（0） 💬（0）<div>async 和 defer 属性的作用都是异步加载js资源，差别是js加载后的执行时机，async 是加载后立马执行，而 defer 是加载后在 DOMContentLoaded 事件前执行。
