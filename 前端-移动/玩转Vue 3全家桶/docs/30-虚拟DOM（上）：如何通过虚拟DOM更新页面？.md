...
<li><span>费城的二鹏</span> 👍（5） 💬（0）<div>key属性有利于判断新旧列表的复用判断，提升列表乱序后的复用率。</div>2021-12-29</li><br/><li><span>chensd</span> 👍（1） 💬（0）<div>什么场景会触发 invalidateJob, 具体的demo可否展示一下</div>2022-04-07</li><br/><li><span>Meiki</span> 👍（1） 💬（0）<div>vue在进行页面更新时，会通过Diff算法对虚拟DOM进行更新，因为真实的DOM消耗比较大。 假设我们需要对数组进行增删改查，我们需要快速定位到某一项，所以我们需要给每项绑一个具体的唯一的id值</div>2021-12-31</li><br/><li><span>李凯</span> 👍（0） 💬（0）<div>这一节值得花时间认真阅读，写的很清楚，收获满满！</div>2023-09-09</li><br/><li><span>evan</span> 👍（0） 💬（1）<div>&quot;然后进行队尾元素的预判，可以判断出 g 和元素也是一样的：&quot;  此处文案描述有错误，应该是“然后进行队尾元素的预判，可以判断出 g 和 h 元素也是一样的：”</div>2022-03-28</li><br/>
</ul>