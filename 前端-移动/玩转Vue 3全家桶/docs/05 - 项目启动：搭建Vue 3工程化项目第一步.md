...
<li><span>ch3cknull</span> 👍（35） 💬（1）<div>vite官方收集的一些和vite相关的项目，包括插件，模板，都分类整理好的，地址如下
https:&#47;&#47;github.com&#47;vitejs&#47;awesome-vite</div>2021-10-27</li><br/><li><span>南山</span> 👍（24） 💬（4）<div>1. vuex 的数据本地持久化插件
2. 接口数据的mock， json-server
3. 埋点的sdk
4.  @vueuse 库，封装常用的hooks</div>2021-10-27</li><br/><li><span>奇奇</span> 👍（13） 💬（3）<div>希望老师能够使用TS来演示代码
集成 EditorConfig 配置，集成 husky 和 lint-staged，代码提交时候检查 ESLint 规则，通过再提交</div>2021-10-28</li><br/><li><span>Geek_da0e92</span> 👍（11） 💬（6）<div>希望老师用vite+vue3.2+ts</div>2021-10-27</li><br/><li><span>cskang</span> 👍（10） 💬（1）<div>Element3 比较适合桌面端，手机端组件库老师推荐用什么？</div>2021-10-27</li><br/><li><span>Mèow</span> 👍（9） 💬（1）<div>大圣老师，你的架构图是怎么画的？</div>2021-11-02</li><br/><li><span>我叫小灰</span> 👍（8） 💬（1）<div>我可能会加入lodash和axios这两个库</div>2021-10-28</li><br/><li><span>乐叶</span> 👍（7） 💬（1）<div>如果路由不使用hash模式，可以使用createWebHistory</div>2021-10-27</li><br/><li><span>学渣rUa一哈จุ๊บ</span> 👍（7） 💬（1）<div>vite真的太快了，啥时候大圣老师能开个与之相关的课程呢？</div>2021-10-27</li><br/><li><span>王鸿轩</span> 👍（6） 💬（2）<div>想问下大圣老师 vue3.2 插件该怎么配置 vetur 和 volar 都使用吗，冲突问题如何解决</div>2021-10-27</li><br/><li><span>ll</span> 👍（6） 💬（1）<div>跟着小圣打怪升级！用 Vue 3 启动项目，个人觉的相较于 Vue 2 更符合直觉，比如说 Vue 2 扩展需要用到 Vue.use()， Vue 3 用到的是类似链式调用，实现了”管道化“。或是像乐高玩具，哪里需要插哪里那种。

之前我学过elm框架，就很喜欢那种函数式编程思想框架，现在看来像 Vue 3 也在朝这个方向走，属于越用越爽这种。

总之，给大圣点赞，大家加油</div>2021-10-27</li><br/><li><span>一荤一素</span> 👍（6） 💬（1）<div>
安装vuex和router加@next是vue3的安装还是有其他目的啊</div>2021-10-27</li><br/><li><span>codeDoge</span> 👍（5） 💬（1）<div>跟着大圣开发项目 ，思路格外清晰明了</div>2021-10-27</li><br/><li><span>Leung</span> 👍（5） 💬（5）<div> Chrome 访问 Vue 3 调试插件 这个访问不了 有不翻墙的下载链接吗</div>2021-10-27</li><br/><li><span>peterpc</span> 👍（4） 💬（1）<div>希望老师用vite+vue3.2+ts，强烈建议老师采用</div>2021-10-28</li><br/>
</ul>