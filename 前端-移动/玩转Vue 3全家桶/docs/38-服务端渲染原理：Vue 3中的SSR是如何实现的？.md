...
<li><span>kai</span> 👍（3） 💬（0）<div>SSR等并不是什么新技术，早期魔板还是后端处理的时代，这些技术点实现都是一样的原理。</div>2022-07-29</li><br/><li><span>Alias</span> 👍（1） 💬（1）<div>厉害了，react的next 中有 ssg  概念，看到这里，vue也有，一下子就豁然开朗了，前端框架解决某一类问题的理念都大差不差啊，学习就融会贯通而已</div>2022-02-14</li><br/><li><span>大将</span> 👍（0） 💬（0）<div>其实完全没有在使用，感觉现在很多情况下对前端的感知已经有些麻木了。</div>2024-03-29</li><br/><li><span>Geek_c63012</span> 👍（0） 💬（0）<div>1. 减少白屏时间
2. 利于seo优化</div>2023-04-29</li><br/><li><span>下一个起跑点</span> 👍（0） 💬（1）<div>我这个用egg.js渲染出来的首页模板，点击那个num的&lt;h&gt;标签,怎么不能触发click事件啊？你们的能正常js吗</div>2022-06-30</li><br/><li><span>james</span> 👍（0） 💬（0）<div>厉害了，很全面</div>2022-01-19</li><br/>
</ul>