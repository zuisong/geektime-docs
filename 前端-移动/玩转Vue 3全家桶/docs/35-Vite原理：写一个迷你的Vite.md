...
10.  调用 compilerDom.compile 解析 template 内容，直接返回 render 函数</div>2022-01-14</li><br/><li><span>tequ1lAneio</span> 👍（3） 💬（3）<div>有源码吗，一直在报process未定义的错误</div>2022-01-16</li><br/><li><span>润培</span> 👍（3） 💬（1）<div>模块如果是分散的，可以使用“依赖预构建”，通过预构建生成一个模块，这样只会有一个 http 请求。

https:&#47;&#47;cn.vitejs.dev&#47;guide&#47;dep-pre-bundling.html

https:&#47;&#47;cn.vitejs.dev&#47;config&#47;#dep-optimization-options</div>2022-01-10</li><br/><li><span>吴颜</span> 👍（2） 💬（1）<div>写的太简单，你这也没写出一个迷你的vite啊</div>2022-01-16</li><br/><li><span>Chen.Lu</span> 👍（0） 💬（1）<div>【Vite 热更新】小模块中 chalk 是定义 log 颜色的工具，不是监听文件&#47;文件夹的工具吧。
chokidar 是监听文件&#47;文件夹的工具</div>2022-01-16</li><br/><li><span>InfoQ_e521a4ce8a54</span> 👍（0） 💬（2）<div>从[Vite 的热更新]开始，代码片段所在的文件目录和所需的依赖就搞不清楚了。。。</div>2022-01-10</li><br/><li><span>若川</span> 👍（21） 💬（0）<div>我之前也写过一篇mini-vue的分析文章，感兴趣的可以结合大圣老师的文章对比看看实现～

尤雨溪几年前开发的“玩具 vite”，才100多行代码，却十分有助于理解 vite 原理
https:&#47;&#47;juejin.cn&#47;post&#47;7021306258057592862</div>2022-01-18</li><br/><li><span>Geek_37g</span> 👍（1） 💬（0）<div>热更新源码在哪儿呢？</div>2023-07-06</li><br/><li><span>Geek_07f3c3</span> 👍（0） 💬（1）<div>vite打包时提示包体积过大，请问应该怎压缩呢或者怎么分包</div>2022-05-16</li><br/><li><span>null</span> 👍（0） 💬（0）<div>开发过程中出现加载慢，timeout。</div>2022-02-17</li><br/><li><span>逗逼章鱼</span> 👍（0） 💬（0）<div>以后 importmap 会变成主流吗？</div>2022-02-08</li><br/><li><span>Geek_4da4e1</span> 👍（0） 💬（1）<div>css文件替换换行符windows下不行，&#47;r也有可能</div>2022-01-18</li><br/>
</ul>