...
![](https://static001.geekbang.org/resource/image/63/4c/6391573a276c47a9a50ae0cbd2c5844c.jpg?wh=1440%2A810)
...
![](https://static001.geekbang.org/resource/image/3d/a1/3db5e0f362bc276b83c7564430ecb0a1.jpg?wh=930%2A516)
...
![](https://static001.geekbang.org/resource/image/2b/a2/2be3e2457f08bdf624837dfaee01e4a2.png?wh=633%2A407)

接下来看一下Response Header。  
![](https://static001.geekbang.org/resource/image/ef/c9/efdeadf27313e08bf0789a3b5480f7c9.png?wh=627%2A453)
...
<li><span>奕</span> 👍（17） 💬（1）<div>HTT2 还有一个很重要的特性：使用二进制代理文本进行传输，极大提高了传输的效率</div>2019-02-23</li><br/><li><span>花儿与少年</span> 👍（13） 💬（3）<div>当5G来临，http小优化都不用找了</div>2019-02-16</li><br/><li><span>hhk</span> 👍（10） 💬（1）<div>那么 HTTP2 的 TCP 连接复用, 和 keep-alive 有什么区别呢?
</div>2019-02-17</li><br/><li><span>umaru</span> 👍（4） 💬（1）<div>服务器如何知道tag有没有更新？
是有某个地方可以设置还是我需要刻意去修改页面中某个标签？</div>2019-02-21</li><br/><li><span>...</span> 👍（4） 💬（1）<div>老师，网站做https升级后，由于TLS加密，第一次连接，速度慢一点是可以理解，但是之后的连接速度也变得挺慢的，这个用户体验不好，这个是不是跟我申请的https证书有很大关系，除此之外，有没有好的建议？</div>2019-02-17</li><br/><li><span>Helen</span> 👍（1） 💬（1）<div>为什么对位图的合成是一个可选的过程，浏览器的composite 不是一定会执行的么，我以为这一步是无法不执行的</div>2019-06-29</li><br/><li><span>liu志远</span> 👍（1） 💬（1）<div>https在实际环境经常会部分用户遇到ssl handshake fail的错误，前辈能否提示下调试方法</div>2019-02-20</li><br/><li><span>小农民</span> 👍（1） 💬（1）<div>老师您好 tag是什么 之前没听说过 可以解释一下吗</div>2019-02-13</li><br/><li><span>CC</span> 👍（142） 💬（3）<div>现在工作中暂时只使用到 HTTPS。
...
很有意思的变化。
</div>2019-02-09</li><br/><li><span>yy不会笑</span> 👍（67） 💬（0）<div>自己可以扩展补充以下
&gt; DNS查询得到IP
...
&gt; 强缓存与协商缓存</div>2019-02-09</li><br/><li><span>徐จุ๊บ</span> 👍（20） 💬（0）<div>老师真的很喜欢猫呐</div>2019-02-09</li><br/><li><span>新哥</span> 👍（13） 💬（1）<div>option请求在线上也会存在吧？非简单请求中的预请求</div>2019-02-26</li><br/><li><span>umaru</span> 👍（11） 💬（1）<div>老师，浏览器渲染听说有重绘，回流什么的，哪里可以找到这一部分相关资料？</div>2019-02-09</li><br/><li><span>oillie</span> 👍（10） 💬（0）<div>h2的头部会用哈夫曼编码压缩大小</div>2019-02-09</li><br/><li><span>晴天</span> 👍（6） 💬（2）<div>看了您的流式数据的解释，是不是可以理解当看到页面渲染的时候，DOM是不是有可能都还没构建完成呢？即使是理论上，有这种可能吗？
在网上看别人写的网页渲染原理，都是说dom构建完成了，再和构建css，都完成了才进行渲染的。
老师能详细解释下吗？</div>2019-04-28</li><br/>
</ul>