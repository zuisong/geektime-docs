...
<li><span>陈彦祖</span> 👍（0） 💬（0）<div>WritableMap resultMap = new WritableNativeMap(); 下面两行有问题
这行底下的代码有问题，变量名错了，应该是 resultMap.putInt(&quot;code&quot;, 1) 而不是 map
</div>2023-07-12</li><br/><li><span>Geek_ce9101</span> 👍（0） 💬（1）<div>最近有个项目，想直接上rn，但怕未来搞不定，搜了很多，没发现有什么是原声可以而rn不可以的，除了一些动画性能之类的</div>2022-05-27</li><br/>
</ul>