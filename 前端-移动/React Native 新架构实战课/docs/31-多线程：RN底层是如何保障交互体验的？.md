...
<li><span>Wcly👺</span> 👍（5） 💬（1）<div>“从源码中，可以看到 ShadowQueue 线程的名字叫做 com.facebook.react.JavaScript。”这里写错了，应该是“com.facebook.react.ShadowQueue”</div>2023-01-05</li><br/><li><span>解念念</span> 👍（3） 💬（1）<div>React Native 可以被设计成只使用 JavaScript 线程和主线程的“双线程”异步渲染模型。这种模型可以在保持应用性能的同时简化应用的开发和调试过程。
