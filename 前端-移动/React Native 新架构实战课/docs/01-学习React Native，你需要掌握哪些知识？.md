...
<li><span>阿拉丁神猫</span> 👍（0） 💬（1）<div>有相关交流群吗？拉我一下呗~</div>2022-07-10</li><br/><li><span>nigelli</span> 👍（0） 💬（1）<div>老师您好，想研究react native的实现，在iOS端能否源码编译呢？这样方便查看实现逻辑</div>2023-02-08</li><br/><li><span>Geek_63fd40</span> 👍（0） 💬（1）<div>捉虫：图中的 npm&#47;yarm 应该是 yarn吧？</div>2022-11-20</li><br/><li><span>chaos</span> 👍（0） 💬（1）<div>老师您好，uniapp与rn相对，在跨端开发性能上谁更有优势呢</div>2022-04-20</li><br/><li><span>姑苏小沈🏃🎸</span> 👍（9） 💬（4）<div>react native在国内搭建开发环境和项目，一坑又一坑，墙不胜墙</div>2022-03-29</li><br/><li><span>刘琦-Ava Ba</span> 👍（6） 💬（0）<div>无论是新手还是老手，你都应该系统地、有深度地再学习一遍，把基础打扎实了;

非常赞同</div>2022-04-07</li><br/><li><span>长林啊</span> 👍（3） 💬（1）<div>老师 你好  在开发RN项目的过程中  应该如何选择RN生态的第三方库呢  有很多库维护更新不是很积极  甚至issue都得靠使用者（踩坑者）自己修改源码来维持项目的正常运行</div>2022-03-29</li><br/><li><span>大土豆</span> 👍（3） 💬（4）<div>抛开主观看法，新项目Flutter的使用率，确实是高于rn的。</div>2022-03-28</li><br/><li><span>小凡</span> 👍（2） 💬（0）<div>干了 6 年 rn，现在大前段啥都干</div>2022-09-21</li><br/><li><span>天择</span> 👍（2） 💬（0）<div>对于国内RN环境搭建，以iOS为例，可以参考这篇博文：https:&#47;&#47;www.jianshu.com&#47;p&#47;412d760bcacd
对于cocoapods的依赖，更新了源依然可能有问题，但可以多试几次pod install，能把所有依赖安装成功。有些是依赖包不是总下不下来，而是偶尔会超时（比如GitHub的资源）。更新源的时候，需要下载新的pod repo，可能会花上相当一段时间。供参考。</div>2022-03-29</li><br/><li><span>爱我所爱</span> 👍（1） 💬（2）<div>react native 环境都没搭建起来。。。</div>2022-06-05</li><br/><li><span>焦糖大瓜子</span> 👍（1） 💬（2）<div>如果没有科学上网,估计很多人停在了android开发环境搭建😂</div>2022-03-29</li><br/><li><span>Geek_e86ebf</span> 👍（0） 💬（0）<div>课程中案例的源码在哪里下载啊？</div>2024-10-11</li><br/><li><span>稀饭</span> 👍（0） 💬（0）<div>我反而很喜欢极客这种有文本的教学模式，不喜欢慕课那种只有视频没有脚本……</div>2024-09-20</li><br/><li><span>阿韦</span> 👍（0） 💬（0）<div>想问一下，这个课程，有没有视频的方式
