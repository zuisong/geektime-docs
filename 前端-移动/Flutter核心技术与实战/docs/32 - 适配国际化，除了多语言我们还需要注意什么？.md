...
<li><span>Geek_keyi</span> 👍（4） 💬（1）<div>图片显示是靠图片名称路径，不同语言环境返回对应图片资源的文件路径即可</div>2019-09-26</li><br/><li><span>zzz why</span> 👍（3） 💬（1）<div>老师，图片资源的国际化适配，可以在assets下创建不同语言的目录，然后利用i18n的翻译功能，在values下对应的arb文件中分别添加不同的图片路径，使用的时候使用S.of(context).images这种方式，完成国际化的图片资源使用。不知道这么做是不是合适</div>2019-09-25</li><br/><li><span>JustinLiu</span> 👍（2） 💬（1）<div>教师节快乐</div>2019-09-10</li><br/><li><span>YJ</span> 👍（1） 💬（1）<div>教师节到了，老师辛苦了！</div>2019-09-10</li><br/><li><span>hopkin</span> 👍（0） 💬（1）<div>其实还是没太懂GlobalMaterialLocalizations.delegate 与 GlobalWidgetsLocalizations.delegate是干嘛的</div>2019-11-07</li><br/><li><span>毛哥来了</span> 👍（0） 💬（1）<div>老师，我把翻译加到Provider那个例子里面报错了，请看看是怎么回事呢
...
错误信息是：The method &#39;message_tip&#39; was called on null.</div>2019-10-29</li><br/><li><span>和小胖</span> 👍（0） 💬（1）<div>图片资源的国际化，本质上还是文本资源的国际化。</div>2019-10-16</li><br/><li><span>迷茫的2月27</span> 👍（2） 💬（5）<div>现在的android studio已经无法搜索到这个插件了
http:&#47;&#47;plugins.jetbrains.com&#47;plugin&#47;10128-flutter-i18n
Plugin removal has been requested</div>2020-01-08</li><br/><li><span>洋洋</span> 👍（0） 💬（0）<div>老师，如果想要在应用内部切换语言我们要怎么是怎么实现呢？</div>2021-05-14</li><br/><li><span>iHTC</span> 👍（0） 💬（0）<div>感谢航哥！文章写的很清晰！

欢迎大家follow 开源的番茄钟倒计时App，有多语言功能。https:&#47;&#47;github.com&#47;iHTCboy&#47;iPomodoro-Flutter 🥳</div>2021-03-07</li><br/><li><span>毛成方</span> 👍（0） 💬（0）<div>老师新年快乐 </div>2021-02-11</li><br/><li><span>jayce</span> 👍（0） 💬（0）<div>flutter 1.22 内置国际化代码生成
https:&#47;&#47;docs.google.com&#47;document&#47;d&#47;10e0saTfAv32OZLRmONy866vnaw0I2jwL8zukykpgWBc&#47;edit#</div>2020-10-02</li><br/><li><span>jayce</span> 👍（0） 💬（0）<div>写个
extension Resource on BuildContext {
  S resource() {
    return S.of(this);
  }
}
调用更简单些，context.resource().app_title</div>2020-09-30</li><br/><li><span>飓风</span> 👍（0） 💬（0）<div>intl_en.arb 对应的key必须有，intl_zh.arb 可以没有。可以反过来吗？</div>2020-09-10</li><br/><li><span>kk</span> 👍（0） 💬（1）<div>老师您好，我现在使用module的方式打包出framework iOS中无法实现多语言，我用的是AS开发，使用了flutter intl插件，跑flutter工程选择iOS设备 是可以正常显示多语言，只要一打出个framework后和原生工程混编就没有多语言打效果，project中语言都设置过了，请问有什么解决方法吗？</div>2020-06-23</li><br/>
</ul>