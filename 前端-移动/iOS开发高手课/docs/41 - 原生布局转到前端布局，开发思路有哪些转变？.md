...
<li><span>Happy_Home</span> 👍（5） 💬（6）<div>swiftUI如果能普及的话估计也得是三年后的事情了，iOS版本要求太高了点</div>2019-06-15</li><br/><li><span>壹</span> 👍（2） 💬（0）<div>看到留言区的状态很揪心，很多人都在关注版本号……记得autolayout推出的时候很多人也是因为系统版本的原因不去学习了解，一句兼容性问题就打发了，然后死抱着frame。以至于到今天仍然是frame，sb，xib，autolayout都不见踪影。然后还总说原生开发慢，没有前端快……</div>2020-04-28</li><br/><li><span>bilibili</span> 👍（2） 💬（0）<div>swiftu对应的是swift语言 然而对着oc的还是mansory用的多 而且健壮性不强 还是用原声frame在搞</div>2019-06-18</li><br/><li><span>哈</span> 👍（1） 💬（0）<div>兼容是个大问题…版本太高了…据说swiftUI和flutter很像</div>2019-06-17</li><br/><li><span>2thousand19</span> 👍（1） 💬（0）<div>戴铭老师分析的很到位，佩服，感谢</div>2019-06-15</li><br/><li><span>无名</span> 👍（1） 💬（0）<div>swiftUI最低要求iOS13，这样兼容性问题...</div>2019-06-15</li><br/><li><span>程序员讲道理</span> 👍（0） 💬（0）<div>SwiftUI 只支持 iOS 13 以上，我不知道苹果怎么想的。而且 iOS 14 之后，SwiftUI 做了大幅度改进。这就意味着你要支持 iOS 13，还得做一些兼容。。</div>2022-04-10</li><br/><li><span>幻想vs梦想</span> 👍（0） 💬（2）<div>现在还有人觉得swiftUI要3年后吗😁</div>2020-07-15</li><br/><li><span>Geek_9dbcb4</span> 👍（0） 💬（0）<div>@State ，标记一个属性，当他改变时，监听这个属性的对象会收到信号，触发自己的逻辑。可以理解为kvo。</div>2020-04-27</li><br/><li><span>Geek_9dbcb4</span> 👍（0） 💬（0）<div>@State，相当于oc里的kvo吧</div>2020-04-18</li><br/><li><span>Code Man</span> 👍（0） 💬（0）<div>讲真，最低支持iOS 13，确实有点过分，这得要出iOS15，16才能全面派得上用场</div>2019-06-24</li><br/><li><span>烈人</span> 👍（0） 💬（0）<div>不知道swiftUI的版本支持情况如何？</div>2019-06-15</li><br/>
</ul>