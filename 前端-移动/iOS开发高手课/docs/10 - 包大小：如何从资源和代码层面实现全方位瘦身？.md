...
<li><span>元元</span> 👍（30） 💬（2）<div>老师ios为什么要设计元类？能讲一下吗</div>2019-04-02</li><br/><li><span>付海龙</span> 👍（2） 💬（1）<div>相比于2x和3x两套资源，用矢量图一套资源搞定所有，这样会不会更好一点</div>2019-04-02</li><br/><li><span>Toon</span> 👍（1） 💬（3）<div>矢量图呢？也可以减少大小吧</div>2019-04-21</li><br/><li><span>开发小能手</span> 👍（1） 💬（2）<div>请教老师，我在评论中看到老师有提到“元类的flag中记录了什么？”这里的 “flag” 是指isa是一个共用体中每段 “位域” 的含义么？还是指其它的概念？</div>2019-04-13</li><br/><li><span>一纸丶荒年</span> 👍（1） 💬（1）<div>您的这个 工具 对于 swfit  和 xib  不适用.  </div>2019-04-12</li><br/><li><span>卓小土</span> 👍（1） 💬（1）<div>戴老师为什么没有讲一下，用clang AST分析代码依赖关系，找出无用代码的方法。</div>2019-04-12</li><br/><li><span>西北旺车神</span> 👍（1） 💬（1）<div>OTA并不是单指蜂窝网络吧，我觉得是指不用连电脑iTunes下载了</div>2019-04-02</li><br/><li><span>李小草</span> 👍（0） 💬（2）<div>之前开发遇到过提供三方sdk的公司提供了两个版本，一个版本带模拟器指令集（支持模拟器的），一个版本是不带模拟器的，只支持arm真机，上线时切换下，这样可以减小包得体积，请问老师这样对吗？如果这样真能减小包体积的话，那我是不是可以把所有三方sdk中模拟器指令集都剔除掉？</div>2019-06-03</li><br/><li><span>一纸丶荒年</span> 👍（0） 💬（2）<div>你好 我下载了 AppCode 工具. 但是 我选择不了 code-&gt;inspectCode 吖 </div>2019-04-15</li><br/><li><span>Geek_i59t1w</span> 👍（0） 💬（1）<div>framework中的i386和x86_64会打包进release app里么？</div>2019-04-09</li><br/><li><span>付海龙</span> 👍（0） 💬（1）<div>在资源图片上，我都是直接用的2x图，像plus等机型也都是直接找的2x</div>2019-04-02</li><br/><li><span>学无止境</span> 👍（0） 💬（1）<div>添加 xcassets 目录?
Xcode不是自带的有Assets.xcassets吗？
</div>2019-04-02</li><br/><li><span>金子菇凉的铁粉小逗</span> 👍（0） 💬（1）<div>王者荣耀和吃鸡这样的游戏为啥可以几个GB</div>2019-04-02</li><br/><li><span>Geek_97bcf5</span> 👍（73） 💬（9）<div>元类和类的数据结构是同一个，只是运行时使用的字段不一样。
...
所以，问这个问题的，都是objc_msgSend源码没看过的同学。</div>2019-04-03</li><br/><li><span>Mit</span> 👍（5） 💬（0）<div>重复图片与无用图片的检索工具 
https:&#47;&#47;github.com&#47;mitchell-dream&#47;MitImgChecker  可以尝试一下这个工具。</div>2019-08-26</li><br/>
</ul>