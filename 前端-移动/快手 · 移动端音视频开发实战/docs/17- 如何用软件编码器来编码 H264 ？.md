...
Q7：最后写入的h264文件，是二进制文件吗？</div>2022-08-31</li><br/><li><span>xueerfei007</span> 👍（0） 💬（0）<div>老师您好，我最近在使用ffmpeg编码工业相机sdk提供的raw帧数据。目前编码后，视频的时间与原始视频流对不上，编码长度比录制时长多了一倍。猜测可能与pts&#47;dts的设置有关。这个需要如何设置，或者有什么方法定位到问题的具体原因？</div>2023-08-05</li><br/>
</ul>