...
<li><span>国旗</span> 👍（1） 💬（2）<div>老师课程代码有线上仓库地址么？</div>2021-04-20</li><br/><li><span>Yarco</span> 👍（4） 💬（1）<div>私以为这是桌面软件向web应用方向演化的最重要的过程，以前的话受限于cpu,带宽等等诸如此类的硬件条件, web&#47;浏览器中的虚拟机不可能有这种效果。当硬件层次的提上去，当webassembly慢慢成熟, 5G普及. 那么桌面软件web化趋势将不可避免.......
与其说是前端开发，不如说是桌面开发...... 是桌面软件应用的技术在web领域复现一次.</div>2020-10-21</li><br/><li><span>言言周</span> 👍（1） 💬（0）<div>感谢老师</div>2020-10-21</li><br/><li><span>Geek_14eaee</span> 👍（0） 💬（0）<div>为啥不一开始的时候 就给一个demo，让我们看看他能干什么</div>2023-09-26</li><br/>
</ul>