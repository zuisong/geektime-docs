...
![](https://static001.geekbang.org/resource/image/dd/1e/dd8b5d1cb842c822fafa128719ec021e.png?wh=912%2A348)
...
![](https://static001.geekbang.org/resource/image/03/e0/032e738fd9df278623a79f147e77fce0.png?wh=1920%2A309)
...
![](https://static001.geekbang.org/resource/image/61/96/61494e773045613a4339dc56438ef896.png?wh=1412%2A542)
...
![](https://static001.geekbang.org/resource/image/fa/c1/fa38166961e917ea6a321f84d3d4d4c1.png?wh=1746%2A694)
...
![](https://static001.geekbang.org/resource/image/4d/88/4d145e1d2bfd986c10def9a6afa9cf88.png?wh=1920%2A287)
...
![](https://static001.geekbang.org/resource/image/ae/fe/ae1b52340f802f25a09c31c13a2a22fe.png?wh=1296%2A594)
...
![](https://static001.geekbang.org/resource/image/e5/1b/e5440a10376fee148c96c53a846a6f1b.png?wh=1302%2A422)
...
![](https://static001.geekbang.org/resource/image/8f/99/8f77b820113df5635497a5ad20a03299.png?wh=1286%2A542)
...
![](https://static001.geekbang.org/resource/image/13/8e/13697353748c1637643a6970db22808e.png?wh=1292%2A700)
...
<li><span>坚持远方</span> 👍（6） 💬（1）<div>平时遇到的比较耗电的就是关于屏幕常亮、定位、以及广播等方面，所以在开发过程中就会谨慎使用WakeLock，对于多个模块使用定位时尽量复用上一次的定位结果，而且要选择合适的Location Provider，而且在网络请求方面，无网状态下避免进行网络请求等，还希望作者能够给出更加丰富的解决方案</div>2019-01-30</li><br/><li><span>Geek_941030</span> 👍（2） 💬（2）<div>耗电量这块， 因为要维持推送的实时到达， 只能追求黑科技， 要不然人家就会问，为啥苹果可以收到推送，android就不行~  但是保活就会加大耗电， 好纠结， 希望大神能给点推送方面的意见</div>2019-03-14</li><br/><li><span>亮仔</span> 👍（1） 💬（1）<div>本篇文章主要写的是系统方面如何管控应用已达到省电的效果，对于我们日常应用开发角度来说需要注意哪些点已达到我们自己的应用更省电。</div>2019-01-29</li><br/><li><span>汪旭光</span> 👍（1） 💬（2）<div>一开始那个笑话不应该说的是iphone吗？电池容量太小，😂😂😂😂</div>2019-01-29</li><br/><li><span>哈珀朋友</span> 👍（0） 💬（5）<div>国内软件都在追求永驻后台等等黑科技，提高从业者素质就能极大提高Android手机的续航能力</div>2019-01-29</li><br/><li><span>程序员小跃</span> 👍（5） 💬（1）<div>在以前的项目组，做过加入厂商白名单的努力，几个同事投入很大</div>2019-04-24</li><br/><li><span>无敌肥球王</span> 👍（3） 💬（0）<div>把微信QQ加白名单是因为使用频率高，频繁重启的话，用户会选择优先投诉厂商，而不是腾讯。</div>2020-11-22</li><br/><li><span>douvril</span> 👍（2） 💬（0）<div>搜索蓝牙，搜索wifi信号，都挺耗电的。</div>2020-04-11</li><br/><li><span>less</span> 👍（1） 💬（0）<div>之前提过 保活方案 再耗电章节有说明 没找到呀 能否具体明示下</div>2019-05-15</li><br/><li><span>杨迁</span> 👍（0） 💬（0）<div>动画一直在做，耗电</div>2021-09-06</li><br/><li><span>EchoSomeTH</span> 👍（0） 💬（1）<div>bugreport.zip怎么分析啊，那个historian得通过go跑的得vpn才能搞下来，而且是本地端口访问的。
