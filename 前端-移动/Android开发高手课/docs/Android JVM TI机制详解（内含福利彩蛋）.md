...
<li><span>功夫熊猫</span> 👍（2） 💬（1）<div>方法执行这段里的FileAccess 这个是不是写错了，应该是FieldAccess
https:&#47;&#47;docs.oracle.com&#47;javase&#47;7&#47;docs&#47;platform&#47;jvmti&#47;jvmti.html#FieldAccess</div>2018-12-26</li><br/><li><span>程序员小跃</span> 👍（0） 💬（2）<div>完了，第一次听说这个JVM TI 很认真的看了，还是有点不大明白，需要更好的消化下</div>2019-03-13</li><br/><li><span>bonan</span> 👍（8） 💬（0）<div>今天看到Matrix 开源了，老师有计划介绍一下嘛？</div>2018-12-25</li><br/><li><span>hbl</span> 👍（1） 💬（0）<div>刚才看到Android 8.0 以后可以使用 apply change  这个功能通过 Android Studio 3.5 能够实现代码的动态加载，并且不需要重启，稍微了解了下原理，发现正是使用 JVM TI 的方式实现的</div>2019-08-15</li><br/><li><span>Eric 老乌龟</span> 👍（1） 💬（0）<div>确实不太了解这块，先Mark下，用到了来学😂</div>2019-01-08</li><br/><li><span>GEEK_jahen</span> 👍（0） 💬（0）<div>运行Sample还是有闪退现象</div>2022-10-26</li><br/><li><span>珞小飞</span> 👍（0） 💬（0）<div>dexmaker貌似只能生成字节码，没办法修改已有字节码？</div>2020-06-01</li><br/>
</ul>