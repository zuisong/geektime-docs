...
<li><span>姑射仙人</span> 👍（3） 💬（1）<div>对云厂商最有优势</div>2020-04-17</li><br/><li><span>闹够了</span> 👍（1） 💬（1）<div>我要提前上车了</div>2020-04-22</li><br/><li><span>麦乐</span> 👍（0） 💬（1）<div>我也要上车了~</div>2020-06-16</li><br/><li><span>大表哥</span> 👍（5） 💬（0）<div>好一个’钱’字，不仅仅打动了我，也打动了老板的心儿啊。哈哈哈。你们要小心了后台架构来学serverless了！</div>2020-04-28</li><br/><li><span>008</span> 👍（4） 💬（0）<div>如果有vendor-lock的前提的话，“至少要做到能让开发者以一种方式专注于业务代码的开发，无需关注运行平台的差异性，一处编写可以处处运行，开发者只要掌握一种方式就可以在不同业务之间没有学习成本地切换”，这句话还是片面了，“处处运行”仍然是局限的。

不过所有上云的事情，总会面临不少厂商差异，就看企业如何评估这个差异在未来给自己带来的麻烦。</div>2020-04-20</li><br/><li><span>余熙</span> 👍（1） 💬（1）<div>今天看到，阿里函数计算(包年包月) - 已于2021年08月03日0时下线，我去试用腾讯云函数，给大伙探探路鸭</div>2022-03-20</li><br/><li><span>IT小村</span> 👍（0） 💬（0）<div>serverless目前还是后端在用</div>2022-11-05</li><br/><li><span>Roway</span> 👍（0） 💬（0）<div>水电煤是好东西</div>2020-05-29</li><br/>
</ul>