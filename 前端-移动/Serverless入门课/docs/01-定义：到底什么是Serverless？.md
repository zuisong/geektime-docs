...
<li><span>pedro</span> 👍（30） 💬（2）<div>这里不得不提微信小程序的云开发其实就是一种意义上的 serverless，让前端工程师不仅可以开发页面还可以通过云函数(Faas)来写业务，而且还提供了基础存储(Baas)。</div>2020-04-15</li><br/><li><span>JackPn</span> 👍（8） 💬（3）<div>这个有点牛皮，感觉这样一来程序员的技术活只剩下写逻辑了，其他的都是管理</div>2020-04-15</li><br/><li><span>大表哥</span> 👍（6） 💬（1）<div>听了这节课感觉这钱没白花，妥妥的实力派。然后一开始吸引我的是省钱哈哈哈（我是说中长尾服务模块）。作为一个12年后台开发、架构师也来拥抱一下serverless。</div>2020-04-28</li><br/><li><span>24601</span> 👍（6） 💬（1）<div>我在力拓上写函数，感觉也算是 severless🤔</div>2020-04-18</li><br/><li><span>猫切切切切切</span> 👍（4） 💬（2）<div>读后感：
...
3. 优缺点：
优点是可降低服务运维成本
缺点是对云服务商形成依赖</div>2020-08-13</li><br/><li><span>程序员二师兄</span> 👍（3） 💬（8）<div>我的作业：http:&#47;&#47;my-bucket-1253451803.cos-website.ap-guangzhou.myqcloud.com&#47;</div>2020-04-16</li><br/><li><span>黄耗子皮</span> 👍（2） 💬（1）<div>请问图是用什么工具画的。。</div>2020-05-12</li><br/><li><span>Cryhard</span> 👍（1） 💬（1）<div>好用，稳定，方便——才是好的“容器”，希望serverless这种比docker更加“容器化”的“运行时”技术方向能够经得起时间的考验。</div>2020-04-26</li><br/><li><span>闹够了</span> 👍（1） 💬（2）<div>因为之前已经看过不少这种了。对serverless也比较感兴趣。但是之前写的demo都是类似于hello world。不知道怎么连接数据库。哈哈哈。现在大概知道了。然后的话他是通过算法还是什么达到的扩容和收缩？</div>2020-04-24</li><br/><li><span>神执念の浅言多行</span> 👍（1） 💬（1）<div>老师，请问完成这个课程的作业，是需要拥有一个域名才可以的吗？</div>2020-04-21</li><br/><li><span>程序员二师兄</span> 👍（1） 💬（1）<div>Serverless 让服务端免运维，这一点很赞，发布应用不需要运维了。
老师留的作业准备今天中午实践一下，实践完再来留言。</div>2020-04-16</li><br/><li><span>每天晒白牙</span> 👍（1） 💬（5）<div>这样搞下去，程序员门槛越来越低，如果不提高自己的核心竞争力，真的要失业了😂</div>2020-04-16</li><br/><li><span>吴小智</span> 👍（1） 💬（1）<div>老师的思路还是很赞，对 Serverless  有了比较清晰饿认识。</div>2020-04-15</li><br/><li><span>David.</span> 👍（1） 💬（1）<div>FaaS 在aws上可以通过API Gateway+lambda实现，请问老师BaaS具体可以通过什么方式实现呢？</div>2020-04-15</li><br/><li><span>Ricky</span> 👍（0） 💬（1）<div>文中 “Serverfull” 应为 Serverful，作者意将 full 与 less 两词的对比来加强读者的理解，但业界并无 serverfull 一说</div>2023-05-10</li><br/>
</ul>