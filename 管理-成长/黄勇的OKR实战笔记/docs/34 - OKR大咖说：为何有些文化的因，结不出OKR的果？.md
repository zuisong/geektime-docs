...
<li><span>杀地瓜</span> 👍（4） 💬（0）<div>文中管理者价值观对于OKR的实施甚为重要，所谓兵熊熊一个，将熊熊一窝，再好的理论需要实施者的操作和布局，也需要这个团队的文化能否接地气的施展开来，所以天时（互联网时代）地利（公司位置）人和（团队文化和管理者价值观）让OKR更加具有潜力去开花结果。</div>2019-09-16</li><br/><li><span>IT蜗壳-Tango</span> 👍（0） 💬（0）<div>打卡</div>2020-03-29</li><br/>
</ul>