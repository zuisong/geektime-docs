...
<li><span>SnowHide雪诺海德</span> 👍（4） 💬（0）<div>虚拟现实的场景里所有的东西都是虚拟的，增强现实的场景里既有真的亦有虚的。

前者完全是假的，后者部分是假的。</div>2019-02-14</li><br/><li><span>谷鱼</span> 👍（0） 💬（0）<div>非常喜欢这个故事，大开眼界。之前也在vr公司上班，如今才理解htc也在这里面发挥作用</div>2021-10-08</li><br/><li><span>羽翼</span> 👍（0） 💬（1）<div>老师很喜欢 花开两朵各表一枝 这句胡，再多节课里有用到</div>2021-02-12</li><br/><li><span>caohuan</span> 👍（0） 💬（0）<div>请问老师：虚拟现实与增强现实 的区别在哪里？

htc 转型到 虚拟现实  htc原本是硬件开发企业 设计 和 制造硬件，valve为 游戏开发者 服务于游戏玩家，二家 合作 服务 玩家，让玩家 有更好的体验，吴军老师 提过：新产品 在黄赌毒 的应用，为产品 全面打开市场 的预演，期待 htc 与valve 的虚拟现实 产品vive 越走越好。</div>2018-12-06</li><br/>
</ul>