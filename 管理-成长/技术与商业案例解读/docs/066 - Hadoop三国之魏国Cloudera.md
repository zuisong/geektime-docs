...
<li><span>caohuan</span> 👍（4） 💬（0）<div>cloudera 可能没有自己的存储业务需求 所以没有吹起 大数据存储的服务，亚马逊 和 阿里巴巴 都因为 自身的业务 把云平台 搭建起来，不但满足自己的业务，多余的还可以用来销售，自己做事 不忘顺便捞钱。

徐飞老师 怎么解释：雅虎是 ‘活雷锋’的形象</div>2018-11-30</li><br/><li><span>Geek_d76385</span> 👍（1） 💬（0）<div>现在cloudera总市值47亿，解英特尔解套了</div>2021-09-24</li><br/><li><span>星轨</span> 👍（0） 💬（0）<div>没用的话咋那么多呢？</div>2022-05-18</li><br/><li><span>self-discipline</span> 👍（0） 💬（0）<div>开源项目有些类似于WinRAR模式,有口碑形成标准,然后收企业的钱,Spark的诞生就是因为cloudera不是标准导致,从而杀出重围的</div>2019-09-30</li><br/><li><span>穿越时间与空间的旅行家</span> 👍（0） 💬（0）<div>现在cloudera股价5美元。</div>2019-06-16</li><br/><li><span>莲花</span> 👍（0） 💬（0）<div>现在hadoop算是稳定吗？有竞争者吗？</div>2018-09-27</li><br/>
</ul>