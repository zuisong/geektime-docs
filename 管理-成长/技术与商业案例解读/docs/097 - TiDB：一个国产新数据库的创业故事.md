...
<li><span>不去彼岸</span> 👍（1） 💬（1）<div>能点评下Lealone这个数据库吗</div>2019-02-02</li><br/><li><span>拉欧</span> 👍（0） 💬（1）<div>跟MySQL保持兼容是就成功了一半，能支持更好的扩展就一定可以成功了</div>2019-06-07</li><br/><li><span>云师兄</span> 👍（5） 💬（0）<div>tidb这种newsql数据库采用的兼容主流mysq和提供从库使用的策略简直就是完美啊！</div>2019-10-28</li><br/><li><span>lijianping</span> 👍（4） 💬（0）<div>华为的高斯数据库也有很多用户</div>2019-04-11</li><br/><li><span>远古的咖啡</span> 👍（0） 💬（0）<div>很棒！</div>2020-04-07</li><br/><li><span>Panda</span> 👍（0） 💬（0）<div>TiDB 现在在国内越来越火 后起之秀</div>2019-02-26</li><br/>
</ul>