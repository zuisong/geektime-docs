...
<li><span>LYy</span> 👍（14） 💬（3）<div>老师 To B业务有什么好的模型吗？</div>2021-02-17</li><br/><li><span>周平</span> 👍（6） 💬（2）<div>1.漏斗模型只适合2C业务。
...
还记得在做一个新的产品项目的时候(运营最关键)，当时我的老大就天天不在工位，天天和运营老大在一起，原来这样了解业务需要最快了。</div>2021-04-23</li><br/><li><span>飞翔</span> 👍（3） 💬（1）<div>老师好，做存储的公司，有一个研发中心经理，下面有负责分布式nas的组长，san存储的组长，还有几个测试组长，下面就是开发人员。
这种架构的公司，人员各属于什么职级，P几？
低层工作5-6年的开发应该具备P几的能力了？</div>2021-02-16</li><br/><li><span>麦峰强</span> 👍（2） 💬（1）<div>想请教下针对开发者生态我们该用哪个模型来评估</div>2021-07-17</li><br/><li><span>Milo</span> 👍（1） 💬（1）<div>老师您好，如果是做中台的话，有什么模型或者书籍推荐么</div>2022-12-04</li><br/><li><span>老实人Honey</span> 👍（0） 💬（1）<div>网红带货直播也可以作为这节的例子。</div>2023-02-08</li><br/><li><span>Jian</span> 👍（0） 💬（1）<div>华仔，可以加餐讲讲2b的吗：）</div>2021-03-07</li><br/><li><span>robing</span> 👍（0） 💬（1）<div>这个AA222模型有没有使用事例理论看着有，但是实际使用的时候不知如何应用。</div>2021-03-03</li><br/><li><span>大魔王汪汪</span> 👍（0） 💬（1）<div>在了解了一定业务之后，如何将其体现在技术上呢？是让系统规划更好的服务于业务目标产生收益吗？比如star模型体现业务目标和技术动作。</div>2021-03-01</li><br/><li><span>王同学</span> 👍（0） 💬（0）<div>感觉这个漏斗AARRR只适合to C业务</div>2021-02-20</li><br/>
</ul>