...
<li><span>Knight²º¹⁸</span> 👍（24） 💬（1）<div>希望老师能在新的章节开始之前解答一下上一章节的问题，谢谢</div>2018-05-13</li><br/><li><span>丸子</span> 👍（21） 💬（1）<div>能讲一下两个失败案例怎么改进能达到mvp的要求么</div>2018-05-15</li><br/><li><span>徐东鹏～种下一朵太阳花</span> 👍（11） 💬（1）<div>实际情况是家长都有微信群或QQ群，群已经解决了频繁沟通的问题，通过这两个平台上的第三方应用更容易来做产品，比如微信小程序。
既然要求用App，就按这个方向来吧。
后台：学生管理、家长管理、家长会管理、学生问题管理、家长访谈记录。 
app：家长获取教师分配的账号，查看学生问题， 家长和老师基于问题进行讨论（留言板，便于查看内容 并降低反馈时长预期）、学生问题解决方案。

拼多多：有人拼团更实惠。</div>2018-05-13</li><br/><li><span>herongchang</span> 👍（11） 💬（1）<div>可行性产品很重要，因为真正好的产品都是实践出来的，单纯想是根本不可能。MVP给了快速试错的机会。所以最大的核心是试错</div>2018-05-12</li><br/><li><span>linda.zx</span> 👍（5） 💬（1）<div>1.这个app最小可行产品应该是基于现有沟通方式快速建立起老师和家长的沟通渠道，方便老师能联系上问题学生的家长，家长也能找到对应的任课老师了解孩子的情况。
基本功能应有：
...
突然发现研究这些发展历程还是蛮有趣的～😀</div>2018-05-18</li><br/><li><span>William</span> 👍（4） 💬（1）<div>帮助学生和家长这个app最小可行性情况可以考虑做每天学生动态。老师每天拍摄一些学生照片发布，类似ins的。只发照片加简短文字。家长可like或评论。初始家长数据及学生数据关联等直接后台导入。慢慢再加一些围绕功能，如照片加tag。圈家长。幼儿及活动发起报名，以及学校通知推送等。</div>2018-05-19</li><br/><li><span>山下哩人</span> 👍（2） 💬（1）<div>老师和家长的链接纽带是学生，所以最小化MVP以学生为方向。
...
竟然想不到二期，难道线上作业？做家长社交？</div>2018-05-18</li><br/><li><span>Leo</span> 👍（1） 💬（1）<div>老师好，关于MVP阶段，有一些问题想请教一下，以下是我自己根据经验整理和总结的产品在MVP表现不佳的原因，有两个方面:
产品方面：
...
</div>2018-09-17</li><br/><li><span>kiko</span> 👍（6） 💬（1）<div>拼多多的MVP：
1、登陆注册
2、商品详情页面
3、拼团+参团
4、购买支付页面
...
针对有评论说发红包的事情，老师红包是敏感的关键词，还有提到的排名，现在学校也是不提倡的。</div>2019-07-21</li><br/><li><span>歌行</span> 👍（4） 💬（2）<div>最近买了您的课程，深受启发。做完课后作业发现跟精选留言的思路都不太相同。
...
希望您的回复，简单评价就好，谢谢您！
</div>2018-08-12</li><br/><li><span>杨蕊</span> 👍（2） 💬（0）<div>最小可行性APP可以包含如下功能： 
...
3.还需要一个类似公告的地方可以放一些公共信息，比如作业布置，放假通知等。</div>2020-04-22</li><br/><li><span>摇之</span> 👍（2） 💬（1）<div>1.定位：搭建家校互动SaaS平台，在这个平台上提供增值服务，如学生保险，发作业，发成绩，报名补习班。
