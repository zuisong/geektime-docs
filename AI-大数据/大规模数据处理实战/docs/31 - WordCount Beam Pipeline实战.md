...
<li><span>cricket1981</span> 👍（1） 💬（1）<div>如何用Apache Beam求word count TopK问题呢？</div>2019-07-12</li><br/><li><span>cricket1981</span> 👍（1） 💬（1）<div>如果要按word出现次数从大到小排序应该怎么写？</div>2019-07-12</li><br/><li><span>杰洛特</span> 👍（6） 💬（4）<div>前两章还在说不要使用任何 DoFnTester 进行测试，这边怎么又来写 DoFnTester 了？感觉这专栏像是很多人写了拼起来的，有很多前后矛盾的地方</div>2019-11-14</li><br/><li><span>cricket1981</span> 👍（4） 💬（0）<div>Beam的函数确实难用，不像spark和scala collection那样用起来直观. 
sc.textFile(&quot;file:&#47;&#47;&#47;your-input.txt&quot;).flatMap(_.split(&quot;[^\\p{L}]+&quot;)).map((_,1)).reduceByKey(_+_).map(_.swap).sortByKey(false).map(_.swap).collect</div>2019-07-12</li><br/><li><span>李孟聊AI</span> 👍（1） 💬（0）<div>这还是比较重，spark求同样的需求几个函数就搞定了</div>2019-07-08</li><br/><li><span>之渊</span> 👍（0） 💬（0）<div>实例代码 https:&#47;&#47;gitee.com&#47;oumin12345&#47;daimademojihe&#47;blob&#47;e20d60b93113d2537f4bd2e7f38b23ac17d4c3c0&#47;cloudx&#47;bigdata&#47;src&#47;main&#47;java&#47;test&#47;beam&#47;WordCountBeam.java
...
2. 如果要类比的话，就好像 Apache beam 就是mybatis ， 而 spark ,flink 就是 hibernate了。</div>2020-08-23</li><br/><li><span>Hank_Yan</span> 👍（0） 💬（0）<div>还是spark方便一些。。。beam看了这么多节，只能感受到其出发点，问题抽象的独到之处，很难感受实际工作中会带来什么益处，文中例子不太容易领悟到这点。</div>2020-07-11</li><br/><li><span>jeeeeeennnny</span> 👍（0） 💬（1）<div>Sideinput 可以根据业务逻辑新增数据吗？</div>2020-03-24</li><br/>
</ul>