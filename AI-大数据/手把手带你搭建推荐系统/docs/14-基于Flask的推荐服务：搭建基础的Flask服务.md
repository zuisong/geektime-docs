...
<li><span>Geek_ccc0fd</span> 👍（4） 💬（1）<div>直接request.get_json()就可以了，不需要get_data再json.loads一遍：
...
def sum():
    try:
        ...
        return jsonify({&#39;code&#39;: &#39;500&#39;, &#39;msg&#39;: &#39;error&#39;})</div>2023-05-17</li><br/><li><span>欢少の不忘初心</span> 👍（0） 💬（1）<div>最近刚学了Go，拿Go来练练手。老师Go语言  Gin框架也可以吧</div>2023-06-03</li><br/><li><span>peter</span> 👍（0） 💬（1）<div>python适合用来开发中型、大型网站吗？ Python是不是难以处理高并发？</div>2023-05-18</li><br/><li><span>海欧</span> 👍（0） 💬（1）<div>这个flask结合docker可以做到多大的并发，有什么实现技巧吗</div>2023-05-17</li><br/><li><span>一叶浮萍</span> 👍（0） 💬（1）<div>老师, 一般公司高并发的请求都是后端统一来处理的, 他们调用推荐系统的话一般是grpc吗, 还是其他什么方式?</div>2023-05-17</li><br/><li><span>GAC·DU</span> 👍（2） 💬（0）<div>Github作业地址：https:&#47;&#47;github.com&#47;gacdu&#47;recommendation-service</div>2023-05-17</li><br/>
</ul>