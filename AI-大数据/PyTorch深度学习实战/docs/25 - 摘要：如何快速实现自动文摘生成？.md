...
<li><span>ifelse</span> 👍（1） 💬（1）<div>学习打卡</div>2023-12-14</li><br/><li><span>XTZ</span> 👍（0） 💬（1）<div>跑预处理的时候报了错Provided `function` which is applied to all elements of table returns a `dict` of types [&lt;class &#39;list&#39;&gt;, &lt;class &#39;list&#39;&gt;, &lt;class &#39;torch.Tensor&#39;&gt;, &lt;class &#39;torch.Tensor&#39;&gt;]. When using `batched=True`, make sure provided `function` returns a `dict` of types like `(&lt;class &#39;list&#39;&gt;, &lt;class &#39;numpy.ndarray&#39;&gt;)`但是这个返回值不能去掉任何一条啊</div>2022-09-10</li><br/><li><span>Geek_709f77</span> 👍（0） 💬（8）<div>有交流群能加么？</div>2022-04-16</li><br/><li><span>(●—●)</span> 👍（0） 💬（2）<div>请问模型下载了一半，然后断网了，运行的结果不一致，怎么解决呢？或者有交流群吗？</div>2022-03-22</li><br/><li><span>蓝色天空  好萌啊</span> 👍（0） 💬（1）<div>老师，有完整的BART代码地址吗？</div>2022-01-27</li><br/><li><span>蓝色天空  好萌啊</span> 👍（0） 💬（1）<div>还有T5、去年比较热的prompt和对比学习等</div>2022-01-27</li><br/><li><span>钱钱钱我爱钱</span> 👍（3） 💬（0）<div>请问老师的代码仓库在哪里呢？没找到</div>2023-05-01</li><br/><li><span>Archer</span> 👍（0） 💬（0）<div>方老师 ，您好。
...
请问您有遇到过类似的问题吗？如何解决呢？</div>2022-10-04</li><br/><li><span>亚林</span> 👍（0） 💬（0）<div>老师的例子没跑通，我用官网的文摘微调，T5-saml训练 BillSum 数据集跑通了。
https:&#47;&#47;huggingface.co&#47;docs&#47;transformers&#47;tasks&#47;summarization</div>2022-06-10</li><br/><li><span>亚林</span> 👍（0） 💬（0）<div>老师的源代码训练有点牛，我还是用官网T5简单的弄了弄。
https:&#47;&#47;huggingface.co&#47;docs&#47;transformers&#47;tasks&#47;summarization</div>2022-06-10</li><br/><li><span>亚林</span> 👍（0） 💬（0）<div>summarizer = pipeline(&quot;summarization&quot;)
