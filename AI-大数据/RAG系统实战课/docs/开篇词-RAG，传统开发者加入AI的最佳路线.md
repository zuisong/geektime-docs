...
<li><span>Billy火炎焱燚(不羁的风)</span> 👍（4） 💬（0）<div>后续章节的金句：为什么不使用LLM得出前天的具体日期？
...
另外，实事求是和精益求精并不冲突。我们工程师实事求是把AI应用落地，AI科学家们精益求精解决大模型做数学计算的问题。工程师和科学家都是为AI、为社会、为人类做贡献，我们只是分工不同而已。</div>2024-09-15</li><br/><li><span>Billy火炎焱燚(不羁的风)</span> 👍（0） 💬（0）<div>精选答读者问：为什么不使用LLM的tool-calling功能，生成结构化的SQL？

因为相当多（甚至可以说绝大部分）MIS系统并不使用SQL来增删改查数据，而是使用ORM。所以我们这门专栏是使用LLM生成ORM所需要的参数，然后调用ORM的查询功能。</div>2024-09-15</li><br/><li><span>Billy火炎焱燚(不羁的风)</span> 👍（4） 💬（3）<div>精选答读者问：为什么放弃了OpenAI？
...
</div>2024-09-15</li><br/><li><span>张申傲</span> 👍（6） 💬（1）<div>开篇词打卡~
我也是互联网后端开发转型进入AI赛道，看到老师的课程就第一时间加入了，希望能跟着课程一起全面、系统地掌握RAG相关技术。
小建议：对于很多开发工程师来说，AI领域的一些概念和原理可能是个短板，希望老师在项目实战过程中，可以尽可能覆盖一些AI相关知识和原理的讲解。</div>2024-09-05</li><br/><li><span>NEO</span> 👍（2） 💬（1）<div>建议加个智能知识库的搭建的项目实践。</div>2024-09-06</li><br/><li><span>德慢慢</span> 👍（1） 💬（1）<div>老师可否把rag在整个AI赛道的流程地位，讲一下呢？</div>2024-09-12</li><br/><li><span>grok</span> 👍（1） 💬（1）<div>@老师：每节课后面能否加一些拓展阅读，比如blog&#47;paper&#47;book_chapter之类的
@小编：这门课是否有学习群</div>2024-09-06</li><br/><li><span>nuan</span> 👍（0） 💬（1）<div>不先解释下RAG什么吗？</div>2024-09-12</li><br/><li><span>技术骨干</span> 👍（0） 💬（1）<div>跟上时代的脚步</div>2024-09-09</li><br/><li><span>Billy火炎焱燚(不羁的风)</span> 👍（1） 💬（1）<div>后面章节金句：第17节 通过相似度模糊检索

明明向量数据库就提供了更方便、性能更高的相似度检索功能，为什么还要用LangChain的相似度检索功能？</div>2024-09-15</li><br/><li><span>石云升</span> 👍（0） 💬（0）<div>开始学习~</div>2024-09-25</li><br/><li><span>极客时间攻城狮。</span> 👍（0） 💬（0）<div>很灵敏</div>2024-09-23</li><br/><li><span>Eric</span> 👍（0） 💬（0）<div>老师可否把azure openai作为例子加入案例里，多一个选择。另外，openai的新产品也同步更新一下</div>2024-09-14</li><br/>
</ul>