...
<li><span>ティア（Erlin Ma）</span> 👍（1） 💬（1）<div>可以根据需求，只获取感兴趣的类别的文章，或者按照类别分多次获取。
同意类别内的文章，也可以按照喜好或者基于特定指标进行排序后去top##。
说到底，感觉就是信息提供方的推荐策略的反向应用。不知大家是否同意，欢迎讨论。</div>2024-09-18</li><br/><li><span>jfdghb</span> 👍（0） 💬（1）<div>老师，这个爬虫需自己要去学吗</div>2024-09-26</li><br/><li><span>石云升</span> 👍（0） 💬（1）<div>根据自己的喜好，设置不同维度，然后让AI去评分，总分10分，让AI筛选出评分高于8分的文章。这块可以做的简单，也可以很复杂。</div>2024-09-25</li><br/><li><span>小韩爱学习</span> 👍（0） 💬（0）<div>催更+++</div>2024-09-18</li><br/>
</ul>