...
<li><span>奥特虾不会写代码</span> 👍（10） 💬（1）<div>老师你好，通过这一篇文章又学习到了一些 AI 领域好用的开源工具，例如 LocalAI，想请教一下您平时都是通过哪些渠道获取到有关 AI 开源项目的这部分信息？</div>2023-09-12</li><br/><li><span>iLeGeND</span> 👍（4） 💬（1）<div>Flowise和longchain之间什么关系呢</div>2023-08-17</li><br/><li><span>顾琪瑶</span> 👍（3） 💬（1）<div>使用ReAct方式的话, 是如何将用户的提问&#47;需求, 拆解成prompt的?
或者在之后的课程中会详细讲这一点吗?</div>2023-08-17</li><br/><li><span>Geek_bdceaa</span> 👍（2） 💬（2）<div>需要多大内存和显存的服务器呀</div>2023-08-16</li><br/><li><span>aLong</span> 👍（1） 💬（1）<div>这节课让我觉得教了一套串起来的流程和工具。 爽 开眼界了。</div>2023-12-06</li><br/><li><span>Decoder波</span> 👍（1） 💬（1）<div>老师您好，测了一下LocalAI，发现它提供的是一个同步接口，有多个请求的时候，后面的请求要排队等着，LocalAI可以提供异步的接口吗？</div>2023-09-26</li><br/><li><span>福禄妹妹</span> 👍（0） 💬（1）<div>老师，如何用市面上的智能体创建工具，比如智谱的智能体自建工具，如何用这样的工具创建属于自己的智能体？ 原理类似么？</div>2024-12-03</li><br/><li><span>InfoQ_6792a017d8d3</span> 👍（0） 💬（1）<div>老师，有学习交流群吗</div>2024-02-23</li><br/><li><span>周晓英</span> 👍（0） 💬（1）<div>这节课知识密度好高，Flowise可视化调用可以帮助读者快速理解概念，这是一种非常好的教学方式</div>2023-10-02</li><br/><li><span>Geek_6d035f</span> 👍（0） 💬（1）<div> OpenAI Api Key是自己去申请吗</div>2023-09-19</li><br/><li><span>任易</span> 👍（0） 💬（1）<div>老师您好，目前我们正在探索 SQLDatabaseChain在实际生产过程中的应用，在单表的查询等需求表现还好，一旦涉及到多表之间关联的复杂需求，生成的sql往往不可用，正在针对prompt参数进行调整，老师能讲讲SQLDatabaseChain的具体应用吗?</div>2023-09-12</li><br/><li><span>馍馍汉宝</span> 👍（0） 💬（1）<div>老师，最后说到langchain有性能问题，那这个我们应该怎么解决呢？自己自建一套调用流程吗？</div>2023-09-02</li><br/><li><span>骨汤鸡蛋面</span> 👍（0） 💬（1）<div>比如我基于一个文档做问答，用户的问题暂时分为两种：普通问题、摘要。这种情况一般需要
1. 识别问题是摘要还是普通问题
2. 对于不同的问题使用不的llm chain或prompt
3. 针对这个场景，有现成的agent嘛？</div>2023-09-01</li><br/><li><span>Janeyzhan</span> 👍（0） 💬（2）<div>Flowise怎么下载</div>2023-08-17</li><br/><li><span>甲子光</span> 👍（0） 💬（3）<div>Flowise怎么下载
</div>2023-08-16</li><br/>
</ul>