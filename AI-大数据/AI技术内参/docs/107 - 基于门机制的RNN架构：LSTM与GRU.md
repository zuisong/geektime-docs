...
<li><span>黄德平</span> 👍（2） 💬（0）<div>个人认为是解决梯度异常的需要催生了门机制，然后发现门机制可以进行长时序信息的选择性提取</div>2018-12-13</li><br/><li><span>离忧</span> 👍（0） 💬（0）<div>rnn需要门机制，应该是为了防止剃度消失等情况，所以为了防止这样情况，应该建模的时候，就需要。</div>2018-07-01</li><br/>
</ul>