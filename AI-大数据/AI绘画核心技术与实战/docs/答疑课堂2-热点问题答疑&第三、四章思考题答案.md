...
<li><span>Geek_7ce725</span> 👍（1） 💬（1）<div>针对25讲中 如何生成文字，我有一个想法
通过chat抽无用户prompt中想要显示的文本内容，然后随机选择一款字体，生成对应的mask，基于controlnet技术对mask渲染，然后再去除result image 中 mask之外的内容 获得一张艺术字png</div>2023-09-15</li><br/><li><span>Geek_7ce725</span> 👍（0） 💬（0）<div>diffusers即将支持blipdiffusion和control_lora，风格临摹的效果将会得到改善</div>2023-09-15</li><br/>
</ul>