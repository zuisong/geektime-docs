...
<li><span>Geek_guo</span> 👍（28） 💬（3）<div>老师预测的很准，阿里的玄铁就是基于RSIC-v的</div>2019-08-06</li><br/><li><span>程序员花卷</span> 👍（25） 💬（0）<div>这节就好像了解历史一样，开了眼界</div>2019-12-20</li><br/><li><span>南山</span> 👍（17） 💬（0）<div>开阔了视野。另外想插句题外话: 设计思想都是通用的，灵活应用，能选择最适合的才是关键</div>2019-07-01</li><br/><li><span>天使也有爱</span> 👍（7） 💬（0）<div>我觉得最主要是arm生态比intel 要好，只授权不生产cpu, 只收授权费，也让其他厂家扩展自己的功能，像百花齐放那种，还有就是价格便宜，功耗低</div>2020-05-24</li><br/><li><span>Adam Lau</span> 👍（5） 💬（5）<div>我不太懂请见谅。复杂指令可以用简单指令组合替代，这个理念我是明白了，但是我没学过不清楚，老师可否举一些例子，什么样的复杂指令可以用什么样的简单指令替代。</div>2020-06-12</li><br/><li><span>大王叫我来巡山</span> 👍（5） 💬（0）<div>我第一次看懂RSIC和CSIC，感觉上学时候老师讲了很多都没明白，应该是不成体系</div>2019-12-30</li><br/><li><span>墨渊战神01</span> 👍（4） 💬（1）<div>pc时代有intel, 移动互联网时代有arm，物联网时代是不是会有更低功耗更高效的架构出现？</div>2019-07-26</li><br/><li><span>Martin</span> 👍（3） 💬（0）<div>老师请问《计算机组成与设计：硬件 &#47; 软件接口》看有第六版、第五版的RISC-V版、第五版的ARM版；普通零基础小白，买哪个版本好？</div>2022-09-07</li><br/><li><span>活的潇洒</span> 👍（3） 💬（0）<div>我工作的这10多年里用的都是Intel 的 x86 CPU、对于ARM只知道是嵌入式、应用才交换机、路由器、智能手机领域，至于到底和Intel 的 x86 CPU底层的实现原理有什么区别我一直都不是很明白，一直有这样的疑问，但是不知道应该去哪里问？正好看到这篇文章我才明白了
day29 笔记：https:&#47;&#47;www.cnblogs.com&#47;luoahong&#47;p&#47;11330406.html</div>2019-08-21</li><br/><li><span>xindoo</span> 👍（3） 💬（3）<div>atom是面向移动市场的，所以肯定会以低功耗为设计导向，我觉得肯定会大量参考rsic的设计，但atom貌似是可以运行windows的，应该还是x86的指令集。</div>2019-07-01</li><br/><li><span>Geek_75b2e6</span> 👍（2） 💬（0）<div>之前都在想，为什么X86_64的，经常看到AMD64，曾经都不敢安装，AMD64的包。这下才明白</div>2021-06-30</li><br/><li><span>A君</span> 👍（2） 💬（0）<div>ARM的策略是做减法，减少指令数，减少cpu性能，减少公司业务。微指令由指令译码器将复杂指令转成多条简单指令，虽然指令处理效率高了，但译码所要花的时间也更长了。</div>2020-07-07</li><br/><li><span>WENMURAN</span> 👍（2） 💬（0）<div>CISC和RISC:
CISC复杂指令集，指令多，复杂。SISC精简指令集，指令少，常用指令短，复杂指令可以用简单指令组合，指令中有80%都是常用指令。早期都是C，后来出现了R，但是因为兼容问题，因特尔还是采用C，不过他们引入了微指令，其实就是类似的R。但是功耗大，对硬件要求高，后来在手机芯片中就采用了R。现在手机芯片都是ARM架构</div>2020-04-23</li><br/><li><span>czh</span> 👍（1） 💬（0）<div>微指令：由于cpu指令的局部性原理，所以，Intel 就在 CPU 里面加了一层 L0 Cache。这个 Cache 保存的就是指令译码器把 CISC 的指令“翻译”成 RISC 的微指令的结果</div>2019-11-28</li><br/><li><span>Mamba</span> 👍（0） 💬（0）<div>Intel Atom处理器采用的是CISC（复杂指令集计算机）架构。虽然Atom处理器是为了低功耗和移动设备设计的，但它们仍然基于x86架构，这是Intel公司长期以来使用的CISC架构。
