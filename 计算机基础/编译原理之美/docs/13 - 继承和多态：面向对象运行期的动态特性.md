...
<li><span>曾经瘦过</span> 👍（13） 💬（2）<div>看到了评论 泛型 然后想到了反射。根据使用经验(反射报错都是在运行时)，老师在后端的部分会讲一下反射吗？</div>2019-09-27</li><br/><li><span>Gopher</span> 👍（7） 💬（1）<div>老师能增加一讲泛型吗？这样就圆满了🤣</div>2019-09-15</li><br/><li><span>影影影</span> 👍（4） 💬（4）<div>老师您好，有些小的疑惑，麻烦解答下。
...
因此我的疑惑是，在一个类(Cow)的实例没有初始化的时候，为何就已经可以去调用这个实例的方法了？</div>2019-09-13</li><br/><li><span>xiaobang</span> 👍（3） 💬（2）<div>Java里面构造函数里面居然允许多态，感觉行为怪怪的，不符合自觉。另外ThisSuperTest里面那个weihgt和speak 前面不加this 语义也一样吗</div>2019-09-17</li><br/><li><span>林恒杰</span> 👍（3） 💬（1）<div>现在深度学习的端侧芯片碎片化比较严重，因而对于编译器需求也开始变多起来，包括谷歌最近也像LLVM社区提交了MLIR，老师可以讲一下这个部分的看法吗？</div>2019-09-11</li><br/><li><span>李懂</span> 👍（3） 💬（2）<div>也就是只有方法存在多态，属性和构造函数是不存在多态！
这个this，super是咋实现的，以前觉得this是当前对象  super是父类对象，现在看来好像不对！</div>2019-09-11</li><br/><li><span>余晓飞</span> 👍（2） 💬（2）<div>&#47;&#47; 在本级查找这个这个方法
Function rtn = super.getFunction(name, paramTypes);
这里需要首先在本级查找，但是根据下文介绍的super特性，这里查找的应该是上级及以上的方法，是在这里和Java有差别吗？</div>2019-09-22</li><br/><li><span>cry soul</span> 👍（1） 💬（3）<div>还有一个点，其实比较想知道的是多线程的实现。以及线程安全问题等，怎么样实现是原子级的操作。希望老师能稍微提及这样的内容，因为本身是做web开发的，真的比较好奇。</div>2019-10-11</li><br/><li><span>沉淀的梦想</span> 👍（1） 💬（1）<div>看代码的时候有个疑问，this作为一个primary，当要去找其左值的时候，会去各个作用域中搜索thisRef，但是thisRef是什么时候加入到作用域的符号表的呢？没有找到代码中对应的位置</div>2019-09-13</li><br/><li><span>沉淀的梦想</span> 👍（1） 💬（1）<div>看老师的代码里好像没有对类方法和对象方法进行区分，是因为PlayScript目前还不支持类方法吗？</div>2019-09-13</li><br/><li><span>minghu6</span> 👍（0） 💬（1）<div>好大的项目，用gradle组织并加了一个简单的集成测试
https:&#47;&#47;bitbucket.org&#47;minghu6code&#47;ps-java&#47;src&#47;master&#47;</div>2021-04-05</li><br/><li><span>lion_fly</span> 👍（0） 💬（1）<div>mark一下，原理篇跟完了</div>2020-09-14</li><br/><li><span>Giacomo</span> 👍（0） 💬（8）<div>老师，现在流行的计算机语言中，有没有结构化继承的啊？因为我自己想写的语言本身是结构化继承的</div>2019-09-21</li><br/><li><span>刘桢</span> 👍（2） 💬（0）<div>太强了</div>2020-05-14</li><br/><li><span>王越</span> 👍（0） 💬（0）<div>那位大佬能告诉我  怎么运行起来 playscript 啊</div>2022-06-28</li><br/>
</ul>