...
<li><span>沉淀的梦想</span> 👍（4） 💬（1）<div>既然LALR(1)有性能低的缺点，那为什么yacc和bison还使用它呢？用yacc和bison生成的语法分析器性能差的话，为什么还有这么多人用？</div>2019-09-25</li><br/><li><span>minghu6</span> 👍（2） 💬（3）<div>用Rust写了一个完整demo: https:&#47;&#47;bitbucket.org&#47;minghu6code&#47;alg-parser&#47;src&#47;master&#47;</div>2021-05-26</li><br/><li><span>余晓飞</span> 👍（2） 💬（1）<div>
start -&gt; exp
exp -&gt; lvalue = rvalue
exp -&gt; rvalue
lvalue -&gt; Id
...
对这里最后两行的产生式不太理解，请问有对应哪种具体语言的语法吗？</div>2019-11-03</li><br/><li><span>ZYS</span> 👍（1） 💬（2）<div>宫老师这个课件做的真棒👍，GCC语法分析用的是LR分析器么？Clang用的是什么语法分析器</div>2019-09-23</li><br/><li><span>Amy</span> 👍（0） 💬（1）<div>一个小typo：
LR 算法中的 R，带有反向（Reverse）和最右（Reightmost）这两层含义。
s&#47;Reightmost&#47;Rightmost</div>2021-08-04</li><br/><li><span>lion_fly</span> 👍（0） 💬（2）<div>mark一下，算法篇趟过去了</div>2020-11-03</li><br/><li><span>飞翔</span> 👍（0） 💬（1）<div>老师，不理解第 13 步，根据“add-&gt;add+mul”规约到 add
为什么会回到状态 2
状态2中“add-&gt;add.+mul”点号不是在中间吗，状态1的点号在开始</div>2019-10-17</li><br/><li><span>xiaobang</span> 👍（0） 💬（3）<div>这一章看的有点困难，不理解那个NFA怎么来的</div>2019-09-25</li><br/><li><span>locke.wei</span> 👍（6） 💬（0）<div>在状态 2，如果下一个输入是“=”，那么做移进和规约都是可以的。因为“=”在 rvalue 的 Follow 集合中。
这里我理解&quot;=&quot;应该是lvalue的follow集合？</div>2020-05-09</li><br/><li><span>温雅小公子</span> 👍（1） 💬（0）<div>把follow集合拆解是怎么做的？</div>2022-10-10</li><br/><li><span>！</span> 👍（1） 💬（1）<div>是不是我太菜了，算法开始就看不懂了</div>2022-04-28</li><br/><li><span>惘 闻</span> 👍（0） 💬（0）<div>动态规划就是自底向上逐级推导</div>2021-09-10</li><br/>
</ul>