...
还有一个问题，我使用locate_file()函数对文件较多的目录进行搜索时，显示直接跳出了，没有返回目录中的文件，但是在命令行条件下可以返回。是怎么回事。</p>2022-05-28</li><br/><li><span>Soul of the Dragon</span> 👍（0） 💬（3）<p>老师，我按照您之前说的，用.py格式的脚本文件运行“current_path = pathlib.PurePath(__file__).parent”这一行代码，为什么还是会出现“NameError: name &#39;__file__&#39; is not defined”这样的报错？</p>2021-03-02</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<p>学习打卡</p>2023-07-08</li><br/><li><span>琥珀·</span> 👍（0） 💬（0）<p>expanded_name = &quot;jpg&quot;
