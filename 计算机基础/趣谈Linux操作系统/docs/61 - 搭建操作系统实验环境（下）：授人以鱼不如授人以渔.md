...
<li><span>LDxy</span> 👍（2） 💬（1）<div>打断点的指令b后面是不是既可以跟行号也可以跟函数名？</div>2019-08-17</li><br/><li><span>魏颖琪</span> 👍（6） 💬（0）<div>终于在virtualbox中做完了这两课的实验。请问老师，云服务是否很少用 vbox，基本都用qemu?</div>2019-09-20</li><br/><li><span>yanger</span> 👍（3） 💬（1）<div>缺省很多变量被编译优化了，有O0编译kernel的方法吗</div>2020-02-01</li><br/><li><span>蓝莓</span> 👍（0） 💬（0）<div>想请教一下
...
Command aborted.</div>2024-05-09</li><br/><li><span>邹德虎</span> 👍（0） 💬（1）<div>如果没有虚拟机而是实体的服务器，怎么调试内核呢？</div>2022-05-23</li><br/><li><span>莫名</span> 👍（0） 💬（0）<div>编译、调试较新版本的内核稍微有些区别，大体流程基本相同。</div>2020-09-24</li><br/><li><span>kkxue</span> 👍（0） 💬（0）<div>赞👍</div>2019-08-16</li><br/><li><span>许童童</span> 👍（0） 💬（0）<div>跟着老师一起精进。</div>2019-08-16</li><br/>
</ul>