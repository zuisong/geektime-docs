...
<li><span>有铭</span> 👍（16） 💬（4）<div>还是没理解那个“伙伴系统”为何会命名为伙伴系统，没感觉到有“伙伴”的感觉</div>2019-05-20</li><br/><li><span>奔跑的码仔</span> 👍（10） 💬（1）<div>老师，对于32bit的系统，如果物理内存大小小于896M，那物理内存区域还有ZONE_HIGHMEM吗？您的第26节课讲到内核处理匿名页的缺页中断处理时，会调用alloc_zeroed_user_highpage_movable去高端内存区域分配物理页，对于32bit系统，物理内存小于896M的情况，这时候伙伴系统去哪里分配物理页呢？对于64bit系统，没有高端内存区域，那上述函数去哪里分配高端内存的物理页呢？</div>2019-09-03</li><br/><li><span>江山未</span> 👍（6） 💬（1）<div>一边读一边在脑海构想结构关系图，半天不得要领。看到最后这张图才恍然大悟。艾玛，以后先看最后这张图，少分配一点脑细胞了</div>2019-08-01</li><br/><li><span>geraltlaush</span> 👍（5） 💬（1）<div>伙伴系统的意思就是劫富济贫</div>2019-05-22</li><br/><li><span>oldman</span> 👍（3） 💬（3）<div>老师，我这里有一个疑惑，内存的最大连续页是1024个页，也就是4MB的大小，我们知道在一般的应用程序中，数组都是一连串的内存，那我如果要申请一个大于4MB的数组呢，操作系统会怎么样来分配呢，期待老师解惑。</div>2019-07-12</li><br/><li><span>注意力$</span> 👍（2） 💬（1）<div>老师，好多数据安装时都建议关闭numa，主要是觉得numa哪里不好呢</div>2020-06-01</li><br/><li><span>Linuxer</span> 👍（2） 💬（3）<div>每个页块的第一个页的物理地址是该页块大小的整数倍。怎么理解</div>2019-05-21</li><br/><li><span>奔跑的码仔</span> 👍（1） 💬（2）<div>您好，之前看过一篇文章讲解Linux内存物理模型，里面说到了三种物理模型:平坦型、非连续型、稀疏性，看完本节后，发现基于zone的buddy系统和上面讲解的几种模型的关系，理不清了。不知道，三种物理模型是不是也是基于zone的伙伴系统呢？</div>2019-08-28</li><br/><li><span>Linuxer</span> 👍（1） 💬（1）<div>有些应用会要求关闭numa那么这里numanode就为1吗？这时候是所有CPU共用一个pglist?</div>2019-05-21</li><br/><li><span>饭粒</span> 👍（0） 💬（1）<div>看多几遍终于稍微明白点了</div>2020-05-23</li><br/><li><span>Virtue</span> 👍（0） 💬（1）<div>学了进程管理和内存管理，在看前面内核初始化的内容，感觉理解又深刻了点。</div>2019-05-28</li><br/><li><span>MARK</span> 👍（0） 💬（1）<div>周六打卡，这周的课程让我感觉自己智商欠费😂</div>2019-05-25</li><br/><li><span>欢乐小熊</span> 👍（0） 💬（1）<div>老师, 从这节课我看到 slab slob 和 slub... 这...是同一个吗? </div>2019-05-23</li><br/><li><span>冷月流光</span> 👍（0） 💬（1）<div>老师好，伙伴系统的页分配我好像理解了，但是它是怎么回收(回收后要合并吗？)还是没想明白，这个伙伴系统与netty的PoolChunk分配机制有什么异同？

</div>2019-05-22</li><br/><li><span>bradleyzhou</span> 👍（0） 💬（1）<div>感觉伙伴系统的命名是说，每次请求内存时，要么是请求到别的伙伴分剩下的内存，要么是自己切好拿走一块，剩下的给将来的伙伴。</div>2019-05-21</li><br/>
</ul>