...
<li><span>LDxy</span> 👍（27） 💬（1）<div>信号类似内核里面的中断，只不过是在用户态的</div>2019-06-25</li><br/><li><span>geraltlaush</span> 👍（7） 💬（1）<div>c语言开发者路过，表示以前从来不知道signal不是系统调用</div>2019-06-21</li><br/><li><span>免费的人</span> 👍（1） 💬（2）<div>关于SA_ONESHOT，为什么我平时用signal的时候，处理函数可以被重复调用呢</div>2019-06-21</li><br/><li><span>欢乐小熊</span> 👍（1） 💬（1）<div>收获满满, 不过看了标题以为是信号发送的流程, 结果学到了信号的注册和处理</div>2019-06-21</li><br/><li><span>Luke</span> 👍（0） 💬（1）<div>信号是不是操作系统的一个原语，在Windows端，对应的实现是消息Message循环</div>2019-06-24</li><br/><li><span>眭东亮</span> 👍（4） 💬（0）<div>课后练习，参考文档：
https:&#47;&#47;www.cnblogs.com&#47;wblyuyang&#47;archive&#47;2012&#47;11&#47;13&#47;2768923.html
https:&#47;&#47;www.runoob.com&#47;linux&#47;linux-comm-kill.html</div>2019-07-12</li><br/><li><span>NoTryNoSuccess</span> 👍（2） 💬（0）<div>“SEGSTOP”笔误，应为“SIGSTOP”。</div>2023-04-24</li><br/><li><span>hello</span> 👍（2） 💬（1）<div>一个进程如果一瞬间收到很多同一个信号，那task_struct的action最多能保存几个呢</div>2019-11-10</li><br/><li><span>JT</span> 👍（2） 💬（0）<div>老师，我测试过使用 signal 函数注册信号处理函数，注册一次是一直有效。每次给进程发信号都会调用信号处理函数</div>2019-10-18</li><br/><li><span>Geek_1ec22e</span> 👍（0） 💬（0）<div>信号注册是针对所有进程还是单个进程？</div>2021-09-08</li><br/>
</ul>