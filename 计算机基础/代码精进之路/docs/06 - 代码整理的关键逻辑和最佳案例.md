...
<li><span>hua168</span> 👍（19） 💬（2）<div>老师，像我这种没有项目经验，知道类、接口及其修饰符、方法，但不知道什么情况下使用：
...
这些基础概念都懂，但是就不知道怎么在项目中应用的，说懂好像又不懂，感觉基础不是很扎实一，我这种情况怎搞？有没有相关文章或书推荐一下，非常感谢？</div>2019-03-10</li><br/><li><span>Dream</span> 👍（17） 💬（5）<div>总感觉给出的一些理论，在现实开发有一些是没有必要的。如果每一篇就讲针对性很强的一段代码，不好吗，理论性的东西太多了，对实践转换率不强，</div>2019-01-17</li><br/><li><span>草原上的奔跑</span> 👍（10） 💬（1）<div>今天这篇内容很实用，我现在也有整理代码的习惯，但是只是用的都比较零散，不像本篇中这么系统，而且范老师给出了理论依据。代码块，人体接受信息的方式。有实践方法，有理论支撑，以后整理代码也会更有目标性，同时，在要求别人整理代码时，也会有理有据。最后说一句，看到写的排版很乱的代码，很影响阅读代码的心情，以及理解代码的速度。</div>2019-01-16</li><br/><li><span>虢國技醬</span> 👍（4） 💬（1）<div>打卡
我有一个自己在实践且感觉不错的经验，分享一下:
举个栗子，我现在准备写一个控制器方法，我会先仔细想想要做一点什么？怎样的顺序？多想几次在脑袋里过一下，但是我不会深想到底怎么做，想好以后，我会先写注释（更准确说应该是提纲），以注释作为思路的引子同时也是一种代码实现思维的分块</div>2019-01-20</li><br/><li><span>蓝色波浪</span> 👍（4） 💬（1）<div>&#47;&#47; conventional indentation
int runningMiles = runningSpeedOne * runningTimeOne +
                   runningSpeedTwo * runningTimeTwo;
这个是不是违背了在操作符前换行这个原则？</div>2019-01-18</li><br/><li><span>空知</span> 👍（4） 💬（1）<div>老师可不可以多出些题目,可以结合实际练练手~~</div>2019-01-16</li><br/><li><span>背着吉他的大漠狼</span> 👍（3） 💬（1）<div>老师，有的时候，在一个代码块里面逻辑较多，远远超过了25行，这个时候我们是在这个块里写完，还是再分块，分块了又使得同一个目标不同的代码块了，希望老师能看到</div>2019-01-21</li><br/><li><span>Sisyphus235</span> 👍（2） 💬（1）<div>留言里没有一条讨论习题的。。。
...
空格、空行、缩进都是很好的视觉手段，加上 IDE 提供的收起和展开功能往往能让开发者很直观的看到代码的意图。整理代码逻辑就能很好的分块，我一般代码会分为“基础校检”，“初始化”，“核心代码逻辑” *n，“LBYL”的异常处理等</div>2019-05-21</li><br/><li><span>学无涯</span> 👍（1） 💬（1）<div>1） 
if (hiTail == null) {
    hiHead = e;
}
else {
...
老师，这两种写法，哪种好呢</div>2019-10-23</li><br/><li><span>hshayq</span> 👍（1） 💬（1）<div>我写Python一般都是在括号后换行，比如
a = get(
    arg1,
    arg2,
    arg3
)
老师怎么看？</div>2019-07-08</li><br/><li><span>Demon.Lee</span> 👍（1） 💬（1）<div>return new xxxModel（xxxservice.getxxx（））;
看样子不能这么写了，换两行喽</div>2019-01-16</li><br/><li><span>pyhhou</span> 👍（1） 💬（1）<div>专栏看到现在，很有收获，规范了自己之前没有想到的很多地方，满满的干货，谢谢老师～</div>2019-01-16</li><br/><li><span>Geek_2e666c</span> 👍（0） 💬（1）<div>实际工作中，大多人不去整理代码是因为接到的大多都是历史代码或者别人的代码，已经上线运行了你再去整理，没工作量是一方面，改了出生产问题，还要回溯，真没有想象简单</div>2024-04-08</li><br/><li><span>aoe</span> 👍（0） 💬（1）<div>如果Java能像Go一样统一格式就好了！按下保存，自动格式化</div>2021-12-10</li><br/><li><span>进化菌</span> 👍（0） 💬（1）<div>空格如果不习惯的话，使用ide的格式化就可以很好的处理。
代码总要回过头来整理，才能越来越好。总体感觉就是，一次性写好的可能性太小了。</div>2021-11-14</li><br/>
</ul>