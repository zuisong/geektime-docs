...
<li><span>Django...</span> 👍（37） 💬（2）<div>讲解详细很赞；想请教个曾被一个开发面试面倒的数据库问题：一张表在源源不断插入的情况下，怎么去做备份(不知是不是这样，记不太清)？</div>2021-03-09</li><br/><li><span>右耳朵猫咪</span> 👍（13） 💬（9）<div>老师，workbench、sqlyog、navicat这三个图形工具有什么区别，最常用的是哪个呢？</div>2021-03-09</li><br/><li><span>giteebravo</span> 👍（7） 💬（1）<div>
太详细了，这几乎就是手把手教了</div>2021-03-13</li><br/><li><span>空亦非空</span> 👍（6） 💬（1）<div>喜欢作者的贴心安排</div>2021-03-18</li><br/><li><span>无刃</span> 👍（4） 💬（2）<div>老师，我win10系统，完全根据视频步骤导入test.csv，但表头的barcode通过Workbench导入后变成了锘縝arcode，其他无异常。不知这是什么原因？</div>2021-03-27</li><br/><li><span>DebugDog</span> 👍（4） 💬（2）<div>自己用的5.7版本，需要切换到8.0吗</div>2021-03-10</li><br/><li><span>流云</span> 👍（2） 💬（1）<div>用docker在Linux云主机起一个应该可以?</div>2021-03-18</li><br/><li><span>小鱼干</span> 👍（2） 💬（1）<div>课程中用到的MySQL版本都是8.0吗，自己用的5.7版本。两个版本有些特性不同。学习过程中要切换到8.0吗。</div>2021-03-10</li><br/><li><span>longMe</span> 👍（1） 💬（1）<div>确实很详细，感觉就有点小学老师在教小学生一笔一划怎么写字一样。</div>2021-09-07</li><br/><li><span>Soul of the Dragon</span> 👍（1） 💬（1）<div>老师，我的MySQL installer里面没有choosing a setup type这一项，导致后面的安装步骤进行不下去，请问是什么原因？</div>2021-09-03</li><br/><li><span>NARUTO</span> 👍（1） 💬（1）<div>MySQL Router 就可以对这些请求进行调度，把访问均衡地分配给每个数据库服务器，而不是集中在一个或几个数据库服务器上，会讲到多个数据库服务器之间是怎么进行数据同步的吗</div>2021-08-31</li><br/><li><span>郑。</span> 👍（1） 💬（3）<div>老师，我没法导入test.csv，一直报错，提示未处理的异常:&#39;Unhandled exception: &#39;ascil&#39; codec can&#39;t encode character u&#39;ufeff&#39; in position 0: ordinal not in range(128)</div>2021-08-26</li><br/><li><span>好困啊</span> 👍（1） 💬（1）<div>alter table rename to&#47;as demo.sample;</div>2021-07-12</li><br/><li><span>张成虎</span> 👍（1） 💬（1）<div>老师，思考题答案在哪里找到呢？</div>2021-06-16</li><br/><li><span>jjn0703</span> 👍（1） 💬（1）<div>老师能讲讲读MySQL源代码的经验么，之前听人直播说源代码可是百万行级别的</div>2021-06-04</li><br/>
</ul>