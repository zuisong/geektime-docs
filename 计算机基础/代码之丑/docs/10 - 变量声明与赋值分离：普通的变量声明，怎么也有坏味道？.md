...
<li><span>桃子-夏勇杰</span> 👍（31） 💬（2）<div>有一种当年读Effective系列从书的感觉</div>2021-01-21</li><br/><li><span>webmin</span> 👍（15） 💬（1）<div>刷新了认知，给我植入了&quot;声明式”和&quot;做什么”两个思想</div>2021-01-21</li><br/><li><span>阎魔502</span> 👍（6） 💬（1）<div>
List&lt;Permission&gt; permissions = List.of(
  Permission.BOOK_READ, 
  Permission.BOOK_WRITE
);
check.grantTo(Role.AUTHOR, permissions);
使用Arrays.asList 方式同样可以达到相同的效果</div>2021-03-22</li><br/><li><span>刘大明</span> 👍（5） 💬（1）<div>说来惭愧，项目中从来没有一个同事用过final。
学到了用声明式的标准来看代码</div>2021-01-21</li><br/><li><span>huaweichen</span> 👍（4） 💬（1）<div>看了这一篇，觉得现存的代码，好多地方要改。。。</div>2021-01-21</li><br/><li><span>adang</span> 👍（4） 💬（2）<div>第一个例子，会尽量用三目运算符的写法，类似于这样
```
CreateEpubResponse response = createEpub(request);
EpubStatus status = (response.getCode() == 201) ? EpubStatus.CREATED : EpubStatus.TO_CREATE;
```
老师，不知道这样算是取巧吗？</div>2021-01-21</li><br/><li><span>6点无痛早起学习的和尚</span> 👍（3） 💬（1）<div>这几天早上起床就来刷这个课，之前一直没有留言，但是昨天看了之前的一个代码，然后发现了很多前面几章讲的坏味道(比如过长的消息链等)，今天又学到了变量声明，记起来之前代码也有这样的问题，今天就立马去改了，点赞这门课</div>2021-04-09</li><br/><li><span>Geek_3b1096</span> 👍（3） 💬（2）<div>List.of今天就用上了!</div>2021-01-28</li><br/><li><span>明星</span> 👍（3） 💬（1）<div>老师示例中的
...
response和status 没想明白在什么情况下会被改变，final 防止改变这两个变量的意图可以理解，但是是防止程序运行过程中被其他线程误改变值？还是防止其他开发的同事调用或修改这段代码的时候一不小心对变量进行了赋值？</div>2021-01-28</li><br/><li><span>Aprelude</span> 👍（1） 💬（2）<div>response状态的那个方法参数为什么不传reponse.getcode而要把整个reponse传进去</div>2021-06-30</li><br/><li><span>安迪密恩</span> 👍（1） 💬（1）<div>我有来了，第二个代码块，少了一些右花括号。类没有闭合。</div>2021-01-26</li><br/><li><span>Asia</span> 👍（0） 💬（1）<div>看完就把昨天提交代码中的 变量初始化为 null 的地方重构了一下。</div>2022-10-19</li><br/><li><span>江鑫</span> 👍（0） 💬（1）<div>看到老师Todo的开源练习项目，一开始还觉得很奇怪，怎么都是搞final ，代码检查工具还对这个进行了专门的检查。就觉得非常奇怪，听完老师这课，终于明白了。</div>2021-08-09</li><br/><li><span>LiuTianyou</span> 👍（0） 💬（1）<div>老师您好，对list的初始化使用Arrays.asList 是否也是可行的？</div>2021-02-02</li><br/><li><span>huaweichen</span> 👍（7） 💬（0）<div>非常喜欢作者有理、有据、有例的分析。非常好。</div>2021-01-21</li><br/>
</ul>