...
等等……</p>2021-07-26</li><br/><li><span>LDxy</span> 👍（2） 💬（1）<p>好像还缺少seek操作</p>2021-07-26</li><br/><li><span>Kinco.</span> 👍（1） 💬（1）<p>1. 不支持多种格式的文件；
2. 不支持多层目录；
3. 不支持seek操作。</p>2021-10-20</li><br/><li><span>艾恩凝</span> 👍（0） 💬（1）<p>打卡，果然不支持多级目录，更多的是体会一下，os中的文件操作</p>2022-05-12</li><br/><li><span>MONKEYG</span> 👍（0） 💬（1）<p>我想请问下，这个try_entry是谁在调用的😂😂</p>2022-05-07</li><br/><li><span>ifelse</span> 👍（0） 💬（1）<p>文件查询</p>2022-02-22</li><br/><li><span>kocgockohgoh王裒</span> 👍（0） 💬（1）<p>请问删除文件的时候 是不是在根目录文件产生空洞啊 新建文件总是从根目录文件末尾操作</p>2022-01-06</li><br/><li><span>al_培龙</span> 👍（0） 💬（2）<p>好像不支持多级目录吧</p>2021-08-03</li><br/><li><span>风云一度</span> 👍（0） 💬（0）<p>老师，可以简单讲下硬盘驱动的实现原理吗</p>2024-06-15</li><br/>
</ul>