...
<li><span>奕</span> 👍（9） 💬（4）<div>学习 Vim 不是为了替换日常开发使用的 编辑器或者 IDE， 只是为了在 进行命令行操作文件的时候 能更高效一些</div>2020-07-20</li><br/><li><span>William</span> 👍（8） 💬（1）<div>Vim有没有JavaScript或Typescript语言相关插件。前端程序员来报道。</div>2020-07-20</li><br/><li><span>balsamspear</span> 👍（7） 💬（3）<div>vim是很强大，不过模式切换带来的中英文切换有点搞心态，有没有什么解决办法呢？</div>2020-07-24</li><br/><li><span>我来也</span> 👍（7） 💬（2）<div>完全用vim做开发工具有两年了，之前的很多年都只是用它来看日志。
看过 《vim实用技巧 》《the viml primer》《modern vim》。
最后，还是看中文的收获最大（因为看的懂😂）。

准备来老师这查漏补缺。</div>2020-07-20</li><br/><li><span>Hesher</span> 👍（7） 💬（6）<div>有推荐书籍吗？</div>2020-07-20</li><br/><li><span>徐洲更</span> 👍（5） 💬（1）<div>接触了好多年的Vim，但是最后还是只会那么几个语句，最近才学习了宏，看来还是我不够懒呀。</div>2020-07-23</li><br/><li><span>瀚海星尘</span> 👍（5） 💬（1）<div>最近正好在学vim，算是上手了，但是很多配置还是两眼发黑，也算不上比IDE高效，希望能通过这个课程，把vim融入自己的开发生活中去。😄</div>2020-07-21</li><br/><li><span>3.141516</span> 👍（4） 💬（2）<div>macOS 终端有一个简易教程，终端输入 vimtutor 即可</div>2020-07-21</li><br/><li><span>我爱吃肉肉</span> 👍（4） 💬（2）<div>还是本人的声音？棒棒哒的</div>2020-07-20</li><br/><li><span>azurepwq</span> 👍（3） 💬（1）<div>使用vim快10年了，开始时不适应，感觉输入速度跟不上思维的速度，现在刚好反过来。无意识地敲击键盘，思维完全跟不上。查询跳转替换等操作，别人问我怎么弄的，我想半天硬是想不出来，想通过看自己的手指弄明白是怎么回事时，发现自己竟然不会了，走两圈回来继续工作，发现自己又会了。手动doge。</div>2022-04-24</li><br/><li><span>mrkey</span> 👍（3） 💬（1）<div>买这个专栏纯粹是一个情怀，当时学习Linux时侯，第一个课接触是vim，工作多年所有代码都在前面编写。</div>2020-07-21</li><br/><li><span>唐龙</span> 👍（3） 💬（2）<div>挺喜欢用vim的，几个月前折腾了一下，比如整了一个molokai配色，剩下的都是高亮当前行、高亮当前列、显示tab和空格之类的小细节，前几天刚看完的正则表达式入门课也是在vim末行模式练习的，然后别的就不会什么了。(网上找到的缩写命令自己试了不好使)
今天看到这门课一点都没犹豫直接就买了，期待了好久。</div>2020-07-20</li><br/><li><span>人在江湖龙在江湖</span> 👍（2） 💬（2）<div>我为什么要订这个专栏，就是为了更高效的使用编辑器，当编辑的时候不需要思考编辑软件怎么用，把思考时间用在写得软件逻辑上，在linux上，vim好像是唯一的编辑器的选择</div>2020-11-08</li><br/><li><span>范程怡</span> 👍（2） 💬（1）<div>老师，拓展篇能否讲讲【Java程序员的Vim工作环境】呢？</div>2020-08-08</li><br/><li><span>徐声睿</span> 👍（2） 💬（1）<div>一直没把vim用的很熟练，也是很遗憾，希望能在老师这里把vim发展成为我的主要编辑器，之前看到一个大佬用vim写笔记的，是真的厉害</div>2020-07-28</li><br/>
</ul>