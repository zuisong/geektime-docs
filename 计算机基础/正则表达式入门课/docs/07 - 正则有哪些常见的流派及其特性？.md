...
<li><span>设置昵称</span> 👍（17） 💬（1）<div>好像 Mac 中自带的 grep 早就不支持 -P 这个模式了,需要 brew install grep ,用这个版本覆盖系统的版本才能用 -P 这个参数</div>2020-07-01</li><br/><li><span>虹炎</span> 👍（8） 💬（3）<div>我的答案：
grep &#39;ftp\|http\|https\|&#39; b.txt		#POSIX-BRE标准
grep -E &#39;ftp|http|https&#39;  b.txt		#POSIX-ERE标准
egrep &#39;ftp|http|https&#39; b.txt		#POSIX-ERE标准
grep -P &#39;ftp|http|https&#39; b.txt		#PCRE</div>2020-06-26</li><br/><li><span>Robot</span> 👍（4） 💬（1）<div>## BRE
grep &#39;\(f\|ht\)tps\?.*&#39; a.txt
...
## PCRE
grep -P &#39;(f|ht)tps?.*&#39; a.txt</div>2020-06-26</li><br/><li><span>奕</span> 👍（1） 💬（1）<div>PCRE:  grep -P &#39;https?|ftp&#39;
ERE:  grep -E &#39;https?|ftp&#39;
BRE: grep  &#39;https\?\|ftp&#39;

这里 ERE 和 PCRE 是一样的写法了</div>2020-06-27</li><br/><li><span>wenxuan</span> 👍（0） 💬（1）<div>GNU sed不支持PCRE吧，没有-P选项</div>2020-07-01</li><br/><li><span>felix</span> 👍（0） 💬（1）<div>还是得再请教老师！
输入是
var para = {
	a: &#39;test;test&#39;,
	b: {
...
var para = ([^;]+);</div>2020-06-26</li><br/><li><span>码农Kevin亮</span> 👍（3） 💬（0）<div>正则难就难在不同流派，之前对此相当困惑</div>2020-10-02</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<div>学习打卡</div>2022-11-18</li><br/><li><span>RecordLiu</span> 👍（0） 💬（0）<div>PCRE标准:grep -P &#39;(ftp|https?):&#47;&#47;.+&#39; 
BRE标准:grep &#39;\(ftp\|https\{0,1\}\):&#47;&#47;.\{1,\}&#39; 
ERE标准:grep -E &#39;(ftp|https?):&#47;&#47;.+&#39;
BRE标准中需要转义圆括号、管道符号，量词?和+需要用区间\{0,1\}和\{1,\}表示,ERE标准中，圆括号、管道符号不需要转义,也支持量词?和+号。
</div>2021-02-28</li><br/><li><span>追风筝的人</span> 👍（0） 💬（0）<div>正则主要有两大流派，分别是 POSIX 流派和 PCRE 流派。其中 POSIX 流派有两个标准，分别是 BRE 标准和 ERE 标准，一般情况下，我们面对的都是 GNU BRE 和 GNU ERE。它们的主要区别在于，前者要转义。另外， POSIX 流派一个特点就是有自己的字符组 POSIX 字符组，这不同于常见的 \d 等字符组。</div>2020-10-24</li><br/><li><span>风</span> 👍（0） 💬（0）<div>请教老师，ECMAScript 支持的是哪个流派的</div>2020-09-20</li><br/>
</ul>