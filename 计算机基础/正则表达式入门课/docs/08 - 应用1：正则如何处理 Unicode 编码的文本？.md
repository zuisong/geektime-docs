...
而python2中的unicode等于python3中的str类型</p>2021-10-29</li><br/><li><span>gsz</span> 👍（1） 💬（1）<p>Unicode和gbk编码时，即刻，时间两个词都包含相同的16位数，为什么unicode匹配不了，而gbk的可以匹配？</p>2020-08-20</li><br/><li><span>jooe</span> 👍（1） 💬（2）<p>感谢老师加了 js 的代码示例，对于不会后端语言的还是很友好的</p>2020-07-03</li><br/><li><span>好运来</span> 👍（1） 💬（1）<p>    print(u&#39;正&#39;.encode(&#39;utf-8&#39;))
    # 全角正则和全角字符串，不能匹配到
