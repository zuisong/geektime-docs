...
<li><span>Yj.yolo</span> 👍（0） 💬（0）<div>【课后思考题】如果希望换乘次数很少，则应该考虑的是节点个数，即将①起始站②可换乘的站③终点站  当作图中的节点，然后考虑起始站到终点站的路径中，节点数更少的路径。将迪杰斯特拉算法中的“距离数组”换成“经过的节点数数组”，同理，按照迪杰斯特拉最短距离比较思想，去维护“节点数组”中的数值。</div>2023-07-13</li><br/>
</ul>