...
<li><span>摩诃不思议</span> 👍（0） 💬（1）<div>&quot;平衡二叉树也叫平衡二叉搜索树，英文名是 Balanced Binary Tree，简称 AVL 树（平衡树）。&quot;

这里是一个明显的错误。 AVL 树是平衡二叉搜索树的其中一种实现。😅</div>2023-06-18</li><br/><li><span>꯭@꯭T꯭</span> 👍（2） 💬（0）<div>1. 全部按照二叉查找树的方式插入
2. 右旋转point 12
3. 左旋转point 7
4. 左旋转point 8
