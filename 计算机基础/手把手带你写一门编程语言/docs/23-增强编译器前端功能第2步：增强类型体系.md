...
<li><span>ifelse</span> 👍（0） 💬（0）<div>学习打卡</div>2022-09-23</li><br/><li><span>qinsi</span> 👍（0） 💬（0）<div>TypeScript的union type就是Haskell ADT里的sum type，不过是untagged，所以在判断类型上有诸多不便。TypeScript也可以定义product type:
...
https:&#47;&#47;github.com&#47;g-plane&#47;type-gymnastics&#47;blob&#47;master&#47;src&#47;spec-compliant-html-parser&#47;index.ts</div>2021-10-02</li><br/><li><span>奋斗的蜗牛</span> 👍（0） 💬（0）<div>赞，类型系统的实现一直看不太明白，是个难点</div>2021-09-29</li><br/><li><span>quanee</span> 👍（0） 💬（1）<div>老师, 我们写的语言最后能自举吗?</div>2021-09-29</li><br/>
</ul>