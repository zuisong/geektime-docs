...
<li><span>Meow</span> 👍（16） 💬（0）<div>oh my godsh, 这个专栏买的是真值，还追加 Go 的选学🥕</div>2021-01-20</li><br/><li><span>戈壁滩的骆驼草</span> 👍（4） 💬（0）<div>皓哥，太强了👍👍👍</div>2021-01-25</li><br/><li><span>Moonus</span> 👍（2） 💬（0）<div>示例代码，foo = make([]int, 5) 初始化少个:  =&gt;foo := make([]int, 5)</div>2021-07-17</li><br/><li><span>重生之蓝</span> 👍（2） 💬（0）<div>这一章真的很赞，作为半路出家学习go的码农，每个知识点都是容易忽略的问题，看了这个能避免不少因为对go理解不到位导致的程序错误或者性能问题。</div>2021-02-25</li><br/><li><span>特立独行的猪</span> 👍（1） 💬（0）<div>这就是面向对象编程方法的黄金法则——“Program to an interface not an implementation”。 这几个循序渐进的例子，看到这里突然就顿悟了</div>2021-09-13</li><br/><li><span>Andy</span> 👍（0） 💬（0）<div>最喜欢看到的就是这些图了，特别方便理解</div>2023-03-10</li><br/><li><span>老高活鱼</span> 👍（0） 💬（0）<div>Typo: `StringBuild` -&gt; `StringBuilder`</div>2023-02-19</li><br/><li><span>Andy</span> 👍（0） 💬（0）<div>我就非常喜欢用图说话，一图胜千言</div>2022-12-31</li><br/><li><span>limix</span> 👍（0） 💬（0）<div>函数，成员方法和接口之间的互动关系，解释到位了</div>2022-07-30</li><br/><li><span>陈琦</span> 👍（0） 💬（0）<div>学习到了</div>2022-04-04</li><br/><li><span>Groot</span> 👍（0） 💬（0）<div>关于接口完整性检查那块，直接将 s 声明为 Shape 类型的变量是不是也可以

var s Shape
s = Square{len: 5}</div>2021-09-19</li><br/><li><span>李刚</span> 👍（0） 💬（0）<div>性能提示里几个总结，还过得去</div>2021-08-06</li><br/><li><span>小丢👣</span> 👍（0） 💬（0）<div>清晰明了，佩服佩服</div>2021-04-11</li><br/><li><span>为骨架</span> 👍（0） 💬（0）<div>初学，感觉很酷，还差的远呢，向老师看齐</div>2021-03-11</li><br/><li><span>汪辉</span> 👍（0） 💬（0）<div>写的很好</div>2021-01-19</li><br/>
</ul>