...
<li><img src="https://static001.geekbang.org/account/avatar/00/20/a8/66/e2781d4a.jpg" width="30px"><span>忘川</span> 👍（0） 💬（0）<div>重构的收益:
    1. 降低理解难度
    2. 提高复用
    3. 培养对象内聚的感觉 
所以 重构越早收益越高</div>2023-01-09</li><br/><li><img src="https://static001.geekbang.org/account/avatar/00/11/1d/de/62bfa83f.jpg" width="30px"><span>aoe</span> 👍（0） 💬（0）<div>三角法补充
1、使用数据驱动进行测试
