...
<li><img src="https://static001.geekbang.org/account/avatar/00/11/1d/de/62bfa83f.jpg" width="30px"><span>aoe</span> 👍（0） 💬（0）<div>原来通过排序也可以实现策略模式，之前只知道使用HASH实现策略模式</div>2022-07-22</li><br/>
</ul>