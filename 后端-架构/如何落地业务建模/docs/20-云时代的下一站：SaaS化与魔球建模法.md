...
<li><span>zhizhi</span> 👍（5） 💬（2）<div>大致学习了一遍，感觉没完全整明白😂，，老师，要不要考虑开个训练营。</div>2021-08-17</li><br/><li><span>Jxin</span> 👍（1） 💬（1）<div>1.都说波士顿矩阵过于简单粗暴，对其的优化一般也都是升维，比如通用电气矩阵。老师这个魔球直接再给降维了一波。 
2.尴尬客户这一块，上无门下无用，离队可能也会是个选项。毕竟向下能满足不会处于尴尬，商业模式运营向好也不会停留在尴尬。就是因为收益不景气加差异化问题多才处在尴尬阶段，而这个现状上下无门。
3.下一章(下一站)，不知道云时代能带来什么奇迹。2045年奇点在即，不知道会不会有云时代的一笔，翘首以盼，拭目以待。</div>2021-08-17</li><br/><li><span>ZQ</span> 👍（1） 💬（0）<div>抛开技术看，在SaaS化策略执行时还是主要从企业运营考虑（利润和成本）</div>2021-08-17</li><br/><li><span>云师兄</span> 👍（1） 💬（0）<div>魔球 SaaS 选项建模法，有意思👍</div>2021-08-17</li><br/><li><span>aoe</span> 👍（0） 💬（0）<div>下一章看起来像元宇宙，进入后可以搭建自己的业务能力，提供服务，碰碰运气</div>2022-09-21</li><br/><li><span>overheat</span> 👍（0） 💬（0）<div>serverless(lambda)方面，any thing？</div>2022-03-02</li><br/><li><span>马若飞</span> 👍（0） 💬（0）<div>本课心得：庙小妖风大池浅王八多。。。</div>2021-09-29</li><br/><li><span>Oops!</span> 👍（0） 💬（0）<div>终于学完啦，即将开启SaaS化的工作，有什么建议的书籍和资料可以推荐一下吗？Let&#39;s move forward.</div>2021-08-20</li><br/><li><span>鸭补一生如梦</span> 👍（0） 💬（0）<div>产品是企业价值的载体，是企业与消费者进行价值交换，实现企业增长赋能的重要容器。
产品架构与技术架构是企业价值的一体两面，不知徐老师能否推荐产品架构的专栏，让我们继续进入“下一章”。谢谢</div>2021-08-18</li><br/><li><span>Williamleelol</span> 👍（0） 💬（0）<div>催更徐老师八叉说～(￣▽￣～)~</div>2021-08-18</li><br/>
</ul>