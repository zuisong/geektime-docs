...
<li><span>pudu168</span> 👍（25） 💬（1）<div>推荐一个网站： https:&#47;&#47;www.conventionalcommits.org&#47;en&#47;v1.0.0-beta.4&#47;  有中文版，之前一直使用的规范文档</div>2021-06-10</li><br/><li><span>wei 丶</span> 👍（7） 💬（1）<div>老师是不是rebase后push会出现 当前分支的最新提交落后于其对应的远程分支 
我每次操作都有这个想要push必须要-f才可以 是我的操作的问题么？？</div>2021-08-11</li><br/><li><span>lianyz</span> 👍（4） 💬（2）<div>孔老师，一个commit里允许同时包含一个feat和一个fix吗？如何约束开发的同事？</div>2021-06-03</li><br/><li><span>兔嘟嘟</span> 👍（3） 💬（1）<div>git-chglog只需要安装好后git-chglog -o CHANGELOG.md ，就可以一键生成change log
gsemver没搞懂怎么用</div>2021-12-01</li><br/><li><span>stefen</span> 👍（2） 💬（1）<div>“我们希望将 feature&#47;user 分支的 5 个 commit 合并到一个 commit，在 git rebase 时，需要保证其中最新的一个 commit 是 pick 状态，这样我们才可以将其他 4 个 commit 合并进去”， 我看了好几遍，应该是保持最旧一个commit是pick状态，不是最新一个commit 是 pick 状态.</div>2022-10-29</li><br/><li><span>Calvin</span> 👍（2） 💬（1）<div>提交push了之后是不是不能修改了？</div>2022-02-22</li><br/><li><span>好家庭</span> 👍（2） 💬（1）<div>请问修改了commit message之后所有的commit id改变，如果修改的是仓库中原有的commit,再提交到仓库会不会产生冲突？</div>2021-09-14</li><br/><li><span>StayLet</span> 👍（2） 💬（2）<div>孔老师，为啥 “subject 的结尾不能加英文句号”？</div>2021-06-30</li><br/><li><span>🌆🌇🌉🌌</span> 👍（2） 💬（2）<div>老师，这个流程和git-flow哪个更好呢？</div>2021-06-03</li><br/><li><span>enjoylearning</span> 👍（1） 💬（2）<div>我喜欢用英文提交，避免切换输入法</div>2022-10-25</li><br/><li><span>lesserror</span> 👍（1） 💬（1）<div>孔老板，项目的第一次提交，type类型应该为feat吧。</div>2021-09-17</li><br/><li><span>Gojustforfun</span> 👍（1） 💬（1）<div>commit-msg工具的github链接缺失了，不知道是不是这个https:&#47;&#47;github.com&#47;JayceChant&#47;commit-msg</div>2021-07-23</li><br/><li><span>Gojustforfun</span> 👍（1） 💬（1）<div>“在以上规范中，必须用括号 () 括起来......”

哪部份“必须用括号 () 括起来”？</div>2021-07-23</li><br/><li><span>helloworld</span> 👍（1） 💬（1）<div>代码性能上的优化用perf, 如果是代码逻辑或功能上的优化也用perf吗, 如果用perf不合适的话, 用哪个type更合适呢</div>2021-07-08</li><br/><li><span>低调</span> 👍（1） 💬（1）<div>有冲突后也需要commit一次，这个是用哪种类型 feat? fix?refactor?</div>2021-06-17</li><br/>
</ul>