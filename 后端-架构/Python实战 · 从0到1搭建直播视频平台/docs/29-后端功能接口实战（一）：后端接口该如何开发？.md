...
<li><span>胡超</span> 👍（0） 💬（3）<div>建议在每段代码中针对需要引入的模块，import下或者form * import *下，不然有时会看点有点模糊，打个比方：name, text, img_data = captcha.captcha.generate_captcha()其中captchp引入的是哪个模块等，这样会有助于阅读代码，谢谢🙏</div>2023-09-18</li><br/>
</ul>