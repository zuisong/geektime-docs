...
Q5：host怎么理解？
Host难道是可以指明多个服务器吗？
Q6：HTTP3用UDP,丢包怎么解决？</div>2023-07-06</li><br/><li><span>ZENG</span> 👍（0） 💬（1）<div>自己没有总结过，老师帮总结很完全，很硬核。

对于http和https区别，就是一般使用的4层模型就到了5层模型，原来的http和tcp直接握手的变为http和tcp之间加了一个ssl&#47;tls层，专门作为加密认证等，就不会改变原来的层原有的作用，我感觉就是http加了一层装饰器</div>2023-07-05</li><br/><li><span>长林啊</span> 👍（0） 💬（1）<div>你觉得 HTTP 和 HTTPS 存在哪些区别？
-------------------------------
都是用于网络上传输数据的两种协议；
区别：
