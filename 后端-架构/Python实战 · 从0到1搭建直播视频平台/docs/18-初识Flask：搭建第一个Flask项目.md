...
另外，放在哪个目录下面就不会是main了？</div>2023-06-02</li><br/><li><span>长林啊</span> 👍（1） 💬（1）<div>老师，每次在新加一个路由后，就需要重新运行程序，否则就访问不到新加的路由，有什么方式可以实现热重载呢？</div>2023-06-02</li><br/><li><span>长林啊</span> 👍（1） 💬（1）<div>实现——用户输入不同 URL，页面显示不同内容
——————————————————————
...
现实结果为：输入的内容是：flask
</div>2023-06-02</li><br/><li><span>张申傲</span> 👍（0） 💬（1）<div>第18讲打卡~ 入门Flask</div>2024-07-24</li><br/><li><span>        </span> 👍（0） 💬（1）<div>思考题如下： 通过判断请求url来触发返回消息 </div>2024-02-21</li><br/><li><span>Aegean Sea</span> 👍（0） 💬（1）<div>python是哪个版本</div>2023-10-23</li><br/><li><span>蜡笔小新爱看书</span> 👍（0） 💬（1）<div>前端的章节里，怎么没介绍用哪个IDE的？</div>2023-08-12</li><br/><li><span>友</span> 👍（0） 💬（2）<div>前端的终于过去了 我亲爱的老师前端完整代码上传了吗 嘻嘻😁</div>2023-06-02</li><br/><li><span>        </span> 👍（0） 💬（0）<div># -*- coding:utf-8 -*-
