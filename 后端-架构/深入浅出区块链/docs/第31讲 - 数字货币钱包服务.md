...
<li><span>麋鹿在泛舟</span> 👍（2） 💬（1）<div>这里最难以处理的问题是保持 MySQL 中的区块数据与全节点数据的一致性
---
这个是定期扫描么  还是时时刻刻有变更就扫</div>2018-06-04</li><br/><li><span>沃野阡陌</span> 👍（1） 💬（1）<div>请问老师，从交易所提币出来到钱包自己保存，是不是就是您说的可以用区块链browser来看或验证是否已被打包成区块的过程？</div>2018-06-05</li><br/><li><span>Geek_f26a61</span> 👍（0） 💬（1）<div>初次读关于区块链的文章，对于区块链要解决的问题一直困惑。数字货币在公链上发行如何匹配各国的货币发行，发行规模应于经济体总量相关。就象美元与黄金挂钩，支付宝钱包里的钱与实际货币挂钩。问题若不对或对区块链误解请见谅</div>2018-06-18</li><br/><li><span>朱显杰</span> 👍（6） 💬（0）<div>对区块链有写操作的应用，很难用微服务，因为是有状态的。而区块链的读服务或基于中心库查询的web服务，完全可以用微服务。</div>2018-06-05</li><br/><li><span>陈靖</span> 👍（5） 💬（0）<div>能不能直接撸代码，边撸边讲</div>2018-06-05</li><br/><li><span>杨家荣</span> 👍（1） 💬（0）<div>极客时间第二期
21天打卡行动 29&#47;21
&lt;&lt;深入浅出区块链31&gt;&gt;数字货币钱包服务
回答老师问题:
...
</div>2020-02-03</li><br/><li><span>绝露</span> 👍（1） 💬（1）<div>区块浏览器的查询功能好理解，但是验证是指什么，能解释下吗？</div>2018-06-26</li><br/><li><span>MarkTang</span> 👍（0） 💬（0）<div>您好老师，我对BIP44有几个个疑问
...
4. HDWallet 新创建钱包时，是否需要先创建 比如20个收款地址 20个找零地址呢？ 他不够时又再新建20个， 这样设计是否合理？</div>2020-11-12</li><br/><li><span>乔良qiaoliang</span> 👍（0） 💬（0）<div>有机会介绍一下infura.io就太好了</div>2018-06-09</li><br/>
</ul>