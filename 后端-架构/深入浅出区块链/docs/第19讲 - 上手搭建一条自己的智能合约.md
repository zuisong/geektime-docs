...
![](https://static001.geekbang.org/resource/image/36/d6/36bcf515221b62694653e8b7aa6019d6.png?wh=1258*640)
...
![](https://static001.geekbang.org/resource/image/0b/5d/0bc6084a9514588107557646ea7a945d.png?wh=866*436)
...
![](https://static001.geekbang.org/resource/image/8c/f4/8caf635275f803120000425ad2add6f4.png?wh=1558*476)
...
![](https://static001.geekbang.org/resource/image/d6/27/d69fd6ce298a755fc50c68cc67e7cd27.png?wh=1920*1379)

在我的远程开发机上一共耗费了6分半，又经过了4分钟，我挖到了第一个块，如下图所示。

![](https://static001.geekbang.org/resource/image/9d/cb/9da9ac44f1057bd8918f60fde20877cb.png?wh=1690*156)

这期间机器的负载如下。

![](https://static001.geekbang.org/resource/image/99/a4/9939264d4e1d37ad307e4f12c51d7da4.png?wh=1920*537)

可以看到CPU和内存占用很高，我这里使用测试的机器是2Core 4GB Ubuntu16.04。

现在我们再去检查一下Etherbase所指向地址的余额。

![](https://static001.geekbang.org/resource/image/9b/44/9b61e6f4a7247f3b86f2962e653f5a44.png?wh=1028*94)
...
![](https://static001.geekbang.org/resource/image/9b/4d/9b89682246dc0304984ee6af011d324d.png?wh=1920*676)

编译器警告我们暂时不必理会，接下来我们还需要生成ABI部署参数，使用命令 solc --abi helloword.sol。

![](https://static001.geekbang.org/resource/image/f1/c4/f13a6440c68435938862ab57873fadc4.png?wh=1920*503)
...
![](https://static001.geekbang.org/resource/image/3b/57/3bdc482fc2eb7fed45d8b16835b1cc57.png?wh=1920*637)

我们可以通过txpool来查看未确认的交易。

![](https://static001.geekbang.org/resource/image/d6/d1/d693a9be1149770884217eddf46c2cd1.png?wh=408*230)

接下来只要等待出块即可，你的合约就会成为正常运行的合约了，否则合约还不可以调用。

由于我本地挖矿出块异常缓慢，所以我尝试了Remix IDE，运行后我们可以得到如下结果。

![](https://static001.geekbang.org/resource/image/be/03/be4e1b3e4f5727a17ba0494ca352e203.png?wh=1452*622)
