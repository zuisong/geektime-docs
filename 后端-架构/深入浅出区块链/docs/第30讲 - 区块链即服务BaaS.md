...
<li><span>zjhiphop</span> 👍（3） 💬（0）<div>稳定可指系统的可用性，响应速度等，这方面我的理解是可以通过服务器集群，缓存方面来做到。可控可以指功能和安全。功能在可扩展性方面设计的时候需要做到对外开放原则，安全更多的要从链技术，链外围结合起来，通过设置各种安全策略检测潜在的危险，出了问题之后能够快速的响应。这是我的理解，请老师点评。</div>2018-06-06</li><br/><li><span>miniluo</span> 👍（2） 💬（0）<div>请问“等区块完成异常同步”，什么意思？</div>2020-01-06</li><br/><li><span>徐宁</span> 👍（1） 💬（1）<div>五个以太币节点超过1TB，为什么是五个？每一个节点保存五分之一？</div>2018-08-27</li><br/><li><span>derek deng</span> 👍（1） 💬（0）<div>请问可控的定义是什么?</div>2018-06-03</li><br/><li><span>杨家荣</span> 👍（0） 💬（0）<div>极客时间第二期
21天打卡行动 28&#47;21
...
4,互联网公司在区块链领域的尝试:蚂蚁金服区块链，联盟链,阿里健康区块链，联盟链,Symbiont,跨境食品溯源,阿里邮箱 + 法链，阿里云 +Hyperledger,数字雄安区块链实施平台,天猫奢侈平台 Luxury Pavilion 溯源,金链盟 FISCO BCOS 区块链平台,微黄金,公益寻人链，星贝云链,TrustSQL,腾讯云金融级解决方案 BaaS;</div>2020-02-02</li><br/><li><span>万志勇</span> 👍（0） 💬（0）<div>第23讲联盟链及困境中表达“这就是我认为联盟链最大的困境，它是一杆加农炮，但是并没有人来告诉我们这杆加农炮可以解决什么问题。”貌似表达联盟链有很大的困境，为啥这里举例都是联盟链，是不是有些相互矛盾？</div>2019-12-19</li><br/>
</ul>