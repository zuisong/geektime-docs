...
<li><span>Kaito</span> 👍（32） 💬（5）<div>很荣幸，能在第二季继续给大家带来加餐文章，分享我学习Redis的经验。

这篇文章和大家分享我阅读源码的经验和心得，当然，文章里提到的方法是「通用」的，不仅限于读Redis代码，读任何项目的源码都可以按这个思路来，希望我的分享能够帮助到大家！</div>2021-09-18</li><br/><li><span>Bruis.</span> 👍（3） 💬（3）<div>Kaito大哥，如何对Redis源码进行编译，并能在开发工具上进行debug调试呢？光看源码不debug运行感觉很多细节是没法读懂的啊。</div>2021-09-18</li><br/><li><span>无痕之意</span> 👍（1） 💬（0）<div>感谢大佬分享，冲呀，我要学习，加油！！！</div>2022-02-12</li><br/><li><span>Milittle</span> 👍（1） 💬（0）<div>这个专栏可以说是有两个老师。</div>2021-09-18</li><br/><li><span>fkc_zyk</span> 👍（0） 💬（1）<div>redis是使用C语言写的，采用哪种编译器启动和读源码比较好？</div>2023-05-24</li><br/><li><span>Kang</span> 👍（0） 💬（0）<div>没有开发经验也可以这样看吗</div>2021-09-29</li><br/><li><span>Ethan New</span> 👍（0） 💬（0）<div>感谢Kaito大佬的分享，向大佬学习</div>2021-09-19</li><br/><li><span>曾轼麟</span> 👍（0） 💬（0）<div>感谢Kaito同学的分享，这段时间受益良多</div>2021-09-18</li><br/>
</ul>