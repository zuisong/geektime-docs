...
<li><span>def</span> 👍（2） 💬（0）<div>第二题， 如果第二句 不是  s1 = s1.intern(); 的话，s1 == s2 应该是false而不是true才对</div>2021-03-17</li><br/><li><span>Geek_f9c246</span> 👍（0） 💬（0）<div>分布式锁那个题目感觉解析有点问题，redlock可能出现同时获取锁，最有可能出现在分区脑裂的时候</div>2020-05-26</li><br/>
</ul>