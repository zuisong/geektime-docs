...
<li><span>Lum</span> 👍（0） 💬（1）<div>看到这里 其实对invocation，filter为啥会执行invoke等代码逻辑还是不太清楚，先插个眼，看完后总结一下</div>2023-02-28</li><br/><li><span>星期八</span> 👍（0） 💬（2）<div>@DubboService(validation ＝ &quot;jvalidation&quot;)  用代码测试了一下，在提供者不生效 什么情况！@DubboReference(validation = &quot;jvalidation&quot;) 客户端是生效的</div>2023-02-22</li><br/><li><span>Six Days</span> 👍（0） 💬（2）<div>思考题：Spring 的切面中完成对参数的统一验证？
