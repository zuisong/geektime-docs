...
<li><span>oh..</span> 👍（13） 💬（1）<div>老师我想问下，这个RPC调用过程是不是所有流程都是同步的，等于从客户端开始调用服务端接口就会一直阻塞到等返回相应结果后，程序才会结束。就像直接调用HTTP请求一样，一来一回，还是会出现几次请求返回的。这个问题我有点疑惑</div>2019-10-22</li><br/><li><span>FATMAN89</span> 👍（11） 💬（1）<div>老师能说一下，一个工业级别，生产级别的rpc，框架，比如说dubbo，在真正的实现上，与您的这个rpc框架，需要考虑哪些更多，更复杂的问题吗？多谢了！</div>2019-12-06</li><br/><li><span>大魔王汪汪</span> 👍（9） 💬（1）<div>老师 桩的实现可在编译阶段和运行时阶段，在选择上除了语言本身特点外，性能上有没有差异，比如运行时阶段跑不掉使用代理反射，如果直接在编译时生成代理类，是不是可以减少这部分性能损耗</div>2019-10-08</li><br/><li><span>奕</span> 👍（8） 💬（1）<div>不是做 java 的，对与 RPC 的调用方式 不是很理解
客户端去注册中心 找到对应的需要执行的方法，和通知服务端需要执行的方法，不还是要进行通讯的吗？这个通讯走的不是http了？</div>2019-10-12</li><br/><li><span>海罗沃德</span> 👍（3） 💬（1）<div>感覺老師講的這個跟EJB很像，name service和JNDI很像，求教是不是這樣？</div>2019-10-21</li><br/><li><span>姜戈</span> 👍（28） 💬（0）<div>太棒了，这是买一送一呀，这个专栏学到的绝不只是消息中间件知识~，还帮我们打通任督二脉，赞~</div>2019-10-12</li><br/><li><span>QQ怪</span> 👍（5） 💬（0）<div>牛逼，老师厉害了</div>2019-10-05</li><br/><li><span>kyll</span> 👍（3） 💬（0）<div>看到这里， 突然想起了N年以前使用EJB时的 Stub，感慨一下。</div>2020-02-04</li><br/><li><span>cppby</span> 👍（2） 💬（0）<div>卧槽 这一篇 看完 对rpc理解茅塞顿开。。谢谢</div>2019-11-08</li><br/><li><span>南山</span> 👍（2） 💬（0）<div>看得困意全无！</div>2019-10-07</li><br/><li><span>饭粒</span> 👍（1） 💬（0）<div>1.这样看 spring cloud 的 feign 不算 RPC 框架。。
2.stub 这个概念和远程代理 RMI 里的 stub，skeleton 蛮现实的。</div>2019-11-21</li><br/><li><span>每天晒白牙</span> 👍（1） 💬（0）<div>激动，太喜欢这个专栏了</div>2019-10-05</li><br/><li><span>VIC</span> 👍（0） 💬（0）<div>github地址，哪能看</div>2022-10-14</li><br/><li><span>Em</span> 👍（0） 💬（0）<div>不得不说  brpc功能挺强大的</div>2022-07-01</li><br/><li><span>子非鱼</span> 👍（0） 💬（0）<div>项目在mac，java8 下运行发现server，client启动正常，但client发送后一直没法收到响应</div>2022-04-29</li><br/>
</ul>