...
另外，钟老师近期翻译了《领域驱动设计参考》。项目地址：https:&#47;&#47;github.com&#47;zhongjinggz&#47;ddd-reference-cn ；电子书地址：https:&#47;&#47;zhongjinggz.github.io&#47;ddd-reference-cn&#47;#&#47; 。 通过这本小册子，可以快速一览DDD全貌。同学们可以作为课后拓展阅读资料使用，有什么翻译不准确，或者不好理解的地方也欢迎提出。</div>2024-02-19</li><br/><li><span>南山</span> 👍（7） 💬（1）<div>搞了这么久的DDD，自己可能理解也不够深入，也是感觉道理都懂，落地也大概知道怎么落地。
还有一点比较深的体会是DDD不是一个人就能搞起来的，而是各个角色（产品、业务、研发、测试）都要参与进来才具备落地的基础，如果是这样又会面临如何能让这些角色积极参与进来的难题，可能很多公司根本就具备这个条件。
自己也始终相信这条路是对的，就是开头比较难，只能选择性的应用，扩大影响力，先营造好环境，再谈落地实践</div>2022-12-08</li><br/><li><span>业余草</span> 👍（8） 💬（1）<div>DDD 就和懂道理一样，自以为懂了 DDD（道理），实际上还是驾驭不了。
...
注意，我并不是否定 DDD！</div>2022-12-07</li><br/><li><span>plimlips</span> 👍（5） 💬（1）<div>DDD最初吸引我的是业务代码和技术代码分离，开始实践后，陆续遇到这些问题：
1.一定要分离，还是看项目进度？大多数我选择了后者；
2.什么是业务代码，什么是技术代码？crud是技术，实体间交互是业务；
3.通过什么框架来分离？资源库接口；
4.如何聚焦业务？企业架构分析、业务流程分析、系统场景分析、面相对象分析；
5.如何组织业务代码？设计模式；</div>2023-01-19</li><br/><li><span>方勇(gopher)</span> 👍（4） 💬（2）<div>老师你好，项目将采用什么语言编程呢</div>2022-12-06</li><br/><li><span>Jxin</span> 👍（3） 💬（1）<div>36讲要讲清楚这些，难度颇大啊。
与钟老师一起学习。

谁都可以抽象，但只有智者知道在哪里停下。

希望学完我们都能在度的把握上更进一步。</div>2022-12-06</li><br/><li><span>Walker Jiang</span> 👍（2） 💬（1）<div>建议多些代码，现在业界不差ddd的理论资料，差的是代码案例</div>2022-12-11</li><br/><li><span>aoe</span> 👍（2） 💬（1）<div>一起探索</div>2022-12-06</li><br/><li><span>JianXu</span> 👍（1） 💬（1）<div>之前看了徐昊老师的DDD, 这两个专栏的区别是什么呢？</div>2022-12-11</li><br/><li><span>Geek_d1bbb0</span> 👍（1） 💬（2）<div>老师您好，这里提到的领域建模，是不是针对业务建模。比如用统一建模语言UML画用例图，活动图，时序图，状态图等。</div>2022-12-06</li><br/><li><span>一拳超人</span> 👍（0） 💬（1）<div>年初泛泛的看了一遍，后续又去看了一遍王铮的设计模式，加深面向对象的理解；再再去实战了下cola框架，这次回来，再次加深，希望能有更深的理解</div>2023-10-25</li><br/><li><span>业余爱好者</span> 👍（0） 💬（1）<div>想逆向工程，给公司的系统画一张业务架构图。但因为一直窝在一个部门，对于外部的业务不甚了解，所以绞尽脑汁也没有好的思路。然后想到ddd是做业务分析建模的，于是就想来学习一下，现学现卖，希望学完能对公司的业务有整体的理解，并画出架构图。同时，希望自己能掌握分析业务与需求的方法。</div>2023-04-26</li><br/><li><span>阿白</span> 👍（0） 💬（2）<div>请问老师，课程里面的模型是用什么软件画的？
DDD强调的是，领域模型要和业务需求一致，系统实现要和领域模型一致。模型的建立非常重要，有没有好的软件，可以提高下 画模型的效率。</div>2023-04-22</li><br/><li><span>花花大脸猫</span> 👍（0） 💬（1）<div>一直停留在概念阶段，没有实操过，希望通过此专栏的学习，采用DDD的理论对目前遗留的老系统的重构改造有指导性的作用</div>2023-03-08</li><br/><li><span>Geek_be4d9a</span> 👍（0） 💬（1）<div>作者是我听过的讲DDD最好的老师，老师还有其他什么课程吗？</div>2023-02-21</li><br/>
</ul>