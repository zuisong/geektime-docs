...
<li><span>自由民</span> 👍（10） 💬（3）<div>作为非专业人士，算法数据结构我学过N次了，要么就是照着书从头到尾敲一遍(的确有帮助，至少编程本身更熟练了)，要么就是看《算法导论》之类的书，然后最多的一次看到第四章就放弃了。实际写程序的时候还是用最简单的直觉的算法，或者就抄现成的。请问老师怎么提高应用算法的能力？做题吗？</div>2019-11-07</li><br/><li><span>董懂</span> 👍（2） 💬（1）<div>看老师文章中的代码就是一种享受，无论是注释还是代码格式，对比自己，我就是个野路子程序猿，-_-||</div>2020-03-13</li><br/><li><span>许童童</span> 👍（34） 💬（5）<div>Leetcode刷了近300道题，现在还在坚持，跟着老师一起精进。</div>2019-08-09</li><br/><li><span>皮特尔</span> 👍（30） 💬（1）<div>一男生带着4本书出图书馆，结果警报响了。大妈把书分成两份，第一份过了一下，响了。又把这一份分成两份，第一份过了一下，又响了。于是男生在大妈鄙视的眼神里，羞愧地带着另外3本书走了。第二天，图书馆丢了3本书。</div>2020-06-21</li><br/><li><span>Nick</span> 👍（5） 💬（2）<div>不得不说，那个B站视频内容引起极度舒适。</div>2019-08-13</li><br/><li><span>陈超</span> 👍（4） 💬（0）<div>不过瘾啊，小老师推荐点实战的书或开源项目参考。</div>2019-08-10</li><br/><li><span>好运来</span> 👍（3） 💬（0）<div>感谢老师提纲挈领的数据结构与算法的总结，值得收藏</div>2020-09-20</li><br/><li><span>Nemo</span> 👍（3） 💬（0）<div>推荐极客时间算法训练营，不错的课程安排，笔记：https:&#47;&#47;kanghaov.com&#47;428.html</div>2020-08-05</li><br/><li><span>未来已来</span> 👍（2） 💬（0）<div>我发现现在是 11111 人已学习，看来学习注定是一条孤独的道路，只有自己坚持，才能走向成功</div>2019-08-09</li><br/><li><span>tt</span> 👍（2） 💬（0）<div>感谢老师提纲挈领的答疑讲解</div>2019-08-09</li><br/><li><span>_stuView</span> 👍（2） 💬（0）<div>老师能不能系统讲一下包的import，有很多地方不是很清楚，比如我该怎么知道什么时候该导入哪个包，为什么有时候同时使用类似import math和from math import aqrt这样的两个包等等，还有装饰器也还是不太明白，谢谢老师</div>2019-08-09</li><br/><li><span>farFlight</span> 👍（2） 💬（1）<div>老师，heap的插入删除应该是O(logn)的复杂度吧</div>2019-08-09</li><br/><li><span>瑞哲</span> 👍（1） 💬（0）<div>老师，堆的随机插入和删除的时间复杂度应该是O(log(n))吧</div>2020-04-19</li><br/><li><span>张鑫</span> 👍（1） 💬（0）<div>老师的提纲很全面，复习算法可以参考！</div>2019-08-09</li><br/><li><span>KaitoShy</span> 👍（1） 💬（0）<div>知道很容易，但是真正落地实施，到学会是一件不是那么容易的事情。需要不断的推敲琢磨，除非天赋异禀😂😂</div>2019-08-09</li><br/>
</ul>