...
<li><span>宙斯</span> 👍（3） 💬（1）<div>需要对newProxyReverseProxy做改造，在newProxyReverseProxy里再定义一个前端director，且对请求地址做检查，若匹配有js后缀的，则直接使用前端的director。</div>2021-12-13</li><br/><li><span>牛玉富</span> 👍（0） 💬（0）<div>这个功能亮了，这才是架构师干的事😀</div>2022-01-13</li><br/>
</ul>