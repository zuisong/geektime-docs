...
<li><span>Geek_a8c1a2</span> 👍（1） 💬（1）<div>重构的同时，正常的业务迭代不会停止，如果重构时间较长，如何确保这期间的需求变更？ 您也提到了避免长时间周期的重构分支，请教下 一般来说 多长的重构周期会比较合理？</div>2023-03-14</li><br/><li><span>peter</span> 👍（1） 💬（1）<div>请教老师几个问题：
Q1：第五步接口嵌套是笔误吗？
