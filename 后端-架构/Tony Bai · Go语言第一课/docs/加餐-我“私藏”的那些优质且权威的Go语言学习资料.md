...
<li><span>罗杰</span> 👍（15） 💬（1）<div>要学的东西太多太多了，不论从哪里开始，从一点一滴掌握做起。有时候选择太多跟没有选择一样，先把该专栏吃透，再计划读书，一本中文，一本英文，同时也努力去阅读 Go 官方博客。</div>2021-12-15</li><br/><li><span>aoe</span> 👍（7） 💬（1）<div>《Go 语言实战》读过一遍，已经全忘了；
...
今天又看到了这么多学习资源，心情很激动！
想想在 《Go 项目的代码 review 站点》可以看到世界级大佬点评代码就更激动了！</div>2021-12-15</li><br/><li><span>用0和1改变自己</span> 👍（5） 💬（1）<div>棒，方向对了，就不怕路远</div>2021-12-15</li><br/><li><span>ShiPF</span> 👍（3） 💬（1）<div>机械工业出版社的那本go程序设计语言翻译简直辣眼睛🙈，还是多学英语啃原版比较香</div>2022-06-02</li><br/><li><span>进化菌</span> 👍（2） 💬（1）<div>他山之石可以攻玉，好东西当然要多翻阅。对于当下还不熟悉go的自己，多用代码解决问题，再参考资料，应该很棒~</div>2021-12-16</li><br/><li><span>Da Vinci</span> 👍（2） 💬（1）<div>欧神的go语言原本挺不错的，但是有点难复用，需要慢慢品</div>2021-12-16</li><br/><li><span>lesserror</span> 👍（2） 💬（2）<div>大白老师的这些推荐，很多都是我之前不知道的，可谓是大开眼界了。

不过，打开电商网站，搜索Go的图书，发现已经有很多国人写的著作了，其中不乏优秀之作。也有极客时间这类在线学习的网站。Go的技术布道在国内已经是遍地开花的状态了。

另外，文中说：“同时 Go 还将整个 Go 项目文档都加入到了 Go 发行版中，这样开发人员在本地安装 Go 的同时也拥有了一份完整的 Go 项目文档。”  我记得Go从某个版本开始，已经不在本地安装项目文档了吧？</div>2021-12-15</li><br/><li><span>Jussi Lee</span> 👍（1） 💬（1）<div>请问老师，有没有比较好go相关框架学习的资料。例如go chassis 等之类的</div>2022-07-07</li><br/><li><span>ps Sensking</span> 👍（1） 💬（1）<div>请问您的两本书和这个专栏讲的一样嘛？不一样的话我希望买，如果一样的话，我希望您能出一个实战类的go 和 postgresql 结合的实战 </div>2022-01-13</li><br/><li><span>Rayjun</span> 👍（1） 💬（1）<div>赞，归根结底还是得自己去消化一手信息</div>2021-12-15</li><br/><li><span>不求闻达</span> 👍（0） 💬（1）<div>干货满满，《Go程序设计语言》从一点一滴掌握做起</div>2023-11-10</li><br/><li><span>lesserror</span> 👍（0） 💬（2）<div>Tony bai 老师，我看你的个人网站分享的那个 k8s 课程的图片上的二维码扫码总是失败，你有时间检查一下。</div>2023-08-17</li><br/><li><span>Jay</span> 👍（0） 💬（1）<div>老师的书有电子版吗？想随时可以在手机上翻阅</div>2022-09-23</li><br/><li><span>微微超级丹💫</span> 👍（0） 💬（1）<div>感觉学无止境啦哈哈</div>2022-09-15</li><br/><li><span>菠萝吹雪—Code</span> 👍（0） 💬（1）<div>师傅领进门，修行在个人</div>2022-09-14</li><br/>
</ul>