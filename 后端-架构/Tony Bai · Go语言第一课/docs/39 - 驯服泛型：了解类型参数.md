...
<li><span>那时刻</span> 👍（3） 💬（3）<div>go语言范型不使用 &lt;&gt;，我想到一个点，是不是解析的时候 容易与大于 或者小于 符号混淆？</div>2022-11-10</li><br/><li><span>文武木子</span> 👍（3） 💬（1）<div>沙发🛋️</div>2022-11-04</li><br/><li><span>左耳朵东</span> 👍（2） 💬（1）<div>既然泛型函数的实例化是在编译阶段做的，实例化生成的也是一个普通函数，怎么压测结果比普通函数要慢呢，不知道哪里多出来的性能损耗？</div>2023-07-27</li><br/><li><span>麦子</span> 👍（1） 💬（1）<div>go语言范型不使用 &lt;&gt; 
难道和组合有关系，为了统一？类似[]int</div>2023-11-27</li><br/><li><span>return</span> 👍（1） 💬（1）<div>白老师一如既往的超高质量，感谢老师的无私奉献。</div>2022-11-17</li><br/><li><span>一打七</span> 👍（1） 💬（1）<div>还好时不时复习一下老师的课，又等到老师更新了，意外之喜</div>2022-11-08</li><br/><li><span>罗杰</span> 👍（1） 💬（1）<div>最近打算看看泛型，然后就看到了老师的更新，非常及时。不过，看起来并没有那么容易，老师写的很详细，需要好好消化一下。</div>2022-11-06</li><br/><li><span>Calvin</span> 👍（1） 💬（1）<div>终于等到你，还好你没放弃。😂
白老师的课程一如既往的高质量，这篇文章补充了我很多关于泛型的未知知识点。</div>2022-11-05</li><br/><li><span>吃橘子的汤圆🐳</span> 👍（1） 💬（0）<div>感谢</div>2023-02-26</li><br/>
</ul>