...
<li><span>张诚</span> 👍（83） 💬（7）<div>目前网上讲包管理讲得最清晰最全面的内容了。</div>2021-10-25</li><br/><li><span>若水清菡</span> 👍（21） 💬（2）<div>之前看过两个老师讲go，上来基本上都适合先语法规则后实践的路线，每次go build都一脸懵逼，看下来还是不了解go的编译过程~~~~tony bai老师讲的非常好，遇到一位合适自己的老师，希望跟着学完这门课程，非常感谢老师~</div>2021-11-14</li><br/><li><span>lesserror</span> 👍（18） 💬（3）<div>感谢 Tony Bai 老师的分享，每篇文章我都认真拜读了。
...
4. 第4讲说到：“Go 支持在一个项目 &#47; 仓库中存在多个 module，但这种管理方式可能要比一定比例的代码重复引入更多的复杂性。”  如果项目中引入了第三方 module，比如这篇文章中也引入了第三方 module，这种情况属于 :  &quot;在一个项目 &#47; 仓库中存在多个 module&quot; 的情况吗？</div>2021-10-25</li><br/><li><span>flexiver</span> 👍（13） 💬（5）<div>老师，您好。想要请问解答两个问题： 1、请问在构建module时， go mod init -module path, 这个module path 是固定要写成github.com&#47;module name这样一个结构吗？ </div>2022-03-13</li><br/><li><span>丶能</span> 👍（12） 💬（11）<div>提问！
“选择符合项目整体要求的最小版本”是可能选择，依赖最小版本与最新版本中任意版本，还是项目引入版本中的可选范围内的最小版本呢？</div>2021-10-25</li><br/><li><span>chin</span> 👍（11） 💬（2）<div>默认是是最小版本原则，能否修改默认呢？比如举例当中的v1.1.0、v1.3.0、v1.7.0默认会选v1.3.0，开发者能否将其改成v1.7.0呢？</div>2022-03-23</li><br/><li><span>独钓寒江</span> 👍（7） 💬（3）<div>老师你好，最近 log4j 和 logback 都被发现了安全漏洞，很多Java程序都受到影响，修复起来工作量也不小。如果类似情况出现在Go方面，例如 logrus 出了安全漏洞，我们需要修改依赖版本, 我们可以怎么应对呢？可以简单说说吗？</div>2021-12-25</li><br/><li><span>ゝ骑着小车去兜风。</span> 👍（6） 💬（4）<div>之前做过一个go的项目，用的iris框架，然而拉下来的包始终没有我需要的那个方法，纠结了好久都没办法解决。 现在终于知道是iris框架更新了，导致主板本号不同，需要的那个方法也变成另一个方法了。</div>2022-04-30</li><br/><li><span>李亮</span> 👍（5） 💬（2）<div>关于依赖管理的文档在这里：https:&#47;&#47;go.dev&#47;doc&#47;modules&#47;managing-dependencies</div>2022-11-01</li><br/><li><span>每天晒白牙</span> 👍（4） 💬（2）<div>老师，请教个问题，我是go1.16.4版本，按照老师在文中所说，GO111MODULE 应该为on呀，而我的确实空
(base) ➜  ~ go env
GO111MODULE=&quot;&quot;
GOARCH=&quot;amd64&quot;
....
GOVERSION=&quot;go1.16.4&quot;</div>2022-05-10</li><br/><li><span>李进</span> 👍（4） 💬（1）<div>作为go的入门者，一直觉得没有理解理解GO的包的依赖管理和mod机制，读了老师的几篇文章，终于理解了。</div>2022-04-18</li><br/><li><span>rocshen</span> 👍（4） 💬（1）<div>目前看过课程结构设计最合理的教程  给老师点赞</div>2022-03-06</li><br/><li><span>功夫熊猫</span> 👍（4） 💬（2）<div>其实这几天我难受的是自定义的包导入的问题。</div>2021-11-15</li><br/><li><span>林</span> 👍（4） 💬（1）<div>这位老师的文章犹如编程爽文，看的过瘾</div>2021-11-05</li><br/><li><span>liaomars</span> 👍（4） 💬（3）<div>把GOPATH构建下的项目目录复制一份出来，在这个目录下面开启 GO MODULES，执行：go mod init &amp;&amp; go mod tidy</div>2021-10-26</li><br/>
</ul>