...
<li><span>自由</span> 👍（47） 💬（1）<div>Tony Bai 老师，你好，我接触 go 目前已经 3 个月了。在接触 go 一个月后，我就选择跳槽去了一家 go 的公司，我对 go 的发展是坚定不移的肯定，相信它会越来越好。

我的问题是，阅读完该专栏，我是否可以得到 go 风格的代码编写风格、优雅的 go 编程姿势？</div>2021-10-13</li><br/><li><span>文经</span> 👍（36） 💬（0）<div>白老师，Go 实现自举具体是什么意思，是不是用Go语言开发的工具链来编译和执行Go源代码？这个具体是一个什么样的过程，Go语言为什么到了1.5版本才实现自举，是因为这个过程很难吗，为什么自举对Go来说是一个重要的节点？</div>2021-10-26</li><br/><li><span>aoe</span> 👍（21） 💬（9）<div>学习Go是因为VS Code的Copilot插件支持Go但不支持Java，AI插件写代码不是一般的强</div>2021-10-14</li><br/><li><span>老韩</span> 👍（19） 💬（1）<div>老师，什么样的人适合学 Go 语言，我目前是Java工程师，在一家小公司里。</div>2021-10-14</li><br/><li><span>lesserror</span> 👍（12） 💬（2）<div>很早就关注老师的微博了，看到老师几乎每天都在分享关于Go的知识。
...
怎么理解这里的一动一静呢？</div>2021-10-13</li><br/><li><span>jimmyd</span> 👍（8） 💬（2）<div>老师 请问go在机器学习算法包括工程这一块 前景如何</div>2021-10-13</li><br/><li><span>1900</span> 👍（7） 💬（3）<div>请问中小公司中的Go语言技术栈的岗位多吗？</div>2021-10-15</li><br/><li><span>fomy</span> 👍（5） 💬（2）<div>我是Java开发者，没有系统学习过Go语言，希望老师能说一下Java和Go的区别。</div>2021-10-15</li><br/><li><span>arch</span> 👍（5） 💬（1）<div>tony老师，文中提及go GC很多次，期待补充些golang GC相关的文章哈</div>2021-10-14</li><br/><li><span>快乐就好</span> 👍（4） 💬（2）<div>运维转go开发，有机会入门吗  </div>2022-07-11</li><br/><li><span>westfall</span> 👍（3） 💬（2）<div>刚开始学这个课程，不知道老师还会不会回复，就是好奇地想问一下，为什么那些跟云相关的项目，比如 docker k8s 等等都选择用 go 来开发？</div>2022-05-01</li><br/><li><span>多喝热水</span> 👍（3） 💬（1）<div>老师辽宁人吧</div>2021-10-16</li><br/><li><span>JS</span> 👍（3） 💬（1）<div>之前自己的基础比较薄弱，有时候遇到一些问题，不太知道如何处理，这次就权当复习了</div>2021-10-14</li><br/><li><span>凡</span> 👍（2） 💬（1）<div>目前是2023年1月，想从客户端iOS转Go，不知道是否可行？</div>2023-02-01</li><br/><li><span>第一装甲集群司令克莱斯特</span> 👍（2） 💬（1）<div>Java开发者，最近学习了Golang和Python，了解了这2种语言的设计思想，语法结构，融会贯通！</div>2022-07-04</li><br/>
</ul>