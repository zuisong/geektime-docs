...
服务器端的连接进入ESTABLISHED 状态，课程上说的是accept返回后才进入，但是我自己实验发现只要客户端发送ack后，也就是第三次握手完成就进入了ESTABLISHED 状态，和accept没有关系，请问一下老师是我哪里理解错了吗？</p>2019-08-13</li><br/><li><span>_stuView</span> 👍（6） 💬（7）<p>sockfd里的这个fd代表什么</p>2019-08-09</li><br/><li><span>Knight²º¹⁸</span> 👍（5） 💬（3）<p>老师我有一个问题，编程语言中的IO模型和操作系统中的IO关系是什么？</p>2019-08-11</li><br/><li><span>浦上清风</span> 👍（4） 💬（1）<p>1. 非阻塞 == 异步通信 ？？？
2. 可以是可以，但是不安全？？？</p>2019-08-09</li><br/><li><span>星亦辰</span> 👍（3） 💬（4）<p>思考题2 
