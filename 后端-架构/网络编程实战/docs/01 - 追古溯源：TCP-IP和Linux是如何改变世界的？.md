...
<li><span>业余爱好者</span> 👍（37） 💬（1）<div>网络协议，epoll,系统调用...脑子里对这些基础知识一直一知半解，不成体系，希望通过追一个贴近实战的网络专栏建立知识之间的关联。flag~</div>2019-08-02</li><br/><li><span>陈俊豪200</span> 👍（23） 💬（3）<div>讲的很好啊，很多书上提及的混乱的历史都被梳理了一遍，很有兴趣，谢谢老师！</div>2019-08-02</li><br/><li><span>java小白</span> 👍（14） 💬（1）<div>能把这么复杂的问题讲清楚，真的是一种能力，真心的叫你一声“老师”</div>2019-08-06</li><br/><li><span>高超</span> 👍（9） 💬（2）<div>支持将 linux 叫做 GNU&#47;Linux，这样也算是对 GNU 致敬了。</div>2019-08-02</li><br/><li><span>geraltlaush</span> 👍（8） 💬（3）<div>之前学习linux网络编程的时候被人给忽悠了，说mac系统不需要装linux，完全兼容，然后学习过程中遇到了一堆不明觉厉的问题，最坑的是macos没有epoll，然后我和一个同学一脸懵逼的把epoll改成了poll才把程序编过去，学习linux编程最好还是装个linux虚拟机，哈哈哈，当前往事不堪回首</div>2019-08-02</li><br/><li><span>Skrpy</span> 👍（8） 💬（1）<div>我认为没必要把世人熟知的 Linux 改成 GNU&#47;Linux，我觉得如果一个操作系统名字这么写，那着实不好看……(我不是说 TCP&#47;IP )。C 语言的编译器就是 GNU 家的，它还有许多为人称道的自由软件，GNU 会名垂千古，没必要把自己贴到同样名垂千古的 Linux 脸上</div>2019-08-02</li><br/><li><span>Zopen</span> 👍（6） 💬（1）<div>问个问题：

摄像头推送视频流到流媒体服务器（基于TCP传输），理论传输速度是3M&#47;S，实际测试发现是2M&#47;S，请分析下可能出现的原因？</div>2019-08-02</li><br/><li><span>神经旷野舞者</span> 👍（4） 💬（2）<div>老师，linux的源码和unix到底一样吗还是实现区别大？</div>2019-12-21</li><br/><li><span>Mr. Ren</span> 👍（4） 💬（1）<div>连续听了两节课，第一节中所说的学习网络过程中的那种心里很符合我现在的情况，到底是学基础还是学框架有点迷茫，第二课中说了发展历史，对这些年了解的历史更加细一些，图文加语音，足见老师对课程的用心，站在巨人的肩上，可以看的得更远，期待老师下一课的课程🤝</div>2019-08-04</li><br/><li><span>啊树</span> 👍（4） 💬（1）<div>老师 OSI模型更多的是运用到硬件设备分层，TCPIP协议更多作为互联网协议么？</div>2019-08-04</li><br/><li><span>钱</span> 👍（3） 💬（1）<div>有些看隋唐演义的感觉，过瘾！
有生于无，由简入繁，认知还是需要一个循序渐进的过程的，这样就不会怀疑自己是否有大脑了，会觉得一切都是自然而然的就发生了。</div>2019-11-18</li><br/><li><span>Geek_66666</span> 👍（3） 💬（1）<div>所以平时教科书上osi七层在实际中并没有采用而是采用tcp&#47;ip标准？</div>2019-08-02</li><br/><li><span>菠萝power</span> 👍（2） 💬（1）<div>为什么在那么早期、网络还没有开始普及时候，就想出这些个复杂、全面的协议，并一直持续发展下去，以前的人怎么那么强啊</div>2021-02-20</li><br/><li><span>郑祖煌</span> 👍（2） 💬（1）<div>毕竟是GNU先出来的，所以Linux为了自身的营销和发展，叫自己为GNU&#47;Linux 估计也是为了借这个GNU这个势能吧。就像JavaScript明明是跟Java无关的一种语言，为了自身的发展，可能需要搭在老大哥的名字上。这算是借助别人文化势能的力量来发展自己，等自己发展壮大了，自己本身也成了一种文化势能。</div>2020-06-12</li><br/><li><span>YUANWOW</span> 👍（2） 💬（2）<div>我觉得应该是整体借鉴
是Linux还是GNU&#47;Linux 
Linux只是内核，如果发行版的内核不是通过GCC编译出来的可以叫Linux
如果是GCC编译出来的就应该叫做GNU&#47;Linux  </div>2019-08-08</li><br/>
</ul>