...
<li><span>李</span> 👍（10） 💬（1）<div>为什么要对商品打标呢？秒杀商品在活动页面不就代表是秒杀商品了吗？点击进去详情页面，就到单独的秒杀详情页，不就和普通商品详情页区别开了吗？</div>2021-10-08</li><br/><li><span>kavi</span> 👍（2） 💬（3）<div>设计独立的宣传页进行引流？</div>2021-11-04</li><br/><li><span>chon</span> 👍（1） 💬（1）<div>请教一下，页面染色打标会对代码有侵入性吗？如果需要修改代码，秒杀活动或者有其他新的需求，那么就需要多次更改代码，这样贵引入风险吗？</div>2021-11-04</li><br/><li><span>无脑熊</span> 👍（1） 💬（1）<div>思考题:根据作者提供的思路，同样也是在用户点击购买按钮的时候进行流量隔离，按钮的链接是秒杀系统单独的域名，单独的秒杀域名下映射多个nginx服务器</div>2021-10-29</li><br/><li><span>_xcc</span> 👍（4） 💬（1）<div>系统隔离，第二个代码段，@Autowired位置错了吧</div>2021-10-04</li><br/><li><span>纵不朽</span> 👍（2） 💬（0）<div>思考题：我来总结一下老师说的，如果确定不用文章上面讲的skutag方式打标在进商品详情页那一刻分流的方案，就会导致商品详情页压力很大，此时就可以单独对这些sku进行限流</div>2022-10-07</li><br/><li><span>最摇摆的鱼</span> 👍（2） 💬（0）<div>最后一张图的后端微服务画反了， 不过一般都能看出来的。</div>2021-11-28</li><br/><li><span>oops</span> 👍（1） 💬（0）<div>秒杀商品详情 ，活动结算需要独立开发。 秒杀流程依赖购物车，订单，商品能力依赖已有的交易基础服务，通过基础服务扩容，服务分组的方式给不同场景提供基础能力？</div>2021-10-20</li><br/><li><span>林伟烽</span> 👍（1） 💬（1）<div>把商祥页静态化，丢到cdn上？</div>2021-10-04</li><br/><li><span>Geek_de63d1</span> 👍（0） 💬（0）<div>老师，在秒杀系统中，如果避免同一件商品被多人重复抢去呢？一直没有领会到，麻烦老师答凝下，谢谢</div>2023-03-05</li><br/>
</ul>