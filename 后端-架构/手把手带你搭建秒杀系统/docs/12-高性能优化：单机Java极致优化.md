...
<li><span>清风</span> 👍（11） 💬（1）<div>可以部署两个服务，将http服务和RPC服务分开，http服务使用独立的域名对外服务，Rpc使用独立的group对外服务</div>2021-10-26</li><br/><li><span>胡桐祥</span> 👍（1） 💬（0）<div>JVM 内存模型那里标错了，-Xms应该是堆区的初始化内存吧，不是最小内存，</div>2024-01-09</li><br/>
</ul>