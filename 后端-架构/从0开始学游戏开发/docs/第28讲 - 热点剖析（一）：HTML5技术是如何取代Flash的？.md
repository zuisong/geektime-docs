...
<li><span>壬大师</span> 👍（2） 💬（1）<div>老师，像斗地主、三国杀这种牌类手机游戏是用html5合适还是C++合适？</div>2018-06-23</li><br/><li><span>周飞</span> 👍（11） 💬（0）<div>XMLHttpRequest是原生ajax请求，不能解决跨域问题，还是得用jsonp或cors来解决。h5提供的是postmessage</div>2018-06-23</li><br/><li><span>董豪强</span> 👍（3） 💬（0）<div>threejs ，更底层的其实还是webgl</div>2018-06-19</li><br/><li><span>曹源</span> 👍（2） 💬（0）<div>WebGL？</div>2018-06-16</li><br/><li><span>😯</span> 👍（1） 💬（0）<div>WebGL吧，我们之前项目做过3D模型在浏览器渲染用到的就是这</div>2018-11-27</li><br/><li><span>H.Humbert</span> 👍（1） 💬（0）<div>webgl</div>2018-07-22</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<div>学习打卡</div>2024-04-05</li><br/><li><span>神马*涛💋</span> 👍（0） 💬（0）<div>老师，比如一个中国象棋游戏。用H5好 ，还是做成安卓app更好？</div>2021-09-07</li><br/><li><span>王俊涛</span> 👍（0） 💬（0）<div>canvas webgl</div>2018-06-17</li><br/>
</ul>