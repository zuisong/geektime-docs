...
<li><span>云学</span> 👍（2） 💬（0）<div>test_fun里的dosomething是在调用lua脚本中的函数吗？p1 .p2是入参？</div>2018-07-26</li><br/><li><span>猫少</span> 👍（1） 💬（2）<div>想提一个问题，请问老师，这一篇的结构体和宏，极其调用代码都是直接写lua里吗，还是得用c语言写</div>2019-09-18</li><br/>
</ul>