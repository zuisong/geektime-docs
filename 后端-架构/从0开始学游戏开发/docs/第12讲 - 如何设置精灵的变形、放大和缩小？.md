...
<li><span>三硝基甲苯</span> 👍（1） 💬（0）<div>class plane(pygame.sprite.Sprite):
...
忙了半个月。终于又可以开始学了
</div>2018-07-06</li><br/><li><span>naijiz</span> 👍（1） 💬（0）<div>等好久，周四到周二真是漫长</div>2018-06-26</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<div>学习打卡</div>2024-03-20</li><br/><li><span>以往</span> 👍（0） 💬（0）<div>1.给这个类设置一个成员变量state，值可以为0、1对应缩放
2.在update方法里写个while循环，把之前的update方法体都放进循环体里
3.修改self.image的赋值语句，根据state决定调用scale方法的参数</div>2018-06-27</li><br/><li><span>naijiz</span> 👍（0） 💬（0）<div>等好久...周四到周二真是漫长的等待</div>2018-06-26</li><br/>
</ul>