...
<li><span>艾尔欧唯伊</span> 👍（4） 💬（3）<div>.a后缀不是Linux下的静态库文件么。。。win下是.lib吧？</div>2018-06-11</li><br/><li><span>叶Da</span> 👍（2） 💬（1）<div>老师我想请问一下vc++和vs有何区别</div>2018-07-15</li><br/><li><span>梦阳</span> 👍（2） 💬（1）<div>身边没有Windows电脑，在Mac上没办法follow这个课程了吗？</div>2018-06-20</li><br/><li><span>川杰</span> 👍（2） 💬（1）<div>你好，请问IDE为什么不选用visual studio2017社区版（免费）？它继承了c&#47;c++和python，并且功能强大。</div>2018-06-17</li><br/><li><span>我叫JB</span> 👍（1） 💬（1）<div>为何还会用到Python2呢，Python3入的门，感觉Python2和Python3的很多库都不一样，改来改去很麻烦Ծ‸Ծ</div>2018-06-08</li><br/><li><span>茂陵刘郎秋风客</span> 👍（1） 💬（1）<div>必须要32位？</div>2018-06-07</li><br/><li><span>野山门</span> 👍（1） 💬（1）<div>很喜欢这个游戏专栏，受益非浅。

Qt的绘图引擎好像也很不错，跨平台，有没有这方面的使用案例和分析？</div>2018-06-07</li><br/><li><span>Geek_dx</span> 👍（0） 💬（1）<div>老师，问一下，如果在window上开发，如果打包，最终怎么保证要在iOS系统上运行？</div>2020-07-28</li><br/><li><span>袁去病自然学派</span> 👍（0） 💬（1）<div>Lua静态库，完全不知道怎么找……解说不详尽呢</div>2018-07-12</li><br/><li><span>淡看烟雨_</span> 👍（0） 💬（1）<div>什么叫绑定实现？前面课里不是说pygame包括了对SDL的封装吗？如果绑定是指使用SDL类库的功能，直接调用sdl相关modules不就可以了吗？</div>2018-06-13</li><br/><li><span>茂陵刘郎秋风客</span> 👍（0） 💬（1）<div>我安装的是3.6的32位，要怎么安装</div>2018-06-12</li><br/><li><span>kk</span> 👍（0） 💬（1）<div>为啥不用python3啊？</div>2018-06-08</li><br/><li><span>金泽龙</span> 👍（0） 💬（1）<div>没有Java吗，期末大作业，老师说后台要用Java写</div>2018-06-07</li><br/><li><span>Geek_King@技术爱好者</span> 👍（12） 💬（1）<div>&gt;pygame 有64位版本
&gt;python IDE可以试试pycharm或者vscode+插件</div>2018-06-08</li><br/><li><span>以往</span> 👍（5） 💬（0）<div>1.将需要使用的C文件编译成.so
2.在python使用时以module形式import，SDL库里的任意函数都可以被调用</div>2018-06-07</li><br/>
</ul>