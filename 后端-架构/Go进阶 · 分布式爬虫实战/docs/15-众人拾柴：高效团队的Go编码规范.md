...
<li><span>一打七</span> 👍（4） 💬（1）<div>函数小结，为什么避免使用init函数？为什么禁止return裸返回？</div>2022-11-14</li><br/><li><span>文经</span> 👍（0） 💬（1）<div>请问郑老师，接口的最佳实践什么时候展开说说，这块在设计的时候挺重要的。</div>2022-12-04</li><br/><li><span>8.13.3.27.30</span> 👍（0） 💬（1）<div>goimports 有空行没办法自动整理怎么解决</div>2022-11-26</li><br/><li><span>Realm</span> 👍（6） 💬（0）<div>errors. ErrorNew()，按老师的建议，包里面有个errors名字了，方法里面也出现这个名字，不够简洁.</div>2022-11-12</li><br/><li><span>陈卧虫</span> 👍（1） 💬（0）<div>Errors包名已经表达了错误的含义，用errors.New就可以表明是新建错误，errors.ErrorNew就显得很多余</div>2022-11-12</li><br/><li><span>风铃</span> 👍（1） 💬（0）<div>又是干货满满的一天</div>2022-11-12</li><br/><li><span>胖黑</span> 👍（0） 💬（1）<div>裸返回那个样例编译不会报错吗</div>2023-03-15</li><br/>
</ul>