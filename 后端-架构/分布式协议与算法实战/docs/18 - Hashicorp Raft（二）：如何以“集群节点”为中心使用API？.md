...
<li><span>Ethan Liu</span> 👍（9） 💬（2）<div>老师 状态机的作用是什么，为什么一定要有这个呢</div>2020-06-24</li><br/><li><span>Stony.修行僧</span> 👍（8） 💬（2）<div>讲讲增删改查背后的真相</div>2020-03-23</li><br/><li><span>盘胧</span> 👍（2） 💬（1）<div>这就很爽了，搭配一下文档看还是很吃力。加油</div>2020-03-28</li><br/><li><span>艾瑞克小霸王</span> 👍（1） 💬（1）<div>服务器ID是在什么地方设置的呢？node的config吗？</div>2020-03-23</li><br/><li><span>周龙亭</span> 👍（0） 💬（1）<div>非leader节点怎么启动呢？</div>2020-04-30</li><br/><li><span>东尘西土</span> 👍（0） 💬（1）<div>ip+端口号代表一个节点，构造单机集群</div>2020-03-26</li><br/><li><span>坤</span> 👍（0） 💬（1）<div>请问加入集群的请求时Raft的哪个API或者RPC？</div>2020-03-25</li><br/><li><span>HuaMax</span> 👍（0） 💬（2）<div>集群最开始的时候，只有一个节点，我们让第一个节点通过 bootstrap 的方式启动，它启动后成为领导者
——————————————
请问老师，节点不是通过投票成为领导者吗？是不是所有节点都是bootstrap方式启动，然后再竞争成为领导者？</div>2020-03-23</li><br/><li><span>Heaven</span> 👍（0） 💬（0）<div>1.在启动节点的函数中,使用pid作为唯一区分,在内存中,进行内存地址的交流
