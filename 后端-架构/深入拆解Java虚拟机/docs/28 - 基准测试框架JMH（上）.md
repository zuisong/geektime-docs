...
<li><span>shitao</span> 👍（19） 💬（0）<div>这篇还没留言啊，总结下自己的一点jmh测试经验吧，希望老师指导。
1. 最好在专门的机器上做测试而不是自己的pc
2. 依赖的外部资源如redis，db等，测试过程中最好是独占的
3. 测试时间不宜过短，我一般10min以上吧</div>2018-12-26</li><br/><li><span>静心</span> 👍（2） 💬（1）<div>老师，什么叫冷循环呀？
既然有冷循环，是不是还有什么所谓的热循环？</div>2020-03-19</li><br/><li><span>史海洋</span> 👍（0） 💬（0）<div>       &lt;dependency&gt;
            &lt;groupId&gt;javax.annotation&lt;&#47;groupId&gt;
            &lt;artifactId&gt;javax.annotation-api&lt;&#47;artifactId&gt;
            &lt;version&gt;1.3.2&lt;&#47;version&gt;
        &lt;&#47;dependency&gt;</div>2021-06-28</li><br/><li><span>曾轼麟</span> 👍（0） 💬（0）<div>感觉基准测试好麻烦，能否有更加简洁的方式呢？比较真实项目中，依赖还是比较强的</div>2021-03-29</li><br/><li><span>akka</span> 👍（0） 💬（0）<div>自己测试时的一点不同点:
