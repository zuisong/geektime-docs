...
<li><span>小杰</span> 👍（3） 💬（2）<div>因为消费位点是consumer定时发给broker的，而每次发的时候只发最小确认offset，所以有可能消费者挂了又起来，大量消息都得重新消费，老师是这个原因吗？</div>2022-08-04</li><br/><li><span>Sam Fu</span> 👍（1） 💬（1）<div>老师可以讲下消费成功或者失败 本地以及broker offset的更新机制吗？
