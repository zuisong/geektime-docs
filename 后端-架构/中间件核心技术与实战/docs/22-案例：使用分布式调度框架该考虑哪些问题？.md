...
<li><span>靠人品去赢</span> 👍（1） 💬（0）<div>要是能像前者选型的那种，比较一下市面比较流行的elasteic job，xxl-job，Schedulerx这些框架。可能接着zookeeper，顺便选型定了ElasticJob。</div>2023-03-15</li><br/><li><span>酱紫的小白兔</span> 👍（0） 💬（0）<div>如何评价 powerjob 这个新框架？</div>2022-12-08</li><br/>
</ul>