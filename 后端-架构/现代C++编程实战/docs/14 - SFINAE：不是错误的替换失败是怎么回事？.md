...
<li><span>三味</span> 👍（37） 💬（1）<div>emmmm....
...
看了本文之后，真是受益颇多啊！留言于此，告诉大家，别以为用不到这些内容，都是实实在在的干货！</div>2019-12-30</li><br/><li><span>禾桃</span> 👍（16） 💬（2）<div>请问有编译器本身什么工具或者日志模式，可以显示模版实例化的过程？</div>2019-12-27</li><br/><li><span>_呱太_</span> 👍（6） 💬（1）<div>刚更新的时候看得头晕目眩，发现基础不够。回头抽空撸完了 STL 标准库 和 effective modern C++，回过头来看豁然开朗，真实受益匪浅</div>2020-04-09</li><br/><li><span>好好虚度时光</span> 👍（6） 💬（2）<div>表示真的太烧脑了</div>2020-01-17</li><br/><li><span>常振华</span> 👍（3） 💬（1）<div>标签分发那里的：
...
吧？
has_reserve&lt;C&gt;::value的::value是啥意思？</div>2021-10-13</li><br/><li><span>西加加</span> 👍（3） 💬（1）<div>看完了两课之后，正儿八经的想把各种 type_traits 用起来了。</div>2020-05-16</li><br/><li><span>geek</span> 👍（2） 💬（1）<div>老师，
template &lt;typename T,
          typename = void_t&lt;&gt;&gt;
struct has_reserve : false_type {};
...
struct has_reserve&lt;
  T, void_t&lt;decltype(
       declval&lt;T&amp;&gt;().reserve(1U))&gt;&gt;
  : true_type {};
第二个是一个类特化，但我理解，第二个中void的模板参数的推导结果和第一个是一样的。那此处 更特殊 这个意思是体现在 void的模板参数推导过程（无错）吗？</div>2021-03-08</li><br/><li><span>Simon</span> 👍（1） 💬（1）<div>typename = void_t&lt;&gt; 这个写法是什么意思？类型名是不重要的？</div>2022-08-01</li><br/><li><span>李亮亮</span> 👍（1） 💬（2）<div>
template &lt;typename T,
          typename = void_t&lt;&gt;&gt;
struct has_reserve : false_type {};
这里的冒号是什么语法？</div>2019-12-30</li><br/><li><span>。</span> 👍（0） 💬（1）<div>用 void_t 实现的 has_reserve 函数有一些问题，它没法判断类型的reserve 方法的返回值是否是 void，所以可以修改一下：
...
struct has_reserve&lt;T, std::__void_t&lt;decltype(std::declval&lt;T&amp;&gt;().reserve(1U))&gt;&gt;
    : std::is_void&lt;decltype(std::declval&lt;T&amp;&gt;().reserve(1U))&gt; {};</div>2024-03-10</li><br/><li><span>！null</span> 👍（0） 💬（2）<div>void_t代码例子后边没有解释void_t的作用，或者没有typename=void_t&lt;&gt;这部分 为什么不行。
另外typename=void_t&lt;&gt;这个是什么神仙语法？</div>2023-08-05</li><br/><li><span>yuchen</span> 👍（0） 💬（3）<div>请问，为什么 ‘declval&lt;T&amp;&gt;().reserve(1U)’中为什么要使用T&amp;而不是T？</div>2023-06-16</li><br/><li><span>Roblaboy</span> 👍（0） 💬（1）<div>我这边提示 enable_if_t 不是模板C&#47;C++(864) 是为什么，我这边用的是C++17</div>2022-09-29</li><br/><li><span>Geek_fa7226</span> 👍（0） 💬（1）<div>auto append(C&amp; container, T* ptr, size_t size) -&gt; decltype（...）中的-&gt;是什么语法？</div>2022-09-28</li><br/><li><span>Geek_fd78c0</span> 👍（0） 💬（1）<div>
