...
<li><span>禾桃</span> 👍（0） 💬（1）<div>“clock_gettime精度是0.0265微秒”
也就是26.5纳秒

请问，如果Clock_gettime返回值是到纳秒，两次取时间的差值如果是15纳秒（小于26.5纳秒），是不是意味着这个15纳秒其实手机不准确的，因为精度是26.5纳秒，远大于15纳秒。</div>2022-04-23</li><br/><li><span>王旧业</span> 👍（0） 💬（0）<div>原来UB还有积极正向的作用，以前没考虑过这种</div>2022-11-02</li><br/>
</ul>