...
<li><span>坤哥</span> 👍（1） 💬（3）<div>老师，不明白就地更新会引起读取-修改-写入过程，随机更新仅仅写入过程。随机更新不会碰到已写的页面吗？</div>2020-07-09</li><br/><li><span>J.Smile</span> 👍（3） 💬（2）<div>公司目前kafka使用的就是ssd</div>2020-07-17</li><br/><li><span>明翼</span> 👍（0） 💬（0）<div>老师，你好，文中的就地更新和随机更新怎么区分，不太理解，能不能举个例子</div>2021-11-11</li><br/><li><span>Trident</span> 👍（0） 💬（0）<div>之前公司采用SSD存储es的热点数据，但是深层次优化没有做</div>2021-05-11</li><br/>
</ul>