...
<li><span>J.Smile</span> 👍（7） 💬（1）<div>能够使用mapreduce思想处理的任务是可以分解且子任务之间没有依赖关系，最后可以做合并的类型。</div>2020-07-23</li><br/><li><span>Run</span> 👍（1） 💬（1）<div>多看看算法,数据结构是没错的</div>2020-07-31</li><br/>
</ul>