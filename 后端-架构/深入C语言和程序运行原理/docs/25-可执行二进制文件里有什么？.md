...
<li><span>LDxy</span> 👍（2） 💬（3）<div>  Elf64_Ehdr* elf_header;为指针类型，应该先让其指向内存空间再使用fread</div>2022-02-18</li><br/><li><span>勿更改任何信息</span> 👍（0） 💬（1）<div>https:&#47;&#47;www.ics.uci.edu&#47;~aburtsev&#47;238P&#47;hw&#47;hw3-elf&#47;hw3-elf.html 这里有一个ELF的作业，可以作为实践</div>2023-04-12</li><br/><li><span>石天兰爱学习</span> 👍（0） 💬（1）<div>文章内容很硬核，赞👍🏻</div>2022-04-12</li><br/><li><span>龍蝦</span> 👍（4） 💬（0）<div>```
#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;elf.h&gt;
...
```</div>2022-03-09</li><br/><li><span>白花风信子</span> 👍（3） 💬（0）<div>最期待的就是原理篇了！！！</div>2022-02-19</li><br/><li><span>西坠客</span> 👍（0） 💬（0）<div>现在的gcc需要加上-no-pie选项才能编译出exec类型的文件</div>2023-10-20</li><br/><li><span>前端1期-高雪荣</span> 👍（0） 💬（0）<div>readelf
zsh: command not found: readelf</div>2023-04-21</li><br/><li><span>TableBear</span> 👍（0） 💬（0）<div>今天这门课解决了不少我读程序员自我修养这本书时产生的疑惑。👍👍</div>2022-08-11</li><br/><li><span>zxk</span> 👍（0） 💬（1）<div>最近刚看完 JVM 的字节码文件格式，配合这篇作对比两者的异同，十分有趣。</div>2022-04-24</li><br/>
</ul>