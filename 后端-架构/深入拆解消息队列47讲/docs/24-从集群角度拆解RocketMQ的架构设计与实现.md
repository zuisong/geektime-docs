...
<li><span>Geek_4c6cb8</span> 👍（1） 💬（0）<div>有一些疑问请教：
1.Dledger模式是多个独立的Master注册到NameServer，每个Master背后各自一个raft集群吗？
2.Controller模式，文中提到Controller之间选主节点，这是通过选择完整性最高的Controller，在某个Master不可用之后，由Controller选择新的Master吗？</div>2024-01-01</li><br/><li><span>shan</span> 👍（1） 💬（0）<div>RocketMQ的三种部署模式
