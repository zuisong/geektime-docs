...
<li><span>郭朝斌</span> 👍（6） 💬（1）<div>关于安信可nodemcu的烧录问题，简单说在原来的命令中增加-fm dio 参数：
...
安可信nodemcu为什么需要呢？Flash芯片和ESP8266主芯片是通过SPI通信的，但是有不同的模式，一般Nodemcu模组是使用Quad I&#47;O 模式，但是这个安信可的板子使用的是Dual I&#47;O 模式，所以需要加这个参数明确指定一下。为什么这样采用DIO模式呢？因为这样可以额外空出2个GPIO管脚使用。嵌入式有时就是这样一个管脚都要珍惜。</div>2020-12-21</li><br/><li><span>garlic</span> 👍（8） 💬（1）<div>1. 使用的这个TopicMQTT_CONTROL_TOPIC = &quot;$thing&#47;down&#47;property&#47;&quot;+PRODUCT_ID+&quot;&#47;&quot;+DEVICE_NAME  终端通过 mqtt_client.subscribe，订阅这个Topic的消息
2. 按键功能实现使用配套的按钮组件， 将S接入到D5， 另外两端参考继电器接法接入分别到VCC， GND位置
学习笔记： https:&#47;&#47;xie.infoq.cn&#47;article&#47;6a9bce475271b9bab147244b8  </div>2021-01-02</li><br/><li><span>董义</span> 👍（4） 💬（2）<div>实践过程中碰到一些问题,LED类中brightness &gt;=1.0: 应该是brightness &lt;=1.0:
这个bug会导致无法调节亮度,且只有亮度设置为100%时才能调整颜色,否则变色逻辑都不会进入.
</div>2020-12-24</li><br/><li><span>俊瑶先森 | J꯭u꯭n꯭ ®</span> 👍（2） 💬（2）<div>我还以为是自己搭建平台。居然是。。。腾讯云物联网。。。。服气。。。</div>2021-01-25</li><br/><li><span>Il Mostro</span> 👍（2） 💬（1）<div>NodeMCU有睡眠的模式，如何设计一个唤醒的功能。</div>2021-01-23</li><br/><li><span>碎步马拉松</span> 👍（2） 💬（1）<div>老师好，类似腾讯物联网平台的开源项目有推荐么？</div>2020-12-22</li><br/><li><span>Il Mostro</span> 👍（1） 💬（1）<div>开发板日志如何查看，开发板在接通电源的情况下是否可以用USB连接至电脑</div>2021-01-22</li><br/><li><span>Geek_eb46b7</span> 👍（1） 💬（1）<div>老师，编写好的代码，有本地电脑端的调试方式吗？
每次改了，在传到 NodeMCU 开发板，验证对错调试，有点繁琐。</div>2020-12-24</li><br/><li><span>Lijkxb</span> 👍（1） 💬（7）<div>我的电灯状态一直显示“未激活”，不知道哪里出了问题，有成功实现的朋友可以帮我分析一下吗？
...
是不是腾讯云的开发平台设置有什么要避免的坑？还是说我其他地方操作不到呢？</div>2020-12-21</li><br/><li><span>小胖</span> 👍（1） 💬（2）<div> dir(network)
...
sta_if.active(True)
sta_if.connect( essid, passowrd)</div>2020-12-19</li><br/><li><span>李益达</span> 👍（0） 💬（2）<div>Button.py 文件我怎么没有看到</div>2021-04-28</li><br/><li><span>杨磊</span> 👍（0） 💬（2）<div>腾讯的物联网平台改版了，不知怎么用了，配不上物模型！</div>2021-04-25</li><br/><li><span>杨磊</span> 👍（0） 💬（1）<div>调速电位器 2👈信SHLIczBr4HO信 https:&#47;&#47;m.tb.cn&#47;h.4m0orgZ?sm=706fd7 WH138-1 B 5K&#47;10K&#47;20K&#47;50K&#47;100K&#47;250K&#47;500K 带开关调光调速电位器   
温湿度传感器 5👈啊tzc6czBI4No信 https:&#47;&#47;m.tb.cn&#47;h.4liAEQh?sm=2dc02f DHT11 DHT22温湿度传感器SHT30&#47;31数字开关 AM2302电子积木模块   

这两个不知买哪个型号</div>2021-04-19</li><br/><li><span>杨磊</span> 👍（0） 💬（2）<div>购买的硬件材料里没有看到Led灯啊</div>2021-04-18</li><br/><li><span>InfoQ_Albert</span> 👍（0） 💬（1）<div>老师，我想问一下，物联网平台除了腾讯云，还有其它推介的吗？</div>2021-03-15</li><br/>
</ul>