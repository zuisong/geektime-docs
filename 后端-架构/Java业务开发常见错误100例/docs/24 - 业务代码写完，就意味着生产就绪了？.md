...
<li><span>winner_0715</span> 👍（16） 💬（4）<div>我是贝壳找房的，所以看到老师的课程感觉很亲切，有个问题就是，在向第三方提供接口的时候，是提供RPC（如Dubbo）,还是HTTP呢，需要考虑哪些因素呢</div>2020-05-10</li><br/><li><span>Darren</span> 👍（8） 💬（1）<div>第一个问题：
	端点与@RestController：
...
第二个问题就不回答了，Prometheus+Grafana暂时还未入门</div>2020-05-11</li><br/><li><span>终结者999号</span> 👍（6） 💬（1）<div>另外请问老师，下单的metric现在是同步到InfluxDb的，应该也可以同步到Prometheus吧</div>2020-05-17</li><br/><li><span>hellojd</span> 👍（6） 💬（1）<div>投产前也要容量评估，做好流量确认，加上限流模块。</div>2020-05-09</li><br/><li><span>终结者999号</span> 👍（4） 💬（2）<div>我是作为一个央企关键部门的开发人员，对老师的这节课程感觉受益匪浅，每次出现问题都是客户报给我们故障，我们的zabbix不能完成metric的工作，所以也想引入Prometheus.</div>2020-05-17</li><br/><li><span>君子意如何</span> 👍（3） 💬（1）<div>老师这节课非常接地气！监控系统也会占用部分系统资源，比如我们的客户觉得自己很懂软件，给我们指定了硬件配置，跑正常的业务系统都捉襟见肘，加监控后性能有明显的下降，真是痛苦。</div>2021-01-27</li><br/><li><span>苗</span> 👍（2） 💬（1）<div>老师，指标收集的代码一般放在哪一层比较合适？</div>2020-09-08</li><br/><li><span>Michael</span> 👍（2） 💬（2）<div>老师，你好！
OrderController 中的业务代码中涉及大量的指标注入代码会不会侵入性太强了，若是需要监控的业务指标很多，代码中涉及大量的这种Metrics.timer(&quot;deliverOrder.success&quot;).record(Duration.between(begin, Instant.now()));采集代码，觉得有点不太好，还有其他的方法嘛？</div>2020-06-24</li><br/><li><span>程序员小跃</span> 👍（1） 💬（1）<div>我的天，这篇对于刚入后端不久的我来说，简直了，打开新世界的大门一样。</div>2020-10-24</li><br/><li><span>Seven.Lin澤耿</span> 👍（6） 💬（1）<div>终于越来越明白Spring Cloud为啥叫Cloud了，强大</div>2020-05-12</li><br/><li><span>Jerry Wu</span> 👍（3） 💬（3）<div>看来要想想办法，多接触些技术性更强的项目了。这几节课的内容都没接触过，读起来很吃力。</div>2020-05-12</li><br/><li><span>鲁鸣</span> 👍（1） 💬（3）<div>尝试了一下influxDB2.0，需要客户端使用token进行鉴权，spring boot里面的配置暂时无法生效了</div>2021-01-24</li><br/><li><span>秋天</span> 👍（0） 💬（0）<div>问一下老师，现在 springboo应用的一些 controlelr 接口可用性监控和报警，应该用哪个比较好啊？</div>2022-06-08</li><br/>
</ul>