...
<li><span>哈哈</span> 👍（2） 💬（1）<div>老师，咨询个问题，AI agent在联通容器云的生产环境，有应用场景没？我个人感觉，学这个暂时做技术储备，有时候考虑安全性，特别是金融领域，很少用于生产。</div>2024-12-23</li><br/><li><span>🤡</span> 👍（0） 💬（1）<div>充电中，对 client-go 比较熟，看看后续的章节最终会实现一个什么样的效果，感觉挺有意思</div>2025-02-01</li><br/>
</ul>