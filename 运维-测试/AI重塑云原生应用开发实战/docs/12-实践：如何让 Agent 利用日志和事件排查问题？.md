...
<li><span>郑海成</span> 👍（0） 💬（1）<div>【少轮对话才能得到“Final Answer”】本质就是控制上下文长度，openai包里面好像没有相应参数，只能自己控制，通过 MessageStore 的长度控制上下文的长度，上下文长度达到一定就使用【Thought】作为【Final Answer】</div>2025-02-21</li><br/><li><span>🤡</span> 👍（0） 💬（1）<div>如果工具不给力得不到final answer，可以设置一个循环的上限次数，比如说循环思考 10 次得不到结果，说明这个大模型可能解决不了这个问题，可以直接退出循环</div>2025-02-02</li><br/>
</ul>