...
<li><span>王雪</span> 👍（2） 💬（1）<div>便贴集赞：backend for frontend ，BFF</div>2022-02-18</li><br/><li><span>neohope</span> 👍（0） 💬（1）<div>1、所有的加解密都是执行 js，那么如果对方使用浏览器直接运行 js，是否意味着所有的加解密都形同虚设？ 如果不是，那原因是什么？
...
</div>2022-03-11</li><br/><li><span>peter</span> 👍（0） 💬（1）<div>Q1：key加解密是说服务端把加解密方法告诉前端，
       由前端进行加解密吗？
       key是用来做什么的？
