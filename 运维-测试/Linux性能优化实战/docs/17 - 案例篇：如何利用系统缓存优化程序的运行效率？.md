...
<li><span>我来也</span> 👍（83） 💬（3）<div>[D17打卡]
...
还居然在完全不知道程序具体实现的基础上,定位到了引起性能问题的系统调用. 有的甚至还直接给出了参数,太牛了.</div>2018-12-28</li><br/><li><span>蓬蒿</span> 👍（41） 💬（6）<div>这里的direct i&#47;o是不是上一节课里的直接操作磁盘的“裸i&#47;o”呢？如果是的话是不是应该从buffer的角度分析实验二呢?</div>2019-02-17</li><br/><li><span>念你如昔</span> 👍（29） 💬（2）<div>（我是小白）
1.dd命令前清理了缓存，为什么缓存命中率是百分之49.8呢？（都已经没有缓存了，按理说是0）
2.绕过了系统缓存，为什么缓存命中率还百分之百？</div>2019-01-04</li><br/><li><span>Johnson</span> 👍（16） 💬（1）<div>dd命令也支持直接IO的 有选项oflag和iflag 所以dd也可以用来绕过cache buff做测试</div>2018-12-28</li><br/><li><span>jssfy</span> 👍（8） 💬（1）<div>请问第一次读50%的命中率如何解释呢？</div>2019-01-04</li><br/><li><span>春暖花开</span> 👍（8） 💬（1）<div>非常有价值，是我阅读的极客课程里面最棒的。</div>2018-12-28</li><br/><li><span>往事随风，顺其自然</span> 👍（6） 💬（1）<div>要是centos验证一下就好了，不同系统很多问题不一样，操作上遇到问题很奇怪</div>2018-12-28</li><br/><li><span>辉晖</span> 👍（5） 💬（2）<div>很遗憾，实际生产环境都是用centos，没法为了安装bcc-tools而去升级内核。</div>2019-07-11</li><br/><li><span>许山山</span> 👍（5） 💬（1）<div>我也觉得这门课超级棒了，原理加时间，学到很多！</div>2018-12-28</li><br/><li><span>Zyj-Sxy</span> 👍（4） 💬（3）<div>#go get方式安装pcstat可能会有问题直接下载github仓库就不用挂代理什么的了
#安装go
yum install -y go
#添加环境变量
cat &lt;&lt; EOF &gt;&gt; &#47;etc&#47;profile
...
#安装完成就可以直接使用pcstat
pcstat &#47;bin&#47;ls</div>2020-07-17</li><br/><li><span>ninuxer</span> 👍（4） 💬（1）<div>打卡day18
年终忙着各种总结，各种文字性东西，已经连着一礼拜12点之后下班了，再忙也要坚持跟着实践～💪💪💪</div>2018-12-28</li><br/><li><span>LindaWang</span> 👍（3） 💬（1）<div>老师，可不可以讲下CPU Cache（L1&#47;L2&#47;L3）如何查看和优化？感觉这里的cachestat&#47;cachetop&#47;pcstat查看的都是文件io之类的，操作系统层面的cache</div>2020-07-16</li><br/><li><span>小周</span> 👍（3） 💬（1）<div>1024*4K&#47;1024 = 4MB 不是等于 4K吗！？ </div>2019-05-29</li><br/><li><span>tinyfool</span> 👍（2） 💬（1）<div>docker日志显示0.03s读取了32MB数据；
根据cachetop输出计算1s从缓存中读取了32MB数据；
这两个时间差异很大，老师是否可以解释下了？</div>2019-08-03</li><br/><li><span>夜空中最亮的星</span> 👍（2） 💬（1）<div>老师 ：
...
package golang.org&#47;x&#47;sys&#47;unix: unrecognized import path &quot;golang.org&#47;x&#47;sys&#47;unix&quot; (https fetch: Get https:&#47;&#47;golang.org&#47;x&#47;sys&#47;unix?go-get=1: dial tcp 216.239.37.1:443: connect: connection refused)
[root@bogon ~]# </div>2018-12-28</li><br/>
</ul>