...
<li><span>Obscure</span> 👍（7） 💬（3）<div>网络基础不行，这一节内容基本看不懂。。。咋整。。。</div>2022-09-07</li><br/><li><span>dao</span> 👍（6） 💬（1）<div>试着思考了一下：
...
kubectl -n kube-system rollout restart deployment coredns</div>2023-06-20</li><br/><li><span>美妙的代码</span> 👍（4） 💬（1）<div>生产环境建议用哪个网络插件呢？</div>2022-09-09</li><br/><li><span>杨丁</span> 👍（4） 💬（1）<div>老师好，您画图用的啥工具啊</div>2022-09-06</li><br/><li><span>Lorry</span> 👍（0） 💬（1）<div>老师，好像启用了calico之后，发现grafana以及Prometheus只能在pod所在的节点访问，其他节点都无法访问grafana页面以及Prometheus页面</div>2023-07-30</li><br/><li><span>糊涂小孩123</span> 👍（0） 💬（1）<div>&#47;opt&#47;cni&#47;bin里的flannel跟以ds部署的flanneld是怎么个关系呢？这块原理是如何的</div>2023-06-02</li><br/><li><span>Lorry</span> 👍（0） 💬（1）<div>hostNetwork是不是属于underlay？</div>2023-02-10</li><br/><li><span>摊牌</span> 👍（0） 💬（1）<div>引用原文 ： &quot;这里我重新画了一张图，描述了 Docker 里最常用的 bridge 网络模式：&quot;
该图中的最下方的位置，ens160是表示啥？请老师帮忙解答下，谢谢</div>2023-01-29</li><br/><li><span>明月夜</span> 👍（0） 💬（1）<div>老师好，在节点上（在Pod外）好像也是能访问某个Pod的ip的，这种情况的IP寻址是不是也和在Pod里面的寻址一样？</div>2022-09-18</li><br/><li><span>罗耀龙@坐忘</span> 👍（0） 💬（1）<div>按照老师的教程，成功从flannel换成calico了</div>2022-09-03</li><br/><li><span>罗耀龙@坐忘</span> 👍（0） 💬（1）<div>老师，calico的版本是v3.24.1了</div>2022-09-03</li><br/><li><span>peter</span> 👍（0） 💬（1）<div>请教老师一个问题：
...
</div>2022-09-02</li><br/><li><span>卩杉</span> 👍（0） 💬（0）<div>calico-kube-controllers-54756b744f-s94cq   1&#47;1     Running            0                10h    10.10.219.65     master   &lt;none&gt;           &lt;none&gt;
