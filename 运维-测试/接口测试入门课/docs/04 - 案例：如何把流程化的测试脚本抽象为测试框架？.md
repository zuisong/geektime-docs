...
<li><span>捷后愚生</span> 👍（63） 💬（3）<div>接口测试框架的形成过程
流水账式的接口测试脚本
...
测试框架是在编写大量测试脚本地过程中不断抽象封装出来地，然后不断完善，是一个循环往复地过程。</div>2020-11-28</li><br/><li><span>happychap</span> 👍（11） 💬（6）<div>有个观点与老师不同，就是在编程语言的选择上，针对新手而言，选择与研发团队相同的编程语言（java,python,js,go）个人觉得会更好一些，一方面有研发团队作为依靠，另一方面在接入ci时，可以复用研发团队的ci接入技术栈。再有就是能复用面向测试的底层开源库就先复用它们，把更多的精力放在测试领域功能封装上，如：入参的处理，出参的传递，接口请求结果的抽取等方面。
如果对编程语言还是一知半解，老师本讲所讲的内容就要多去理解、实践了，它是很好的入门窗口。</div>2020-02-08</li><br/><li><span>技术修行者</span> 👍（5） 💬（2）<div>看完这篇文章，可以更清晰的感觉到这个专栏的受众应该是初级测试人员，不太适合开发人员。

在部落中也零星看到一些关于这个专栏的讨论和批评，我觉得可能是因为大家对专栏的期望太高了，结果在这里没有看到化腐朽为神奇的东西。

一步一步来吧，总归是开卷有益，拓展思路，查漏补缺也挺好的。</div>2020-02-23</li><br/><li><span>丁丁历险记</span> 👍（2） 💬（1）<div>推荐一本书，martin flower 的重构。</div>2020-05-02</li><br/><li><span>深瞳</span> 👍（2） 💬（1）<div>上了这个课程以后才知道自己会的接口测试知识太太少了，要学的太多了，自己的基础太薄弱了</div>2020-04-01</li><br/><li><span>陈优雅</span> 👍（2） 💬（1）<div>单一接口测试代码可以用postman直接生成</div>2020-02-09</li><br/><li><span>Geek_a57228</span> 👍（2） 💬（2）<div>老师，看你的脚步，写公共方法的那一段是否需要加上import requests呢？不然后面调用requests包时，会有问题吧，刚学Python代码，所以问题比较初级</div>2020-02-07</li><br/><li><span>牺牲</span> 👍（1） 💬（3）<div>我真的没看出common接收变量后，代码量有什么节省。就是不用动框架了，每次传参就可以了。</div>2020-05-08</li><br/><li><span>7F</span> 👍（1） 💬（4）<div>有一个Python业界很获得接口测试框架，HTTPrunner，老师你怎么看这个框架。</div>2020-02-09</li><br/><li><span>杨亚玲</span> 👍（1） 💬（3）<div>有下面这样的错误：
print(&#39;Response内容：&#39; + response_login.text)
AttributeError: &#39;NoneType&#39; object has no attribute &#39;text&#39;</div>2020-02-08</li><br/><li><span>lei</span> 👍（0） 💬（1）<div>payload是不是可以作为参数加到post方法里？
print也可以封装个方法到common类里</div>2021-03-15</li><br/><li><span>Aaron Liu</span> 👍（0） 💬（1）<div>Python测试框架验证response的scheme(swagger格式)是如何做</div>2020-06-03</li><br/><li><span>继华</span> 👍（0） 💬（1）<div>我们用的是robotframe work 框架 ，觉得很好用</div>2020-05-07</li><br/><li><span>橘子🍊</span> 👍（0） 💬（1）<div>pytest 框架也是很不错的</div>2020-03-19</li><br/><li><span>米包</span> 👍（0） 💬（2）<div>老师，postman的测试用例应该怎么写？就是在test里面可以执行的，能点拨一下嘛？</div>2020-03-18</li><br/>
</ul>