...
<li><span>木易</span> 👍（3） 💬（6）<div>webpagetest该网站是需要特殊的操作吗？我的页面能打开，但是输入url及配置完相应的设置后，点击&lt;start test&gt;,会显示如下的提示:Failed recaptcha validation. Please go back and try submitting your test again 。也不会有老师文章里的相应结果</div>2018-09-07</li><br/><li><span>llyl</span> 👍（3） 💬（1）<div>对于局域网的网页webpage就不支持了，怎么测试局域网网页的性能呢？</div>2018-09-07</li><br/><li><span>mgxian</span> 👍（2） 💬（1）<div>puppteer之类的开源软件应该也可以获取这些数据 </div>2018-09-08</li><br/><li><span>Cynthia🌸</span> 👍（1） 💬（1）<div>WebPagetest！之前真的没有接触过这个工具。打算找一块时间来跟着操作实践一下，才能理解的更深入。</div>2018-09-12</li><br/><li><span>@VV@</span> 👍（1） 💬（1）<div>测试结果展示跟你的不一样，有什么设置吗？右上角就没有综合评分</div>2018-09-11</li><br/><li><span>赵明月</span> 👍（1） 💬（1）<div>有用，哪天接触前端测试了，可以用用</div>2018-09-10</li><br/><li><span>dean不闷</span> 👍（1） 💬（1）<div>请问一下h5的性能，有什么好的方案吗</div>2018-09-07</li><br/><li><span>Ivan</span> 👍（0） 💬（1）<div>跟“木易”提出的问题一致，url无特殊字符，这是怎么回事？（webpagetest该网站是需要特殊的操作吗？我的页面能打开，但是输入url及配置完相应的设置后，点击&lt;start test&gt;,会显示如下的提示:Failed recaptcha validation. Please go back and try submitting your test again 。也不会有老师文章里的相应结果）</div>2018-12-28</li><br/><li><span>张扬</span> 👍（0） 💬（1）<div>求老师介绍web APP 性能测试方法</div>2018-09-07</li><br/><li><span>on the way</span> 👍（0） 💬（1）<div>很实用
最近公司正在做前端性能优化。下午试了一把，觉得拿公司的实践。
最好可以推行CI&#47;CD</div>2018-09-07</li><br/><li><span>Bella</span> 👍（0） 💬（1）<div>官网输入测试网址一直提示重试，是需要翻墙吗？</div>2018-09-07</li><br/><li><span>心情不错</span> 👍（9） 💬（2）<div>老师您好，我想请问如果某些页面需要登录才能访问到，用您介绍的工具怎么测试呢？</div>2018-09-21</li><br/><li><span>Grace</span> 👍（1） 💬（0）<div>chrome 开发者工具和webpagetest，感觉区别不大？老师能具体分析下两者的优缺点？</div>2020-09-21</li><br/><li><span>天天向⬆️</span> 👍（1） 💬（0）<div>移动端native性能测试有好的工具推荐吗？</div>2018-09-20</li><br/><li><span>张锡好</span> 👍（0） 💬（0）<div>大佬，出了webpagetest外，再讲讲Lighthouse么，相比起webpage test还要自己搭建个私服，Lighthouse可以直接在chrome 里用了哈</div>2024-05-13</li><br/>
</ul>