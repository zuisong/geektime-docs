...
<li><span>图·美克尔</span> 👍（6） 💬（1）<div>代码自动生成会讲到吗？</div>2018-08-01</li><br/><li><span>图·美克尔</span> 👍（5） 💬（3）<div>然后，对于每一个业务流程类，都会有相应的业务流程输入参数类与之一一对应。具体的步骤通常有这么几步：
...
也便于自由组合成其他的业务流程。比如：login-&gt;view order-&gt;logout</div>2018-07-30</li><br/><li><span>Allen</span> 👍（3） 💬（1）<div>公司的业务流程比较复杂，需要在接口层覆盖业务流程的自动化测试。最近正在设计接口自动化的测试方案，看了这篇文章，很有启发。</div>2018-07-31</li><br/><li><span>@</span> 👍（2） 💬（1）<div>用依赖可以实现不同业务间的衔接</div>2018-07-31</li><br/><li><span>麥白</span> 👍（1） 💬（1）<div>总结的很到位，很喜欢这种授人以渔的课程！学到了不少，得好好实践下~</div>2019-05-09</li><br/><li><span>johnny</span> 👍（0） 💬（1）<div>第13节的内容能理解，我已经将伪代码实现了。但是这节的内容不好理解，老师可以给我发一个完整的示例吗（不是用伪代码描述的，是真正用java语言实现的代码示例）？简单的业务流程，只要能说明第14节内容就行。我的邮箱是cjnjk@163.com</div>2018-11-19</li><br/><li><span>Sunshine</span> 👍（0） 💬（1）<div>感谢老师讲解，现在脑子有了一个更清晰的思路</div>2018-08-03</li><br/><li><span>雪哥</span> 👍（0） 💬（1）<div>新手问下，有什么好的论坛，心得交流平台吗，或者测试经常浏览的技术网站</div>2018-07-31</li><br/><li><span>Allen</span> 👍（0） 💬（1）<div>我们公司的业务流程比较复杂，看了这篇文章，有了新的思路，受教了。</div>2018-07-30</li><br/><li><span>彬彬</span> 👍（0） 💬（1）<div>嗯，我也是这种思想去做的，更容易组装出更多的业务场景用例</div>2018-07-30</li><br/><li><span>叶夏立</span> 👍（0） 💬（1）<div>确实是不错，看来接口测试平台也可以借鉴一下这种做法。</div>2018-07-30</li><br/><li><span>张红占</span> 👍（0） 💬（1）<div>需要特别注意的是，第 12 行中 withStartPage(loginFlow.getEndPage()) 的含义是，SearchBookFlow 的起始页面将会使用之前 loginFlow 的结束页面。
-----这个实现方式能否细讲下</div>2018-07-30</li><br/><li><span>Cynthia🌸</span> 👍（13） 💬（0）<div>我曾经做过的一个自动化项目，整体代码实现方式与思路和这里介绍的不太一样。
