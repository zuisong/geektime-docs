...
<li><span>tracer</span> 👍（1） 💬（0）<div>很多高深的安全知识，讲出来似乎都十分有道理，但是实践起来往往不是那么回事。
说的太对了，都说能攻击，但只有你证明给我看了，太强了</div>2022-11-18</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<div>我们以为的随机数，往往没有那么随机。--记下来</div>2023-03-09</li><br/><li><span>leslie</span> 👍（0） 💬（0）<div>分析任何问题都是找到确定性和未知的，做好确定因素是基础，然后对未知的做好可能的风险控制与沙盘推演的Demo测试。</div>2022-01-16</li><br/>
</ul>