...
<li><span>庄风</span> 👍（2） 💬（1）<div>前几天的Log4J事件，应该属于“A06：2021- 易受攻击和过时的组件”吧。</div>2021-12-30</li><br/><li><span>DoHer4S</span> 👍（2） 💬（1）<div>CSRF &#47; XSS &#47; HTTP HEADER ATTACK 等～</div>2021-12-20</li><br/><li><span>Geek_su</span> 👍（1） 💬（1）<div>社会工程学诱骗</div>2021-12-31</li><br/><li><span>meta-algorithmX</span> 👍（1） 💬（1）<div>Ddos、CC攻击算么？</div>2021-12-16</li><br/><li><span>e</span> 👍（0） 💬（1）<div>老师，文件上传漏洞算A01吗，不算的话算第几?</div>2021-12-19</li><br/><li><span>Geek_sa5dup</span> 👍（0） 💬（1）<div>不安全的加密存储，这个是不是也属于“不安全的设计”这一类的啊。我们之前有一个这个问题，就很典型的连接数据库，连接完后 没有清理掉内存中的数据库连接信息</div>2021-12-16</li><br/><li><span>sugar</span> 👍（0） 💬（1）<div>回答思考题： 经典漏洞 clickjacking，点击劫持。在当年道哥的 白帽web安全 里就提到过</div>2021-12-15</li><br/><li><span>韩晔</span> 👍（1） 💬（0）<div>log4j使用低版本，虽然属于过时的组件但是没有漏洞，存在什么潜在风险呢。</div>2022-02-08</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<div>卧底，内鬼算吗？</div>2023-03-03</li><br/><li><span>几叶星辰</span> 👍（0） 💬（0）<div>威胁建模，安全设计会讲吗</div>2022-02-15</li><br/>
</ul>