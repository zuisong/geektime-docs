...
<li><span>雄鹰</span> 👍（12） 💬（1）<div>老师思路清晰，羡慕佩服，若能学会，也是大牛了</div>2021-05-29</li><br/><li><span>道长</span> 👍（4） 💬（1）<div>感觉能把这些搞懂，就很厉害了</div>2021-05-28</li><br/><li><span>WBF</span> 👍（3） 💬（1）<div>搭建整套环境，需要详细阅读并实践这些参考资料不下于20篇，知识点涵盖全面，实用性很强，就是搭建成本有点高哈，感谢高老师的良苦用心，收获很大</div>2021-05-29</li><br/><li><span>weifang</span> 👍（2） 💬（1）<div>老师，请问一个菜鸟要花费多长的时间可以搭建完成呀？另外我只有三台物理服务器，只要总的资源能达到64C,128G是不是就可以呢？</div>2021-08-02</li><br/><li><span>kubxy</span> 👍（1） 💬（4）<div>容量场景的性能脚本可以分享出来吗？看了《高楼的性能工程实战课之脚本开发》这篇文章，开发基准测试脚本没问题，但还是不清楚在容量场景下这些接口如何组装，以及具体如何控制比例。希望老师能分享一下，这样就一目了然了。</div>2022-04-15</li><br/><li><span>微思</span> 👍（1） 💬（1）<div>赞！！！</div>2021-06-11</li><br/><li><span>摩羯</span> 👍（0） 💬（1）<div>这硬件成本有点大了 我去
</div>2024-09-10</li><br/><li><span>亚林</span> 👍（0） 💬（1）<div>相当于我们的大项目了</div>2024-05-14</li><br/><li><span>骑着🚀看银河</span> 👍（0） 💬（1）<div>两台mac pro 2015 配置 4C 16G 250G 处在一个局域网内，使用Virtual Box安装8台CentOS虚拟机（无UI界面），搭建k8s 集群 1个master 7个 worker 搞定，很流畅</div>2024-01-28</li><br/><li><span>勋</span> 👍（0） 💬（1）<div>物理机成本八万...
就在自己的笔记本上部署几个虚拟机能不能玩起来。就不求跟真实的环境接近了，纯粹为了熟悉一下分析问题的思路，以及各种工具、命令。</div>2022-10-11</li><br/><li><span>qtracer</span> 👍（0） 💬（1）<div>要砸钱买机器了，哈哈</div>2022-08-12</li><br/><li><span>姑射仙人</span> 👍（0） 💬（1）<div>缺少一些重点中间件的生产环境配置，如mysql，mongodb，redis等。这也是比较重要的一环。</div>2022-01-22</li><br/>
</ul>